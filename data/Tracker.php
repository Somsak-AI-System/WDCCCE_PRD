 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/data/Tracker.php,v 1.15 2005/04/28 05:44:22 samk Exp $
...
class Tracker {
    ...
    /**
     * Add this new item to the aicrm_tracker aicrm_table.  If there are too many items (global config for now)
 ...
 * Contributor(s): ______________________________________..
    ...
    function track_view($user_id, $current_module, $item_id, $item_summary)
    {
	 ...
	 #if condition added to skip aicrm_faq in last viewed history
     ...
     * return - return the array of result set rows from the query.  All of the aicrm_table aicrm_fields are included
 * Portions created by SugarCRM are Copyright (C) SugarCRM, Inc.
 * All Rights Reserved.
 * Contributor(s): ______________________________________..
     */
...
//        $query = "SELECT * from $this->table_name WHERE user_id='$user_id' ORDER BY id DESC";
	$query = "SELECT * from $this->table_name inner join aicrm_crmentity on aicrm_crmentity.crmid=aicrm_tracker.item_id WHERE user_id=? and aicrm_crmentity.deleted=0 ORDER BY id DESC";
