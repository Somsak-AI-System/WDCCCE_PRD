 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/data/SugarBean.php,v 1.70 2005/03/16 10:25:16 shaw Exp $
...
class SugarBean
{
     ...
     * This method uses the presence of an id aicrm_field that is not null to signify and update.
     * The id aicrm_field should not be set otherwise.
     * todo - Add support for aicrm_field type validation and encoding of parameters.
 * Portions created by SugarCRM are Copyright (C) SugarCRM, Inc.
 * All Rights Reserved.
 * Contributor(s): ______________________________________..
     */
	...
	function save($module_name= '') 
	{
		...
		else
		{
			...
			{
                          $this->id = $this->db->getUniqueID("aicrm_users");
			}
		...
		{
			// Do not write out the id aicrm_field on the update statement.
     ...
     * It fills in all of the aicrm_fields from the DB into the object it was called on.
