...
function expandRecord($table,$log)
{
    ...
    //aicrm_products table
    if( $table == "aicrm_products" )
    ...
    //aicrm_activity table
    elseif( $table == "aicrm_activity") 
	...
	//aicrm_seactivityrel
	elseif( $table == "aicrm_seactivityrel")
	$subfields = array("crmid", "activityid");
	
	//aicrm_cntactivityrel
	elseif( $table == "aicrm_cntactivityrel")
	$subfields = array("contactid", "activityid");
	
	//aicrm_purchaseorder
	elseif( $table == "aicrm_purchaseorder")
	...
	//aicrm_leaddetails
	elseif( $table == "aicrm_leaddetails")
	...
	//aicrm_campaignleadrel 
	elseif( $table == "aicrm_campaignleadrel")
	$subfields = array("campaignid", "leadid");
	
	//aicrm_pricebook
	elseif( $table == "aicrm_pricebook")
