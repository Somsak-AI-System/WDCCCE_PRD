...
class VtigerCRMActorMeta extends EntityMeta {
	...
	private function getReferenceList($dbField){
		...
		$sql = "select * from aicrm_ws_entity_referencetype where fieldtypeid=?";
	...
	private function getFieldType($dbField,$tableName){
		...
		$sql = "select * from aicrm_ws_entity_fieldtype where table_name=? and field_name=?;";
	...
	public function getNameFields(){
		$query = "select name_fields from aicrm_ws_entity_name where entity_id = ?";
	...
	public function getName($webserviceId){
		...
		$query = "select * from aicrm_ws_entity_name where entity_id = ?";
