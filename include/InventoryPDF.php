...
function get_invoice_pdf()
{
	...
	//retreiving the aicrm_invoice info
	$focus = new Invoice();
	...
	$sql="select currency_symbol from aicrm_currency_info where id=?";
	...
	if($focus->column_fields["salesorder_id"] != '')
		...
		$so_name = '';
	$po_name = $focus->column_fields["aicrm_purchaseorder"];
	...
	// Company information
	$add_query = "select * from aicrm_organizationdetails";
