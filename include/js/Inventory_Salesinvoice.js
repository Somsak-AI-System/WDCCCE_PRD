...
jQuery(document).ready(function() {
	...
	jQuery("select[name='quotation_buyer']").change(function() {
		var quotation_buyer = jQuery(this).val();
		jQuery.ajax({
			type: "POST",
			url: "get_data.php",
			cache: false,
			...
			success: function(data, textStatus, jqXHR)
			{
				...
				jQuery("textarea[name='buyer_address']").val(address);
				jQuery("input[name='buyer_phone']").val(phone);
				jQuery("input[name='buyer_email']").val(email);
	...
	jQuery("select[name='vender']").change(function() {
		var vender = jQuery(this).val();
		jQuery.ajax({
			type: "POST",
			url: "get_data.php",
			cache: false,
			...
			success: function(data, textStatus, jqXHR)
			{
				...
				jQuery("textarea[name='vender_address']").val(address);
				jQuery("input[name='vender_phone']").val(phone);
				jQuery("input[name='vender_email']").val(email);
