...
var fieldValueArr=new Array('Text','Number','Percent','Currency','Date','Email','Phone','Picklist','URL','Checkbox','TextArea','MultiSelectCombo','Skype','PickList_product','PickList_Account','PickList_User');
var fieldTypeArr=new Array('text','number','percent','currency','date','email','phone','picklist','url','checkbox','textarea','multiselectcombo','skype','PickList_product','PickList_Account','PickList_User');
...
function selFieldType(id,scrollLayer,bool,blockid) {
	...
	var pickListLayer=document.getElementById("picklistdetails_"+blockid);
        ...
        } else if (type=='PickList_product' || type=='PickList_Account' || type=='PickList_User' || type=='date' || type=='percent' || type=='email' || type=='phone' || type=='url' || type=='checkbox' || type=='textarea' || type=='skype') {
			...
			else
			{
				...
				switch (lead_tod[0]) {
                	case "V"  :
						...
						{
                            console.log(lead_tod[3]);console.log(tod[3]);
