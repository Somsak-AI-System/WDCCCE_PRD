...
function productPricelist(currObj,module, row_no) {
    ...
    if (!emptyCheck("hdnProductId"+rowId,alert_arr.LINE_ITEM,"text")) return false
     ...
     window.open("index.php?module=PriceList&action=Popup&html=Popup_picker&form=EditView&popuptype=inventory_pricelist&fldname=listPrice"+rowId+"&productid="+productId,"priceBookWin","width=640,height=565,resizable=0,scrollbars=0,top=150,left=200");
...
function calcGrandTotal() {
    ...
    */
    ...
    /*if(cf_4352 == true){
        ...
        if(quotestype=="Include Vat"){ console.log('Include Vat')
            var price_include = 0;
            var total_include = 0;
            var group_tax_count = document.getElementById("group_tax_count").value;
            for(var i=1;i<=group_tax_count;i++)
            {
                group_tax_percentage = document.getElementById("group_tax_percentage"+i).value;
        ...
        afterdis_final = (eval(netTotal)-eval(discountTotal_final))*eval(100)/ (100+eval(group_tax_percentage));


        if(quotestype=="Include Vat"){
            grandTotal = eval(netTotal)-eval(discountTotal_final);
            //finalTax = eval((afterdis_final*7)/107);

            ///Start Edit FinalTax in 20180110 ///
            for(var i=1;i<=group_tax_count;i++){
                var group_tax_percentage = document.getElementById("group_tax_percentage"+i).value;
                finalTax = eval(afterdis_final)-((eval(afterdis_final)*eval(100))/(eval(100)+eval(group_tax_percentage)));
            }
            ///End Edit FinalTax in 20180110 ///
            //document.getElementById("tax_final").value = eval(finalTax.toFixed(2))
        }else{
        ...
        var tax_n = total_new - discountTotal_final - afterdis_final.toFixed(2);
...
function fnAddProductRowInventory(module,image_path){
    ...
    var colone = row.insertCell(0);
    var coltwo = row.insertCell(1);
    if(module == "Quotes" || module == "Sparepart" || module == "Service"){
    ...
    if(module == "Quotes" || module == "Sparepart" || module == "Service"){
        if(module == "Quotes"){
            var relService = 'Service';
            var relSparepart = 'Sparepart';
            ...
            '<textarea id="productName'+count+'" name="productName'+count+'" class="detailedViewTextBox user-success" style="width:90%;height:40px"></textarea>'+
            '<input id="hdnProductId'+count+'" name="hdnProductId'+count+'" value="" type="hidden">'+
            '<input type="hidden" id="lineItemType'+count+'" name="lineItemType'+count+'" value="Sparepart" />'+
            '<input type="hidden" id="productcode'+count+'" name="productcode'+count+'" value="" />'+
            '&nbsp;<img id="searchIcon'+count+'" title="Sparepart" src="themes/images/services.gif" style="cursor: pointer;" onclick="sparepartPickList(this,\''+module+'\','+count+')" align="absmiddle">'+
            '</td></tr><tr><td class="small"><input type="hidden" value="" id="subproduct_ids'+count+'" name="subproduct_ids'+count+'" /><span id="subprod_names'+count+'" name="subprod_names'+count+'" style="color:#C0C0C0;font-style:italic;"> </span>'+
            '</td></tr><tr><td class="small" id="setComment'+count+'"><textarea id="comment'+count+'" name="comment'+count+'" class="detailedViewTextBox user-success" style="width:90%;height:40px"></textarea><img src="themes/images/clear_field.gif" onClick="getObj(\'comment'+count+'\').value=\'\'"; style="cursor:pointer;" /></td></tr></tbody></table>';
            ...
            '<textarea id="productName'+count+'" name="productName'+count+'" class="detailedViewTextBox user-success" style="width:90%;height:40px"></textarea>'+
            '<input id="hdnProductId'+count+'" name="hdnProductId'+count+'" value="" type="hidden">'+
            '<input type="hidden" id="lineItemType'+count+'" name="lineItemType'+count+'" value="Service" />'+
            '<input type="hidden" id="productcode'+count+'" name="productcode'+count+'" value="" />'+
            '&nbsp;<img id="searchIcon'+count+'" title="Service" src="themes/images/services.gif" style="cursor: pointer;" onclick="servicePickList(this,\''+module+'\','+count+')" align="absmiddle">'+
            '</td></tr><tr><td class="small"><input type="hidden" value="" id="subproduct_ids'+count+'" name="subproduct_ids'+count+'" /><span id="subprod_names'+count+'" name="subprod_names'+count+'" style="color:#C0C0C0;font-style:italic;"> </span>'+
            '</td></tr><tr><td class="small" id="setComment'+count+'"><textarea id="comment'+count+'" name="comment'+count+'" class="detailedViewTextBox user-success" style="width:90%;height:40px"></textarea><img src="themes/images/clear_field.gif" onClick="getObj(\'comment'+count+'\').value=\'\'"; style="cursor:pointer;" /></td></tr></tbody></table>';
        }
    }else{
   ...
   if(module != "Quotes" && module != "Sparepart" && module != "Service"){
        ...
        colthree.style.textAlign='right';
        colthree.innerHTML='<span id="qtyInStock'+count+'">&nbsp;</span>';
    }

    //uom
    colfour.className = "crmTableRow small"
    colfour.innerHTML = '<input id="uom'+count+'" name="uom'+count+'" type="text" class="small uom" onfocus="this.className=\'uom detailedViewTextBoxOn\'"  onBlur="this.className=\'uom detailedViewTextBox\';" value=""/>';

    //Quantity
    var temp='';
    colfive.className = "crmTableRow small"
    temp='<input data-rowno="'+count+'" id="qty'+count+'" value="1" name="qty'+count+'" type="text" class="small qty" onfocus="this.className=\'qty detailedViewTextBoxOn\'" onBlur="this.className=\'qty detailedViewTextBox\';settotalnoofrows(); calcTotal(); set_tax_manual(); loadTaxes_Ajax('+count+');';
    if(module == "Invoice")
    {
    ...
    colnine.innerHTML ='<table width="100%" cellpadding="0" cellspacing="0"><tr><td align="right"><input data-rowno="'+count+'" id="listPrice'+count+'" name="listPrice'+count+'" value="0.00" type="text" class="small listprice" onfocus="this.className=\'detailedViewTextBoxOn\'" onBlur="this.className=\'detailedViewTextBox\';calcTotal();setDiscount(this,'+count+');callTaxCalc('+count+');calcTotal(); set_tax_manual();" style="width: 80% !important;" />&nbsp;<img id="searchIcon'+count+'" title="Price List" src="themes/images/icon_pricebook.png" style="cursor: pointer;" align="absmiddle" onclick="productPricelist(this,\''+module+'\','+count+')" width="10%" />';
...
function fnAddProductRowProjects(module,image_path){
    ...
    colthree.innerHTML='<span id="productcategory'+count+'" name="productcategory'+count+'"></span><span id="qtyInStock'+count+'">&nbsp;</span>';

    //uom
    colfour.className = "crmTableRow small"
    colfour.innerHTML = '<input id="uom'+count+'" name="uom'+count+'" type="text" class="detailedViewTextBox user-success uom" onfocus="this.className=\'uom detailedViewTextBoxOn\'"  onBlur="this.className=\'uom detailedViewTextBox\';" value=""/>';
    //Quantity
    var temp='';
    colfive.className = "crmTableRow small"
    temp='<input data-rowno="'+count+'" id="qty'+count+'" value="0" name="qty'+count+'" type="text" class="detailedViewTextBox user-success qty" onfocus="this.className=\'qty detailedViewTextBoxOn\'" onBlur="this.className=\'qty detailedViewTextBox\';settotalnoofrows(); loadTaxes_Ajax('+count+');';
    temp+='" onChange="setDiscount(this,'+count+')" value=""/><br><span id="stock_alert'+count+'"></span>';
    colfive.innerHTML=temp;

    colsix.className = "crmTableRow small"
    colsix.innerHTML = '<input data-rowno="'+count+'" id="qty_act'+count+'" name="qty_act'+count+'" type="text" class="detailedViewTextBox user-success qty_act" onfocus="this.className=\'qty_act detailedViewTextBoxOn\'" onblur="this.className=\'qty_act detailedViewTextBox\';" value="0"/>';
    
    colseven.className = "crmTableRow small"
    colseven.innerHTML = '<input data-rowno="'+count+'" id="qty_ship'+count+'" name="qty_ship'+count+'" type="text" class="detailedViewTextBox user-success qty_ship" onfocus="this.className=\'qty_ship detailedViewTextBoxOn\'" onblur="this.className=\'qty_ship detailedViewTextBox\';" value="0"/>';
    
    //List Price with Discount, Total after Discount and Tax labels
    coleight.className = "crmTableRow small"
    coleight.innerHTML ='<table width="100%" cellpadding="0" cellspacing="0"><tr><td align="right"><input data-rowno="'+count+'" id="listPrice'+count+'" width="100%" name="listPrice'+count+'" value="0" type="text" class="detailedViewTextBox user-success listprice" onfocus="this.className=\'listPrice detailedViewTextBoxOn\'" onBlur="this.className=\'listPrice detailedViewTextBox\';" />';
    
    colnine.className = "crmTableRow small"
    colnine.innerHTML = '<input data-rowno="'+count+'" id="listprice_total'+count+'" name="listprice_total'+count+'" type="text" class="detailedViewTextBox user-success listprice_total" onfocus="this.className=\'listprice_total detailedViewTextBoxOn\'" onblur="this.className=\'listprice_total detailedViewTextBox\';" value="0"/>';
    //colnine.innerHTML +='</td></tr>';
    //colnine.innerHTML +='</table> ';
