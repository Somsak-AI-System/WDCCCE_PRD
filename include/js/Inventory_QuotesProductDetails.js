...
function calcGrandTotal() {
    ...
    */
    ...
    bill_discount = document.getElementById("hdn_bill_discount").value;
    ...
    /**** Vat ****/
    tax_final = roundValue(total_after_bill_discount * 0.07);
    ...
    /**** คูปองส่วนลด (บาท)  ****/
    discount_coupons = document.getElementById("discount_coupons").value;
    ...
    if(pricetype=="Include Vat"){
        ...
        document.getElementById("netTotal").innerHTML = netTotal_inc.toString(); // TOTAL PRICE
        document.getElementById("subtotal").value = netTotal_inc; // TOTAL PRICE
        document.getElementById("discountTotal_final").value = sum_hdn_cal_discount_inc; // Discount
        document.getElementById("afterdis_final").innerHTML = total_after_discount_inc.toString(); // Total After Discount  
        ...
        document.getElementById("total_after_bill_discount").innerHTML = total_after_bill_discount_inc.toString(); // Total หลังลดท้ายบิล
        document.getElementById("hdn_total_after_bill_discount").value =  total_after_bill_discount_inc; // Total หลังลดท้ายบิล
        ...
        document.getElementById("tax_final").value = tax_final_inc; // Vat

        document.getElementById("total_after_vat").innerHTML = total_after_vat_inc.toString(); // Total Net Amount including VAT
        document.getElementById("total_without_vat").value = total_after_vat_inc; // Total Net Amount including VAT

        document.getElementById("grandTotal").innerHTML = grandTotal_inc.toString(); // Grand Total 
        document.getElementById("total").value = grandTotal_inc.toString(); // Grand Total
    }else{
        document.getElementById("netTotal").innerHTML = netTotal.toString(); // TOTAL PRICE
        document.getElementById("subtotal").value = netTotal; // TOTAL PRICE

        document.getElementById("discountTotal_final").value = sum_hdn_cal_discount; // Discount
        document.getElementById("afterdis_final").innerHTML = total_after_discount.toString(); // Total After Discount  
        document.getElementById("bill_discount").innerHTML = bill_discount.toString(); // ส่วนลดท้ายบิล

        document.getElementById("total_after_bill_discount").innerHTML = total_after_bill_discount.toString(); // Total หลังลดท้ายบิล
        document.getElementById("hdn_total_after_bill_discount").value =  total_after_bill_discount; // Total หลังลดท้ายบิล

        document.getElementById("tax_final").value = tax_final; // Vat

        document.getElementById("total_after_vat").innerHTML = total_after_vat.toString(); // Total Net Amount including VAT
        document.getElementById("total_without_vat").value = total_after_vat; // Total Net Amount including VAT

        document.getElementById("grandTotal").innerHTML = grandTotal.toString(); // Grand Total 
        document.getElementById("total").value = grandTotal.toString(); // Grand Total
    }
