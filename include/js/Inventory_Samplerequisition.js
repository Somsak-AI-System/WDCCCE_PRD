...
function fnAddProductRow(module,image_path){
    ...
    coltwo.innerHTML= '<table border="0" cellpadding="1" cellspacing="0" width="100%"><tr><td class="small">' +
        ...
        '<textarea id="productName'+count+'" name="productName'+count+'" class="detailedViewTextBox user-success" style="width:90%;height:40px" readonly="readonly"></textarea>'+
    ...
    // colthree.innerHTML='<input id="sr_finish'+count+'" name="sr_finish'+count+'" type="text" class="detailedViewTextBox user-success sr_finish" onfocus="this.className=\'sr_finish detailedViewTextBoxOn\'"  onBlur="this.className=\'sr_finish detailedViewTextBox\';settotalnoofrows();" value=""/>';
	colthree.innerHTML='<td class="crmTableRow small lineOnTop"><select class="small" id="sr_finish'+count+'" name="sr_finish'+count+'">'+getHTMLsr_finish("sr_finish"+count)+'</select></td>';

    colfour.className = "crmTableRow small"
    // colfour.innerHTML = '<input id="sr_size_mm'+count+'" name="sr_size_mm'+count+'" type="text" class="detailedViewTextBox user-success sr_size_mm" onfocus="this.className=\'sr_size_mm detailedViewTextBoxOn\'"  onBlur="this.className=\'sr_size_mm detailedViewTextBox\';settotalnoofrows();" value=""/>';
	colfour.innerHTML='<td class="crmTableRow small lineOnTop"><select class="small" id="sr_size_mm'+count+'" name="sr_size_mm'+count+'">'+getHTMLsr_size_mm("sr_size_mm"+count)+'</select></td>';
    
    // var temp='';
    // colfive.className = "crmTableRow small"
    // temp='<input data-rowno="'+count+'" id="sr_thickness_mm'+count+'" name="sr_thickness_mm'+count+'" type="text" class="detailedViewTextBox user-success sr_thickness_mm" onfocus="this.className=\'sr_thickness_mm detailedViewTextBoxOn\'" onBlur="this.className=\'sr_thickness_mm detailedViewTextBox\';settotalnoofrows();';
    // temp+='" onChange="setDiscount(this,'+count+')" value=""/><br><span id="stock_alert'+count+'"></span>';
    // colfive.innerHTML=temp;
	colfive.innerHTML='<td class="crmTableRow small lineOnTop"><select class="small" id="sr_thickness_mm'+count+'" name="sr_thickness_mm'+count+'">'+getHTMLsr_thickness_mm("sr_thickness_mm"+count)+'</select></td>';

    colsix.className = "crmTableRow small"
    colsix.innerHTML = '<input data-rowno="'+count+'" id="sr_product_unit'+count+'" name="sr_product_unit'+count+'" type="text" class="detailedViewTextBox user-success sr_product_unit" onfocus="this.className=\'qty_act detailedViewTextBoxOn\'" onblur="this.className=\'sr_product_unit detailedViewTextBox\';settotalnoofrows();"/>';
    
    colseven.className = "crmTableRow small"
    colseven.innerHTML = '<input data-rowno="'+count+'" id="amount_of_sample'+count+'" name="amount_of_sample'+count+'" type="text" class="detailedViewTextBox user-success amount_of_sample" onfocus="this.className=\'amount_of_sample detailedViewTextBoxOn\'" onblur="this.className=\'amount_of_sample detailedViewTextBox\';calcTotalamountsample();settotalnoofrows();" value="0"/>';
    
    //List Price with Discount, Total after Discount and Tax labels
    coleight.className = "crmTableRow small"
    coleight.innerHTML ='<table width="100%" cellpadding="0" cellspacing="0"><tr><td align="right"><input data-rowno="'+count+'" id="amount_of_purchase'+count+'" width="100%" name="amount_of_purchase'+count+'" value="0" type="text" class="detailedViewTextBox user-success amount_of_purchase" onfocus="this.className=\'amount_of_purchase detailedViewTextBoxOn\'" onBlur="this.className=\'amount_of_purchase detailedViewTextBox\';calcTotalamount();settotalnoofrows();" />';
...
function getHTMLsr_finish(id){
    // Fetch data from the PHP file
    fetch('getSamplerequisitionProductDetails.php?function=sr_finish')
...
function getHTMLsr_size_mm(id){
    // Fetch data from the PHP file
    fetch('getSamplerequisitionProductDetails.php?function=sr_size_mm')
    .then(response => response.json())
    .then(data => {
        // Call the function to populate the select element
        populateSelect(id,data);
...
function getHTMLsr_thickness_mm(id){
    // Fetch data from the PHP file
    fetch('getSamplerequisitionProductDetails.php?function=sr_thickness_mm')
    .then(response => response.json())
    .then(data => {
        // Call the function to populate the select element
        populateSelect(id,data);
