...
function copyAddressRight(form,module) {
	...
	if(module=='Accounts')	{	
		if(typeof(form.cf_551) != 'undefined' && typeof(form.cf_553) != 'undefined')
			form.cf_551.value = form.cf_553.value;	
		if(typeof(form.cf_552) != 'undefined' && typeof(form.cf_554) != 'undefined')
			form.cf_552.value = form.cf_554.value;	
		if(typeof(form.ship_code) != 'undefined' && typeof(form.bill_code) != 'undefined')
			form.ship_code.value = form.bill_code.value;	
	}else if (module=='Quotes'){
		if(typeof(form.cf_563) != 'undefined' && typeof(form.cf_561) != 'undefined')
			form.cf_563.value = form.cf_561.value;
		if(typeof(form.cf_564) != 'undefined' && typeof(form.cf_562) != 'undefined')
			form.cf_564.value = form.cf_562.value;		
		...
		if(typeof(form.cf_617) != 'undefined' && typeof(form.cf_618) != 'undefined')
			form.cf_618.value = form.cf_617.value;
	}
	return true;

}

function copyAddressLeft(form,module) {
	if(typeof(form.bill_street) != 'undefined' && typeof(form.ship_street) != 'undefined')
	...
	if(module=='Accounts')	{	
		...
		if(typeof(form.cf_561) != 'undefined' && typeof(form.cf_563) != 'undefined')
			form.cf_561.value = form.cf_563.value;
		if(typeof(form.cf_562) != 'undefined' && typeof(form.cf_564) != 'undefined')
			form.cf_562.value = form.cf_564.value;	
	}else if (module=='SalesOrder'){
		if(typeof(form.cf_616) != 'undefined' && typeof(form.cf_615) != 'undefined')
			form.cf_615.value = form.cf_616.value;
	}else if (module=='Invoice'){
		if(typeof(form.cf_617) != 'undefined' && typeof(form.cf_618) != 'undefined')
			form.cf_617.value = form.cf_618.value;
	}
...
function settotalnoofrows(){
	...
	//alert(document.EditView.totalProductCount.value);
...
function productPickList(currObj,module, row_no) {
    ...
    if(record_id != '')
    	window.open("index.php?module=Products&action=Popup&html=Popup_picker&select=enable&form=HelpDeskEditView&popuptype="+popuptype+"&curr_row="+rowId+"&relmod_id="+record_id+"&parent_module=Accounts&return_module="+module+"&currencyid=","productWin","width=640,height=600,resizable=0,scrollbars=0,status=1,top=150,left=200");
    else
		window.open("index.php?module=Products&action=Popup&html=Popup_picker&select=enable&form=HelpDeskEditView&popuptype="+popuptype+"&curr_row="+rowId+"&return_module="+module+"&currencyid=","productWin","width=640,height=600,resizable=0,scrollbars=0,status=1,top=150,left=200");
}
...
function calcProductTotal(rowId) {	//alert("66");
...
{//alert("5556");
	...
	for (var i=1;i<=max_row_count;i++) 
	{
		...
		i//f (!emptyCheck("qty"+i,"Qty","text")) return false
...
function fnAddProductRow(module,image_path){
	...
	colthree.innerHTML='<input id="qty'+count+'" name="qty'+count+'" type="text" class=\'detailedViewTextBox\'" onBlur="this.className=\'detailedViewTextBox\'" onFocus="this.className=\'detailedViewTextBoxOn\'"   style="width:50px"   /><br><span id="stock_alert'+count+'"></span>';

	colfour.className = "crmTableRow small"
	colfour.innerHTML='<textarea id="problem'+count+'" name="problem'+count+'" class=\'detailedViewTextBox\'" onBlur="this.className=\'detailedViewTextBox\'" onFocus="this.className=\'detailedViewTextBoxOn\'" style="width:250px;height:50px"></textarea>';
...
function updatePriceValues(pricesList) {//alert("66666");
