...
/** Class to retreive all the aicrm_users present in a group 
 *
 */
...
class GetGroupUsers { 
	...
	/** to get all the aicrm_users and aicrm_groups of the specified group
	 * @params $groupId --> Group Id :: Type Integer
         * @returns the aicrm_users present in the group in the variable $parent_groups of the class
         * @returns the sub aicrm_groups present in the group in the variable $group_subgroups of the class
         */
	function getAllUsersInGroup($groupid)
	{
		...
		//Retreiving from the aicrm_group2role
		...
		//Retreiving from the aicrm_group2rs
