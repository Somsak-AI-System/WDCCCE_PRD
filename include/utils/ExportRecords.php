...
$isRestrictedExportModule = in_array($currentModule, $exportRestrictedModules, true);
$isAllowedExportRole = in_array($current_user->roleid, $exportAllowedRoles, true);

if(($isRestrictedExportModule && !$isAllowedExportRole) || (!$isRestrictedExportModule && !is_admin($current_user) && (isPermitted($currentModule, 'Export') != 'yes'))) {	
