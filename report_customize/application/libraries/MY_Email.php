...
<head>
    ...
    <style type="text/css">
        ...
        Bring inline: No.*/
        table td,table th {  padding:2px !important; border:1px solid #333;  width:100%; table-layout:fixed;} 

        /* Remove spacing around Outlook 07, 10 tables
        Bring inline: Yes */
        table { border-collapse:collapse;width:100% !important; border:1px solid #333;table-layout:fixed; }
