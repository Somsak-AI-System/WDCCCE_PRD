...
//  * XOBject Templates;
//  * Layers and object visibility.eader
//	* PDF/A-1b support
//============================================================+
...
class TCPDF {
	...
	public function setPage($pnum, $resetmargins=false) {
		...
		if (($pnum > 0) AND ($pnum <= $this->numpages)) {//echo "yyy";
			$this->state = 2;
			// save current graphic settings
			//$gvars = $this->getGraphicVars();
			$oldpage = $this->page;
	 ...
	 * @public
	 */
	public function startPage($orientation='', $format='', $tocpage=false,$type) {
		if ($tocpage) {
			$this->tocpage = true;
		}
	 ...
	 * @public
	 */
	 public function get_chk_page_no() {
		 $this->chk_page_no=$this->chk_page_no+1;
		return $this->chk_page_no;	 
	 }
	 
	

		public function Header($type) {
		//global $user_name,$sale_name1,$sale_name2,$data_so,$address,$address1,$address2,$q_date;
        $this->SetY(10);
		
		/*$image_file = K_PATH_IMAGES.'logo.png';
        $this->Image($image_file, 5, 5, 40, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		$this->SetXY(0,13);*/
		$this->Cell(-10, 380, 'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'R', 0, '', 0, false, 'T', 'M');
		//$this->Ln();
		//$this->SetXY(50,100);
		$this->SetFont('thsarabun', 'y', 10);
		//$this->SetFont('freeserif', 'y', 8);
		//echo $this->chk_page_no."<br/>";		

		if($type != ''){
			session_start();	
			$_SESSION['checktype'] = $type;
		}

			if(($_SESSION['checktype'] == 'BG') && ($this->chk_page_no > 1)){
					$this->Header_BG2();
					$this->chk_page_no=$this->chk_page_no+1;
			}else if(($_SESSION['checktype'] == 'BG') && ($this->chk_page_no = 1)){
					$this->Header_BG1();
					$this->chk_page_no=$this->chk_page_no+1;
			}else if(($_SESSION['checktype'] == 'BK') && ($this->chk_page_no > 1)){
					$this->Header_BK2();
					$this->chk_page_no=$this->chk_page_no+1;
			}else if(($_SESSION['checktype'] == 'BK') && ($this->chk_page_no = 1)){
					$this->Header_BK1();
	...
	public function Header_BG1(){
			$this->SetXY(15,56);	
			$html='
			
			<table  style="width:100%;" border="1" bordercolor="#000000">
			 <tr align="center">
				<td rowspan="2" scope="col" width="4%">ลำดับ</td>
				<td rowspan="2" scope="col" width="7%">เลขที่ <br />ใบขนสินค้า</td>
				<td rowspan="2" scope="col" width="7%">หมายเลข <br />ทะเบียนรถ</td>
				<td rowspan="2" scope="col" width="22%">ขนิดปูน</td>
				
				<td colspan="5" scope="col" width="24%">ยอดจ่าย</td>
				
				<td rowspan="2" scope="col" width="5%">เวลาชั่งเข้า <br />(ชม : นาที)</td>
				<td rowspan="2" scope="col" width="5%">เวลาเริ่ม<br />บรรจุ <br />(ชม : นาที)</td>
				<td rowspan="2" scope="col" width="6%">เวลาบรรจุ<br />เสร็จ <br />(ชม : นาที)</td>
				<td rowspan="2" scope="col" width="6%">ใช้เวลาบรรจุ <br />(ชม : นาที)</td>
				<td rowspan="2" scope="col" width="14%">ปัญหาสาเหตุ/จ่ายปูนล่าช้า</td>
			 </tr>
			 <tr align="center">
				<td  width="4%">เครื่องที่</td>
				<td  width="4%">ช่องจ่าย</td>
				<td  width="4%">ไซโล</td>	
				<td  width="6%">จำนวน <br />ถุง</td>
				<td  width="6%">จำนวน <br />ตัน</td>
			 </tr>
			 </table>
	 ';
	$this->writeHTML($html, true, 0, true, 0);
	}
		public function Header_BG2(){
			$this->SetXY(15,13.7);
			$html='
	...
	public function Header_BK1(){
		$this->SetXY(15,53);	
			$html='
			
			<table  style="width:100%;" border="1" bordercolor="#000000">
			 <tr align="center">
				<td rowspan="1" scope="col" width="3%">ลำ<br/>ดับ</td>
				<td rowspan="1" scope="col" width="6%">เลขที่<br/>ใบขน</td>
				<td rowspan="1" scope="col" width="15%">ปูน</td>
				<td rowspan="1" scope="col" width="6%">หมายเลข <br />ทะเบียนรถ</td>
				<td rowspan="1" scope="col" width="3%">Time In</td>
				
				<td rowspan="1" scope="col" width="3%">LI</td>
				<td rowspan="1" scope="col" width="3%">LO</td>
				<td rowspan="1" scope="col" width="3%">โรง<br/>งาน</td>
				<td rowspan="1" scope="col" width="3%">ไซโล</td>
				<td rowspan="1" scope="col" width="5%">ช่องจ่าย</td>
				
				<td rowspan="1" scope="col" width="5%">Capacity</td>
				<td rowspan="1" scope="col" width="3%">เวลา<br/>รวม</td>
				<td rowspan="1" scope="col" width="4%">นน.ตาม<br>ใบขน</td>
				<td rowspan="1" scope="col" width="4%">นน.รถ<br>เปล่า</td>
				<td rowspan="1" scope="col" width="4%">นน.รวม</td>
				<td rowspan="1" scope="col" width="4%">นน.ปูน</td>
				<td rowspan="1" scope="col" width="4%">รูปแบบ</td>
				<td rowspan="1" scope="col" width="9%">ประเภท<br>รถ</td>
				<td rowspan="1" scope="col" width="13%">Remark</td>

			 </tr>
			 </table>';
			 $this->writeHTML($html, true, 0, true, 0);
	}
	public function Header_BK2(){
			...
			<table  style="width:100%;" border="1" bordercolor="#000000">
			 <tr align="center">
				...
				<td rowspan="1" scope="col" width="15%">ปูน</td>
				<td rowspan="1" scope="col" width="6%">หมายเลข <br />ทะเบียนรถ</td>
				<td rowspan="1" scope="col" width="3%">Time<br/>In</td>
	...
	public function Header_20151102() {
	...
	public function Footer() {
		global $user_name,$sale_name1,$sale_name2,$data_so;
		$this->SetXY(5,-25);
		$this->SetFont('cordiaupc', 'n', 12);

		/*$html='
<table width="100%" border="0" cellspacing="3" cellpadding="0" style="border-top: 1px solid black;">
  <tr>
    <td width="35%" height="25" align="center">'.iconv('tis-620','utf-8',$sale_name1).'</td>
    <td width="35%" align="center">'.iconv('tis-620','utf-8',$sale_name2).'</td>
    <td width="30%" rowspan="2" align="center">
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
        <td height="25" align="center" valign="middle">พนักงานขาย / Sales Staff</td>
        </tr>
        <tr>
        <td height="25" align="center" valign="middle">'. iconv('tis-620','utf-8',$user_name).'</td>
        </tr>
        </table>
    </td>
  </tr>
  <tr>
    <td height="25" align="center">ผู้เสนอราคา / Bidder</td>
    <td align="center">ผู้อนุมัติ / Approvers</td>
  </tr>
  <tr>
    <td height="25" align="center">'.'วันที่ / Date '.date('d/m/Y').'</td>
    <td align="center">'.'วันที่ / Date '.date('d/m/Y').'</td>
    <td align="center">F-SL-002 REV.1 1 มิถุนายน 2557</td>
  </tr>
</table>
		...
		$this->writeHTML($html, true, 0, true, 0);
	/*	$this->SetXY(35,-18);
		$this->Cell(10, 15,  "…………………………………………", 0, false, 'C', 0, '', 0, false, 'M', 'M');
		$this->SetXY(105,-18);
		$this->Cell(10, 15,  "…………………………………………", 0, false, 'C', 0, '', 0, false, 'M', 'M');*/
    }
	public function Footer_20151102() {
		$cur_y = $this->y;
	 ...
	 * @since 4.0.012 (2008-07-24)
	 */
	protected function setHeader() { //echo "ff".$this->state;
