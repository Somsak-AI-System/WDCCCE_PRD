...
class TCPDF {
	...
	public function Header($type) {
		...
		if ($this->chk_page_no == 1){
			 		$this->chk_page_no = $this->chk_page_no+1;
		}else if(($_SESSION['checktype'] == 'BG' || $_SESSION['checktype'] == 'BB' ) && ($this->chk_page_no != 1)){
					$this->Header_BG();
					$this->chk_page_no=$this->chk_page_no+1;
	...
	public function Header_BG(){
			$this->SetXY(15,13.8);
			$html='<table  style="width:100%;" border="1" bordercolor="#000000" >
					 <tr align="center">
						<td rowspan="2" scope="col" width="5%">ลำดับ</td>
						<td rowspan="2" scope="col" width="9%">เลขที่ <br />ใบขนสินค้า</td>
						<td rowspan="2" scope="col" width="9%">หมายเลข <br />ทะเบียนรถ</td>
						
						<td colspan="5" scope="col" width="29%">ยอดจ่าย</td>
						
						<td rowspan="2" scope="col" width="7%">เวลาชั่งเข้า <br />(ชม : นาที)</td>
						<td rowspan="2" scope="col" width="7%">เวลาเริ่ม<br />บรรจุ <br />(ชม : นาที)</td>
						<td rowspan="2" scope="col" width="7%">เวลาบรรจุ<br />เสร็จ <br />(ชม : นาที)</td>
						<td rowspan="2" scope="col" width="8%">ใช้เวลาบรรจุ <br />(ชม : นาที)</td>
						<td rowspan="2" scope="col" width="19%">ปัญหาสาเหตุ/จ่ายปูนล่าช้า</td>
					 </tr>
					 <tr align="center">
						<td  width="5%">เครื่องที่</td>
						<td  width="5%">ช่องจ่าย</td>
						<td  width="5%">ไซโล</td>	
						<td  width="7%">จำนวน <br />ถุง</td>
						<td  width="7%">จำนวน <br />ตัน</td>
					 </tr>
					 </table>';
		$this->writeHTML($html, true, 0, true, 0);
	}
	
	public function Header_BK(){
		$this->SetXY(15,18);
			  $html='<table  style="width:100%;" border="1" bordercolor="#000000">
				 <tr align="center">
					<td rowspan="1" scope="col" width="3%">ลำ<br/>ดับ</td>
					<td rowspan="1" scope="col" width="6%">เลขที่<br/>ใบขนสินค้า</td>
					<td rowspan="1" scope="col" width="6%">หมายเลข <br />ทะเบียนรถ</td>
					<td rowspan="1" scope="col" width="4%">Time In</td>
					
					<td rowspan="1" scope="col" width="4%">LI</td>
					<td rowspan="1" scope="col" width="4%">LO</td>
					<td rowspan="1" scope="col" width="4%">โรง<br/>งาน</td>
					<td rowspan="1" scope="col" width="4%">ไซโล</td>
					<td rowspan="1" scope="col" width="5%">ช่องจ่าย</td>
					
					<td rowspan="1" scope="col" width="5%">Capacity</td>
					<td rowspan="1" scope="col" width="4%">เวลา<br/>รวม</td>
					<td rowspan="1" scope="col" width="5%">นน.ตาม<br>ใบขน</td>
					<td rowspan="1" scope="col" width="5%">นน.รถ<br>เปล่า</td>
					<td rowspan="1" scope="col" width="5%">นน.รวม</td>
					<td rowspan="1" scope="col" width="5%">นน.ปูน</td>
					<td rowspan="1" scope="col" width="5%">รูปแบบ</td>
					<td rowspan="1" scope="col" width="11%">ประเภท<br>รถ</td>
					<td rowspan="1" scope="col" width="15%">Remark</td>
			 </tr>
			 </table>';  
			 $this->writeHTML($html, true, 0, true, 0);
	}
...
<table width="100%" border="0" cellspacing="3" cellpadding="0" style="border-top: 1px solid black;">
  ...
  <tr>
	 ...
	 * @since 4.0.012 (2008-07-24)
	 */
	protected function setHeader($type='') { //echo "ff".$this->state;
