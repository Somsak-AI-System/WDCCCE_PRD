...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->name=$focus->column_fields['SmartSms_name'];
}
if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') 
{
	...
	$focus->column_fields['smartsms_name']="";
	//$focus->column_fields['sms_template_type']="SMS Marketing";
	$focus->column_fields['sms_status']= "Prepare";
	$focus->column_fields['setup_sms']= "0";
	$focus->column_fields['send_sms']= "0";
	$focus->column_fields['sms_start_date']=date('Y-m-d');
	$focus->column_fields['sms_start_time']=date("H:i", strtotime((date("H:i")) . "+15 minutes"));
