...
{
	$rel_table = 'aicrm_smartsms_emailtargetrel';
}
elseif($update_mod == 'Contacts')
{
	$rel_table = 'aicrm_smartsms_contactsrel';
}
elseif($update_mod == 'Users')
{
	$rel_table = 'aicrm_smartsms_usersrel';
}
elseif($update_mod == 'Leads')
{
	$rel_table = 'aicrm_smartsms_leadsrel';
}
elseif($update_mod == 'Accounts')
{
	$rel_table = 'aicrm_smartsms_accountsrel';
}
elseif($update_mod == 'Opportunity')
{
	$rel_table = 'aicrm_smartsms_opportunityrel';
}
elseif($update_mod == 'Questionnaire')
{
	$rel_table = 'aicrm_smartsms_questionnairerel';
}
