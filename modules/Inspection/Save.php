...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "InspectionList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_inspectionlist_inspectionrel  where inspectionid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_inspectionlist_inspectionrel  values (?,?)";
