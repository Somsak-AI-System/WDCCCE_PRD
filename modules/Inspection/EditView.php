...
require_once('include/utils/utils.php');require_once('modules/Inspection/Inspection.php');
...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='')
{
	...
	$focus->name=$focus->column_fields['inspection_name'];
}else{
	$focus->column_fields['cf_3340']=  "Yes";
}
...
{
    if($_REQUEST['return_module'] == 'Building') {
        require_once('modules/Building/Building.php');
        $focus->column_fields['buildingid'] = $_REQUEST['parent_id'];
        $ins_focus = new Building();
        $ins_focus->retrieve_entity_info($_REQUEST['parent_id'], "Building");
        $focus->column_fields['projectid']=$ins_focus->column_fields['projectid'];
...
// END
$picklistDependencyDatasource = Vtiger_DependencyPicklist::getPicklistDependencyDatasource("Inspection");
