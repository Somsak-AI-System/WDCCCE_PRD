...
$focus->initSortbyField('Inspection');
// END
...
$_SESSION['INSPECTION_ORDER_BY'] = $order_by;
$_SESSION['INSPECTION_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Inspection','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Inspection','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Inspection");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Inspection");
}else
{
	$query = getListQuery("Inspection");
}
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Inspection',$order_by);
...
$listview_header = getListViewHeader($focus,"Inspection",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Inspection",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Inspection",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Inspection","index",$viewid);
