...
$focus->initSortbyField('Smartquestionnaire');
// END
...
$_SESSION['EMAILTARGETLIST_ORDER_BY'] = $order_by;
$_SESSION['EMAILTARGETLIST_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Smartquestionnaire','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Smartquestionnaire','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Smartquestionnaire");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Smartquestionnaire");
}else
{
	$query = getListQuery("Smartquestionnaire");
}
//echo $query;
//<<<<<<<<customview>>>>>>>>>
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Smartquestionnaire',$order_by);
...
$listview_header = getListViewHeader($focus,"Smartquestionnaire",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Smartquestionnaire",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Smartquestionnaire",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Smartquestionnaire","index",$viewid);
