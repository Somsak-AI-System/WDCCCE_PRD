...
{
	$rel_table = 'aicrm_smartquestionnaire_emailtargetrel';
}
elseif($update_mod == 'Contacts')
{
	$rel_table = 'aicrm_smartquestionnaire_contactsrel';
}
elseif($update_mod == 'Users')
{
	$rel_table = 'aicrm_smartquestionnaire_usersrel';
}
elseif($update_mod == 'Leads')
{
	$rel_table = 'aicrm_smartquestionnaire_leadsrel';
}
elseif($update_mod == 'Accounts')
{
	$rel_table = 'aicrm_smartquestionnaire_accountsrel';
}
elseif($update_mod == 'Opportunity')
{
	$rel_table = 'aicrm_smartquestionnaire_opportunityrel';
}
elseif($update_mod == 'Questionnaire')
{
	$rel_table = 'aicrm_smartquestionnaire_questionnairerel';
}
...
foreach($storearray as $id)
{
	if($id != '')
	{
		if ($update_mod == 'Questionnaire' || $update_mod == 'Opportunity' || $update_mod == 'EmailTarget' || $update_mod == 'Contacts' || $update_mod == 'Users' || $update_mod == 'Leads' || $update_mod == 'Accounts') {
