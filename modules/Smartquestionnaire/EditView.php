...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->name=$focus->column_fields['Smartquestionnaire_name'];		
}
if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') 
{
	...
	//$focus->column_fields['smartquestionnaire_name']="";
	$focus->column_fields['send_date']="";
	$focus->column_fields['send_time']="";
	$focus->column_fields['prepare_date']="";
	$focus->column_fields['prepare_time']="";
	$focus->column_fields['email_setup']= "0";
	$focus->column_fields['email_send']= "0";
	$focus->column_fields['prepare_status']="no";
	$focus->column_fields['send_status']="no";
	$focus->column_fields['send_date'] = date("Y-m-d");
    $focus->column_fields['send_time'] = date("H:i");
	$focus->column_fields['smartquestionnaire_status'] = 'Prepare';
	$focus->column_fields['email_start_time']= "";
}
