...
if(isPermitted("Questionnaire","EditView",$_REQUEST['record']) == 'yes')
	$smarty->assign("EDIT_DUPLICATE","permitted");

	
$smarty->assign("CREATEPDF","permitted");

if(isPermitted("Questionnaire","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Questionnaire',$focus));
...
WHERE aicrm_questionnaire.questionnaireid = '".$focus->id."' order by aicrm_questionnaire_page.pageid asc, aicrm_questionnaire_choice.choiceid asc , aicrm_questionnaire_choicedetail.choicedetailid asc";
...
$smarty->assign('DETAILVIEW_AJAX_EDIT', PerformancePrefs::getBoolean('DETAILVIEW_AJAX_EDIT', true));
$smarty->display("Questionnaire/InventoryDetailView.tpl");
