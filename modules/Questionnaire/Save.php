...
$Questionnaire = new libquestionnaire($dbconfig);
$Questionnaire->save_questionnaire($qustionnairetemplate,$focus->id,$_REQUEST['mode'],$questionnaire_answer,$questionnairetemplateid);

$parenttab = getParentTab();
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] != "") $return_module = vtlib_purify($_REQUEST['return_module']);
else $return_module = "Questionnaire";
...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "Accounts")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		...
		$adb->pquery($sql, array($_REQUEST['return_id'],$_REQUEST['return_module'],$focus->id,"Questionnaire"));
	}
}
