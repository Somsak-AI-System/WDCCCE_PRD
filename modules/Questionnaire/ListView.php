...
$focus->initSortbyField('Questionnaire');
// END
...
$_SESSION['QUESTIONNAIRE_ORDER_BY'] = $order_by;
$_SESSION['QUESTIONNAIRE_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Questionnaire','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Questionnaire','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Questionnaire");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Questionnaire");
}else
{
	$query = getListQuery("Questionnaire");
}
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid'){
			...
			$tablename = getTableNameForField('Questionnaire',$order_by);
...
$listview_header = getListViewHeader($focus,"Questionnaire",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Questionnaire",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Questionnaire",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Questionnaire","index",$viewid);
