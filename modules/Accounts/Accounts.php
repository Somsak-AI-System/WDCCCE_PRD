...
class Accounts extends CRMEntity {
	...
	var $list_fields = Array(
		...
		'สถานะลูกค้า'=>Array('aicrm_account'=>'accountstatus'),
	);
	...
	*/
	...
	function get_quotes($id, $cur_tab_id, $rel_tab_id, $actions=false) {
		...
		$query = "SELECT CASE WHEN aicrm_users.id IS NOT NULL THEN CONCAT(aicrm_users.first_name, ' ', aicrm_users.last_name) ELSE aicrm_groups.groupname END AS user_name,
			aicrm_crmentity.*, aicrm_quotes.*, aicrm_quotescf.*, aicrm_account.accountname, aicrm_projects.projects_name
			FROM aicrm_quotes
