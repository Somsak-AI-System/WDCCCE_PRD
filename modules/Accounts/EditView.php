 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/modules/Accounts/EditView.php,v 1.19 2005/03/24 16:18:38 samk Exp $
...
if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') {
    /*$focus->column_fields['accountstatus']='Non-Account';
...
if(empty($_REQUEST['record']) && $focus->mode != 'edit'){
    ...
    $focus->column_fields['register_date']=date('Y-m-d');
	/*$focus->column_fields['accountstatus']='Non-Account';
    $focus->column_fields['approved_status']='--None--';
    $focus->column_fields['emailstatus']='Active';*/
}
...
$passed_inspection = $adb->query_result($query,0,'passed_inspection');
// echo $passed_inspection; exit;
$smarty->assign('HIDDEN_FIELDS', $passed_inspection);
