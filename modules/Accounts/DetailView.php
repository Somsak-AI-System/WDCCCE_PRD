 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/modules/Accounts/DetailView.php,v 1.37 2005/04/18 10:37:49 samk Exp $
...
global $log, $currentModule, $singlepane_view, $report_viewer_url ,$report_viewer_url_pdf ;
...
//echo "<pre>"; print_r(getBlocks("Accounts","detail_view",'',$focus->column_fields)); echo "</pre>";
...
/*$pquery = "select approved_status from aicrm_account where accountid = '".$focus->id."' ";
$cf_res = $adb->pquery($pquery,'');
$approved_status=$adb->query_result($cf_res, 0, "approved_status");*/

$approved_status = 0;
$smarty->assign('approved_status', $approved_status);
