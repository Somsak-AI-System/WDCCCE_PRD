 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/modules/Contacts/EditView.php,v 1.21 2005/03/24 16:18:38 samk Exp $
...
if(isset($_REQUEST['account_id']) && $_REQUEST['account_id']!='' && $_REQUEST['record']=='')
{
        ...
        $acct_focus->retrieve_entity_info($_REQUEST['account_id'],"Accounts");
      	$focus->column_fields['addressline']=$acct_focus->column_fields['addressline1'];
		$focus->column_fields['con_villageno']=$acct_focus->column_fields['addressline2'];
		$focus->column_fields['con_village']=$acct_focus->column_fields['buildings'];
		$focus->column_fields['con_lane']=$acct_focus->column_fields['alley'];
		$focus->column_fields['con_street']=$acct_focus->column_fields['accountroad'];
...
if(empty($_REQUEST['record']) && $focus->mode != 'edit'){
    ...
    /*$focus->column_fields['cf_2935']='Active';
    $focus->column_fields['emailstatus']='Active';*/
}
...
//needed when creating a new contact with a default aicrm_account value passed in
