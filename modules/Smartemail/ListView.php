...
$focus->initSortbyField('Smartemail');
// END
...
$_SESSION['SMARTEMAIL_ORDER_BY'] = $order_by;
$_SESSION['SMARTEMAIL_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Smartemail','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Smartemail','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Smartemail");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Smartemail");
}else
{
	$query = getListQuery("Smartemail");
}
//echo $query;
//<<<<<<<<customview>>>>>>>>>
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Smartemail',$order_by);
...
$listview_header = getListViewHeader($focus,"Smartemail",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Smartemail",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Smartemail",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Smartemail","index",$viewid);
