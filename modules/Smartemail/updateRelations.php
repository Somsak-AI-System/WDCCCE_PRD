...
{
	$rel_table = 'aicrm_smartemail_emailtargetrel';
}
elseif($update_mod == 'Contacts')
{
	$rel_table = 'aicrm_smartemail_contactsrel';
}
elseif($update_mod == 'Users')
{
	$rel_table = 'aicrm_smartemail_usersrel';
}
elseif($update_mod == 'Leads')
{
	$rel_table = 'aicrm_smartemail_leadsrel';
}
elseif($update_mod == 'Accounts')
{
	$rel_table = 'aicrm_smartemail_accountsrel';
}
elseif($update_mod == 'Opportunity')
{
	$rel_table = 'aicrm_smartemail_opportunityrel';
}
elseif($update_mod == 'Questionnaire')
{
	$rel_table = 'aicrm_smartemail_questionnairerel';
}
