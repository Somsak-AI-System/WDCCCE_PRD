...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "PromotionvoucherList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_promotionvoucherlist_promotionvoucherrel  where promotionvoucherid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_promotionvoucherlist_promotionvoucherrel  values (?,?)";
