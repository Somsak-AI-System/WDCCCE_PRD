...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->name=$focus->column_fields['promotionvoucher_name'];		
}
if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') 
{
	$focus->id = "";
    $focus->mode = '';
    $focus->column_fields['voucher_status']='สร้าง';
    $focus->column_fields['promotion_start_date']=date('Y-m-d');
	$focus->column_fields['promotion_end_date']=date('Y-m-d');
}
