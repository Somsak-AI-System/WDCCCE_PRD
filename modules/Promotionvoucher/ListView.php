...
$focus->initSortbyField('Promotionvoucher');
// END
...
$_SESSION['PROMOTION_ORDER_BY'] = $order_by;
$_SESSION['PROMOTION_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Promotionvoucher','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Promotionvoucher','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Promotionvoucher");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Promotionvoucher");
}else
{
	$query = getListQuery("Promotionvoucher");
}
//<<<<<<<<customview>>>>>>>>>
...
if($order_by == ''){
	$order_by="promotionvoucher_no desc";
	$sorder="";
}
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Promotionvoucher',$order_by);
...
$listview_header = getListViewHeader($focus,"Promotionvoucher",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Promotionvoucher",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Promotionvoucher",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Promotionvoucher","index",$viewid);
