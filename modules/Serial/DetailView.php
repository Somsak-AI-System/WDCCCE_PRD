...
if(isPermitted("Serial","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Serial","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Serial',$focus));
