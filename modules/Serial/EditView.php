...
require_once('include/utils/utils.php');require_once('modules/Serial/Serial.php');
...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Serial");
	$focus->name=$focus->column_fields['serial_name'];		
}
...
if($focus->mode != 'edit' && $mod_seq_field != null) {
		...
		//echo "<pre>"; print_r($mod_seq_string); echo "</pre>"; exit;
        $mod_seq_prefix = $adb->query_result($mod_seq_string,0,'prefix');
        $mod_seq_no = $adb->query_result($mod_seq_string,0,'cur_id');
        //echo "<pre>"; print_r($focus->checkModuleSeqNumber($focus->table_name, $mod_seq_field['column'], $mod_seq_prefix.$mod_seq_no)); echo "</pre>"; exit;
