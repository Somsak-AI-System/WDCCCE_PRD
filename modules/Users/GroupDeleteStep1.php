...
<tr>
	...
	<td align="right" class="small"><img src="'. aicrm_imageurl('close.gif', $theme) .'" border=0 alt="'.$app_strings["LBL_CLOSE"].'" title="'.$app_strings["LBL_CLOSE"].'" style="cursor:pointer" onClick="document.getElementById(\'DeleteLay\').style.display=\'none\'";></td>
</tr>
</table>
...
<tr>
	...
	<tr>
		...
		global $adb;	
		$sql = "select groupid,groupname from aicrm_groups";
		$result = $adb->pquery($sql, array());
		$num_groups = $adb->num_rows($result);
	
		$sql1 = "select id,user_name from aicrm_users where deleted=0";
