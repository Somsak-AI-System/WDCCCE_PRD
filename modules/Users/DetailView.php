 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/modules/Users/DetailView.php,v 1.21 2005/04/19 14:44:02 ray Exp $
...
if(isset($focus->imagename) && $focus->imagename!='')
{
	...
	<div class='selected' id='handle1' style='width: 18px; height: 18px; position: relative; left: 145px;cursor:pointer;'><img src='" . aicrm_imageurl('scaler_slider.gif', $theme) . "'></div>
	</div>
...
$lead_tables = Array('aicrm_users','aicrm_user2role');
		...
		<div style="border: 3px solid rgb(153, 153, 153); background-color: rgb(255, 255, 255); width: 55%; position: relative; z-index: 10000000;">
			...
			<tr>
				<td rowspan="2" width="11%">
				  	<img src="'. aicrm_imageurl('denied.gif', $theme).'">
				</td>
