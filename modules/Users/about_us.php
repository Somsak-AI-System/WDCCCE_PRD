...
if($patch_version !='')
{
	    $patch_string = $aicrm_current_version . " Patch " . $patch_version;
}
else
{
	    $patch_string = $aicrm_current_version;
}
global $app_strings;
...
<table border="0" cellpadding="0" cellspacing="0" width="500">
		<tr>
				<td colspan="3"><img src="<?php echo aicrm_imageurl('aboutUS.jpg', $theme) ?>" width="500" height="301"></td>
		</tr>
		<tr>
...
<tr><td><a href="javascript:;" onClick=" newpopup('http://tcpdf.sourceforge.net')">TCPDF</a></td></tr>
		...
		<tr>
		  <td colspan="3" background="<?php echo aicrm_imageurl('about_btm.jpg', $theme) ?>" height="75">
