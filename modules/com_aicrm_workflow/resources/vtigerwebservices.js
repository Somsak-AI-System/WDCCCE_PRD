...
//vtInst = new VtigerWebservices("http://localhost:8090/MOAISTD/webservice.php", "admin", "u1p8CDnxtCFwBRMZ");

vtInst = new VtigerWebservices("http://localhost:8090/MOAISTD/webservice.php", "WM1", "aicrm");
