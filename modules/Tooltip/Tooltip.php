	...
	function vtlib_handler($moduleName, $eventType) {
		...
		global $adb,$mod_strings;
 		...
 		if($eventType == 'module.postinstall') {			
			...
			$adb->query("INSERT INTO aicrm_settings_field (fieldid, blockid, name, iconpath, description, linkto) 
							VALUES (".$adb->getUniqueID('aicrm_settings_field').", ".getSettingsBlockId($blockname).", '$name', '$icon', '$description', '$links')");
