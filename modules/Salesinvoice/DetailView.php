...
if(isPermitted("Salesinvoice","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Salesinvoice","Delete",$_REQUEST['record']) == 'yes')
...
$sql = "select pricetype from aicrm_quotes where quoteid='".$focus->column_fields['quoteid']."' ";
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Salesinvoice',$focus));
...
$smarty->assign("INVOICE_STATUS", $focus->column_fields['invoice_status']);
