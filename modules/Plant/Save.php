...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "PlantList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_plantlist_plantrel  where plantid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_plantlist_plantrel  values (?,?)";
