...
$_SESSION['PLANT_ORDER_BY'] = $order_by;
$_SESSION['PLANT_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Plant','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Plant','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Plant");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Plant");
}else
{
	$query = getListQuery("Plant");
}
//<<<<<<<<customview>>>>>>>>>
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Plant',$order_by);
...
$listview_header = getListViewHeader($focus,"Plant",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Plant",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Plant",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Plant","index",$viewid);
