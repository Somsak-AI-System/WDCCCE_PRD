...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "TemplateList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_templatelist_templaterel  where templateid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_templatelist_templaterel  values (?,?)";
