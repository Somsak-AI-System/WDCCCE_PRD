...
if(isset($_REQUEST['record']) && isset($_REQUEST['record'])) {
    $focus->retrieve_entity_info($_REQUEST['record'],"Template");
...
if(isPermitted("Template","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Template","Delete",$_REQUEST['record']) == 'yes')
