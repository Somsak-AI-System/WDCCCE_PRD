...
document.write("<script type='text/javascript' src='include/js/Inventory_QuotesProductDetails.js'></"+"script>");
...
function set_return_specific(quoteid, quote_no) { 
        var fldName = getOpenerObj("quote_no");
        var fldId = getOpenerObj("quoteid");
        fldName.value = quote_no;
        fldId.value = quoteid;
