...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->name=$focus->column_fields['Questionnairetemplate_name'];		
}
if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') 
{
	...
	WHERE aicrm_questionnairetemplate.questionnairetemplateid = '".$_REQUEST['record']."' order by aicrm_questionnairetemplate_page.pageid asc, aicrm_questionnairetemplate_choice.choiceid asc , aicrm_questionnairetemplate_choicedetail.choicedetailid asc";
...
if(empty($_REQUEST['record']) && $focus->mode != 'edit'){
	...
	/*$focus->column_fields['questionnairetemplate_status'] = "Active";
...
if($focus->mode == 'edit') {
	$smarty->assign("DATA_TEMPLATE",$data_template);
	$smarty->display('Questionnairetemplate/InventoryEditView.tpl');
} else {
	$smarty->display('Questionnairetemplate/InventoryCreateView.tpl');
}
?>