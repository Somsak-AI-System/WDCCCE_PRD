 ...
 *
 ********************************************************************************/
document.write("<script type='text/javascript' src='include/js/Inventory_Questionnairetemplate.js'></"+"script>");
...
function set_return_specific(questionnairetemplateid, questionnairetemplate_no, from ,questionnairetemplate_name) {
        var fldName = getOpenerObj("questionnairetemplate_name");
        var fldId = getOpenerObj("questionnairetemplateid");
        fldName.value = questionnairetemplate_no;
        fldId.value = questionnairetemplateid;
