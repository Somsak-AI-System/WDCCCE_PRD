...
<div style="padding:10px 10px ; width:98%; height:100%; ">
  <div id="cc" class="easyui-layout" style="width:100%;height:820px;">
    <div data-options="region:'west',split:true" title="Report List" style="width:260px; height:100%">
      <ul class="easyui-tree">
        <li>
          <span>Reports</span>
          <ul>
            <!-- <li><a href="#" onclick="GetReportList('1','รายงานยอดขายตามผู้แทนขาย','extend/customizereport/rpt_salesreport');return false;" >1.รายงานยอดขายตามผู้แทนขาย</a></li> -->
          </ul>
        </li>
      </ul>
    </div>
