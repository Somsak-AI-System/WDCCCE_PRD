 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/modules/Home/index.php,v 1.28 2005/04/20 06:57:47 samk Exp $
...
//$query="select name,tabid from aicrm_tab where tabid in (select distinct(tabid) from aicrm_field where tabid <> 29 and tabid <> 16 and tabid <>10) order by name";
