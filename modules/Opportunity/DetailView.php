...
if(isset($_REQUEST['record']) && isset($_REQUEST['record'])) {
    $focus->retrieve_entity_info($_REQUEST['record'],"Opportunity");
...
if(isPermitted("Opportunity","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Opportunity","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Opportunity',$focus));

$check_button = Button_Check($module);
$smarty->assign("CHECK", $check_button);

 $tabid = getTabid("Opportunity");
...
//$smarty->display("Opportunity/InventoryDetailView.tpl");
