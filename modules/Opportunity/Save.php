...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "OpportunityList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_opportunitylist_opportunityrel  where opportunityid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_opportunitylist_opportunityrel  values (?,?)";
