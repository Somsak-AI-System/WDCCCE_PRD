...
$log->info("Servicerequest detail view");
...
if(isPermitted("Servicerequest","EditView",$_REQUEST['record']) == 'yes')
	$smarty->assign("EDIT_DUPLICATE","permitted");

	
$smarty->assign("CREATEPDF","permitted");

if(isPermitted("Servicerequest","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Servicerequest',$focus));
...
### Add condtion Participant
$condition = " and related_tabid in ('41') ";
...
$smarty->assign("service_request_status",$focus->column_fields['service_request_status']);
