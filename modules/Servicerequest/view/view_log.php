   				...
   				<div id="RLContents">
   					...
   					<table class="small" style="background-color:#eaeaea;" width="100%" cellspacing="1" cellpadding="3" border="0">
   						<tr style="height:25px" bgcolor="white">
							...
							<td class="lvtCol" align="left">User แผนก</td>							
							<td class="lvtCol" align="left">Assigned To</td>
							<td class="lvtCol" align="left">Assigned To แผนก</td>
						</tr>	
						<?php foreach ($data as $k => $v){?>
						<tr bgcolor="white">
                     <td align="left"><?php echo ($v["log_date"] == '0000-00-00') ? '00-00-0000' : date("d-m-Y", strtotime($v["log_date"]) );?></td>
							<td align="left"><?php echo $v["log_time"]?></td>
							<td align="left"><?php echo $v["service_request_status"]?></td>
							<td align="left"><?php echo $v["userlogname"]?></td>
							<td align="left"><?php echo $v["userlog_section"]?></td>
							<td align="left"><?php echo $v["assigntoname"]?></td>
							<td align="left"><?php echo $v["assignto_section"]?></td>							
						</tr>	
						<?php }//foreach?>
   					</table>
   					<?php }?>
