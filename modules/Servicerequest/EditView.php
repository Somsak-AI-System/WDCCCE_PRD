...
require_once('include/utils/utils.php');require_once('modules/Servicerequest/Servicerequest.php');
...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Servicerequest");
	$focus->name=$focus->column_fields['servicerequest_name'];		
}
if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') 
{
    ...
    $focus->column_fields['service_request_status'] = 'เปิดงาน';
    $focus->column_fields['processing_date'] = '';
    $focus->column_fields['processing_time'] = '';
    $focus->column_fields['closed_date'] = '';
    $focus->column_fields['closed_time'] = '';
    $focus->column_fields['processing_length_date'] = '';
}
...
if(isset($_REQUEST['account_id']) && $_REQUEST['account_id'] != ''){
    ...
    $focus->column_fields['mobile1'] = $acct_focus->column_fields['mobile'];
    $focus->column_fields['email1'] = $acct_focus->column_fields['email1'];
