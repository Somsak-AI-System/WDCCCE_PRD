...
function set_return_specific(servicerequestid, servicerequest_no ,from ,servicerequest_name) {
        
        if(document.getElementById('from_link').value != '' && typeof(window.opener.document.QcEditView)!= 'undefined' ){

                var fldName = window.opener.document.QcEditView.servicerequest_name;
                var fldId = window.opener.document.QcEditView.servicerequestid;

        }else if(typeof(window.opener.document.DetailView) != 'undefined'){

                var fldName = window.opener.document.DetailView.servicerequest_name;
                var fldId = window.opener.document.DetailView.servicerequestid;

        }else{
                var fldName = window.opener.document.EditView.servicerequest_name;
                var fldId = window.opener.document.EditView.servicerequestid;
        }

        fldName.value = servicerequest_name;
        fldId.value = servicerequestid;
