...
$focus->initSortbyField('Servicerequest');
// END
...
if(isPermitted('Servicerequest','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Servicerequest','EditView','') == 'yes')
{
...
$smarty->assign("SINGLE_MOD",'Servicerequest');
...
if($viewid != "0")
{
	$listquery = getListQuery("Servicerequest");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Servicerequest");
}else
{
	$query = getListQuery("Servicerequest");
}
//<<<<<<<<customview>>>>>>>>>
if(isset($where) && $where != '')
{
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Servicerequest',$order_by);
...
$listview_header = getListViewHeader($focus,"Servicerequest",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Servicerequest",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Servicerequest",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Servicerequest","index",$viewid);
