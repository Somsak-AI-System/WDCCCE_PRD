...
{	
	...
	$associated_prod = getAssociatedPriceList("PriceList",$focus);
    ...
    $focus->column_fields['pricelist_enddate']=date("Y-m-d", strtotime((date("Y-m-d")) . "+7 day"));
...
$smarty->assign("SINGLE_MOD",'Price List');
...
if($focus->mode == 'edit'){
	$smarty->display("PriceList/InventoryEditView.tpl");
}else{
	$smarty->display('PriceList/InventoryCreateView.tpl');
}
