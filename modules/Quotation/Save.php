...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "QuotationList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_quotationlist_quotationrel  where quotationid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_quotationlist_quotationrel  values (?,?)";
