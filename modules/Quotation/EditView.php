...
require_once('include/utils/utils.php');require_once('modules/Quotation/Quotation.php');
...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Quotation");
	$focus->name=$focus->column_fields['quotation_name'];		
}
...
if(isset($_REQUEST['product_id'])) {
	...
	$acct_focus->retrieve_entity_info($_REQUEST['product_id'],"Products");	
	$focus->column_fields['unit_size']=$acct_focus->column_fields['unit_size'];
	$focus->column_fields['pricesqm']=$acct_focus->column_fields['pricesqm'];
...
/*if(isset($_REQUEST['buildingid'])) {
	...
	$acct_focus = new Building();
	$acct_focus->retrieve_entity_info($_REQUEST['buildingid'],"Building");
	$focus->column_fields['buildingid']=$acct_focus->column_fields['buildingid'];	
	$smarty->assign("BUILDINGID", vtlib_purify($_REQUEST['buildingid']));
}*/
