...
$log->info("Quotation detail view");
...
if(isPermitted("Quotation","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Quotation","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Quotation',$focus));
...
//$smarty->display("Quotation/InventoryDetailView.tpl");
