    ...
    <div data-options="region:'west',split:true" title="Report List" style="width:400px; height:100%">
      <ul class="easyui-tree">
        <li>
          <span>Reports</span>
          <ul>
            <li><a href="#" onclick="GetReportList('1','Monthly Expenses Report','extend/customizereport/rpt_monthly_expenses');return false;" >1. Monthly Expenses Report</a></li>
            <li><a href="#" onclick="GetReportList('2','Project on hand list for Sales Representative','extend/customizereport/rpt_project_on_hand');return false;" >2. Project on hand list for Sales Representative</a></li>
          </ul>
        </li>
      </ul>
    </div>
