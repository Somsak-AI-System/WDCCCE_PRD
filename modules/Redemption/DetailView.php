...
if(isset($_REQUEST['record']) && isset($_REQUEST['record'])) {
    $focus->retrieve_entity_info($_REQUEST['record'],"Redemption");
...
$log->info("Redemption detail view");
...
if(isPermitted("Redemption","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Redemption","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Redemption',$focus));

$check_button = Button_Check($module);
$smarty->assign("CHECK", $check_button);

 $tabid = getTabid("Redemption");
