...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "RedemptionList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_redemptionlist_redemptionrel  where redemptionid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_redemptionlist_redemptionrel  values (?,?)";
