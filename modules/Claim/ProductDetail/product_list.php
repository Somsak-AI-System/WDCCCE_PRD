        ...
        <tbody>
            ...
            ?>
                <tr seq='<?php echo $rowNo; ?>'>
                    ...
                    <td>
                        <input type="text" class="form-control input-number buy_amount" name="list1_buy_amount_<?php echo $rowNo; ?>" value="<?php echo (float)$row['buy_amount']; ?>" />
                    </td>
                    <td>
                        <input type="text" class="form-control input-number claim_amount" name="list1_claim_amount_<?php echo $rowNo; ?>" value="<?php echo (float)$row['claim_amount']; ?>" />
                    </td>
                    <td>
    ...
    <table class="table-product-list" id="list2">
        ...
        <tbody>
            ...
            <tr seq='<?php echo $rowNo; ?>'>
                ...
                <td>
                    <input type="text" class="form-control input-number buy_amount" name="list2_buy_amount_<?php echo $rowNo; ?>" value="<?php echo (float)$row['buy_amount']; ?>" />
                </td>
                <td>
                    <input type="text" class="form-control input-number claim_amount" name="list2_claim_amount_<?php echo $rowNo; ?>" value="<?php echo (float)$row['claim_amount']; ?>" />
                </td>
                <td>
