...
require_once('include/utils/utils.php');require_once('modules/Premuimproduct/Premuimproduct.php');
...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Premuimproduct");
	$focus->name=$focus->column_fields['premuimproduct_name'];		
}
...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == 'Products' && $_REQUEST['productid'] != ''  ) {
    require_once('modules/Products/Products.php');
    $pro_focus = new Products();
    $pro_focus->retrieve_entity_info($_REQUEST['productid'], "Products");
    setObjectValuesFromRequest($focus);
    $focus->column_fields['premium_product_name_en'] = $pro_focus->column_fields['productname_en'];
    $focus->column_fields['premuimproduct_name'] = $pro_focus->column_fields['productname'];
    $focus->column_fields['premium_price'] = $pro_focus->column_fields['sellingprice'];
    $focus->column_fields['unit'] = $pro_focus->column_fields['unit'];
    $_REQUEST['return_module'] = 'Premuimproduct';
}
...
$smarty->assign("SINGLE_MOD",'Target');
