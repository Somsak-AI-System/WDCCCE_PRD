...
$focus->initSortbyField('Premuimproduct');
// END
...
if(isPermitted('Premuimproduct','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Premuimproduct','EditView','') == 'yes')
{
...
$smarty->assign("SINGLE_MOD",'Premuimproduct');
...
if($viewid != "0")
{
	$listquery = getListQuery("Premuimproduct");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Premuimproduct");
}else
{
	$query = getListQuery("Premuimproduct");
}
//<<<<<<<<customview>>>>>>>>>
if(isset($where) && $where != '')
{
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Premuimproduct',$order_by);
...
$listview_header = getListViewHeader($focus,"Premuimproduct",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Premuimproduct",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Premuimproduct",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Premuimproduct","index",$viewid);
