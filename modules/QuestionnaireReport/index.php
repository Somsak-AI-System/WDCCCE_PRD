...
<div style="padding:10px 10px ; width:98%; height:800px; ">
   ...
   <div data-options="region:'west',split:true" title="Report List" style="width:250px; height:100%">
    <ul class="easyui-tree">
      <li>
        ...
        <ul>
         <!-- <li><a href="#" onclick="GetReportList('weeklyplan_monthlyplan','Weekly Plan + Monthly Plan','report_customize/salesvisit/salesvisit/rpt_weeklyplan_monthlyplan');return false;" >1.Weekly Plan + Monthly Plan</a></li>
         <li><a href="#" onclick="GetReportList('weeklyplan','Daily Report','report_customize/salesvisit/salesvisit/rpt_weeklyplan'); return false;">2.Daily Report</a></li> -->
         <li><a href="#" onclick="GetReportList('Questionnaire','Export Questionnaire','extend/Questionnaire/index'); return false;">1.Export Questionnaire</a></li> 
    </ul>
...
<div data-options="region:'center',title:'Report'" style="padding: 5px 10px 0 5px">
 <div class="display-report"><iframe  id="report_view" style="padding:0 0 0 0;min-height:810px;"  frameborder="0"  width="100%" height="auto" >
