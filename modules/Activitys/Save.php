...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "ActivitysList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_activityslist_activitysrel  where activitysid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_activityslist_activitysrel  values (?,?)";
