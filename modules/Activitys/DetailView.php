...
$log->info("Activitys detail view");
...
if(isPermitted("Activitys","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Activitys","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Activitys',$focus));
