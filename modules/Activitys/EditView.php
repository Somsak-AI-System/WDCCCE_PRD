...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Activitys");
	$focus->name=$focus->column_fields['activitys_name'];		
	print_r ($focus->name);
}
...
if(empty($_REQUEST['record']) && $focus->mode != 'edit' && isset($_REQUEST['account_id']) && $_REQUEST['account_id']!=''){
	require_once('modules/Accounts/Accounts.php');
	$focus->column_fields['account_id'] = $_REQUEST['account_id'];
	$acct_focus = new Accounts();
	$acct_focus->retrieve_entity_info($_REQUEST['account_id'],"Accounts");
	$focus->column_fields['cf_3903']=$acct_focus->column_fields['cf_2090'];//accounttype
	$focus->column_fields['mobile']=$acct_focus->column_fields['mobile'];//mobile
	$focus->column_fields['telephone']=$acct_focus->column_fields['phone'];//tel
	$focus->column_fields['cf_3904']=$acct_focus->column_fields['accountstatus'];//status	
