...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "DealList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_deallist_dealrel  where dealid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_deallist_dealrel  values (?,?)";
