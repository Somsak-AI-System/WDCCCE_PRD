...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Deal");
	$focus->name=$focus->column_fields['deal_name'];		
}
if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') 
{	
	$focus->id = "";
    $focus->mode = '';
    $focus->column_fields['stage'] = 'Lead / Open(25%)';
}
...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == 'Competitor'){
...
if(isset($_REQUEST['account_id']) && $_REQUEST['account_id'] != ''){
    ...
    $focus->column_fields['salutation'] = $acct_focus->column_fields['nametitle'];
    $focus->column_fields['firstname'] = $acct_focus->column_fields['firstname'];
    $focus->column_fields['lastname'] = $acct_focus->column_fields['lastname'];
    $focus->column_fields['idcardno'] = $acct_focus->column_fields['idcardno'];
    $focus->column_fields['birthdate'] = $acct_focus->column_fields['birthdate'];
    $focus->column_fields['gender'] = $acct_focus->column_fields['gender'];
    $focus->column_fields['mobile'] = $acct_focus->column_fields['mobile'];
    $focus->column_fields['mobile2'] = $acct_focus->column_fields['mobile2'];
    $focus->column_fields['email'] = $acct_focus->column_fields['email1'];
    $focus->column_fields['email2'] = $acct_focus->column_fields['email2'];
}
