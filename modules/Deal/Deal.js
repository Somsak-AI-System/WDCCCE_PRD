...
function set_return_specific(dealid, deal_no, form, deal_name, module_return) {
       
        formName = 'EditView';
        var form = window.opener.document.forms[formName];
        if(module_return == 'Questionnaireanswer'){
            if(typeof(form.event_name) != 'undefined'){
                    form.event_name.value = deal_no;
            }
            if(typeof(form.event_id) != 'undefined'){
                    form.event_id.value = dealid;
            }
        }else if(module_return == 'Calendar'){
            if(typeof(form.event_name) != 'undefined'){
                    form.event_name.value = deal_no;
            }
            if(typeof(form.event_id) != 'undefined'){
            ...
            if(typeof(form.event_id) != 'undefined'){
             ...
             var fldName = getOpenerObj("deal_no");
                var fldId = getOpenerObj("dealid");
                fldName.value = deal_no;
                fldId.value = dealid;   
        }
