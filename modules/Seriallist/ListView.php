...
$focus->initSortbyField('Seriallist');
// END
...
$_SESSION['SERIALLIST_ORDER_BY'] = $order_by;
$_SESSION['SERIALLIST_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Seriallist','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Seriallist','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Seriallist");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Seriallist");
}else
{
	$query = getListQuery("Seriallist");
}
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Seriallist',$order_by);
...
$listview_header = getListViewHeader($focus,"Seriallist",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Seriallist",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Seriallist",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Seriallist","index",$viewid);
