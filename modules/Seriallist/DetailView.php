...
if(isset($_REQUEST['record']) && isset($_REQUEST['record'])) {
    $focus->retrieve_entity_info($_REQUEST['record'],"Seriallist");
...
$log->info("Seriallist detail view");
...
$smarty->assign("SINGLE_MOD",'Serial List');
$category = getParentTab();
$smarty->assign("CATEGORY",$category);

if(isPermitted("Seriallist","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Seriallist","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Seriallist',$focus));

$check_button = Button_Check($module);
$smarty->assign("CHECK", $check_button);

 $tabid = getTabid("Seriallist");
