...
$list_query .= ' and aicrm_pricebook.active<>0  ORDER BY pricebookid DESC ';
...
$sql1="select aicrm_crmentity.crmid, aicrm_pricebookproductrel.pricebookid,aicrm_products.unit_price 
			from aicrm_pricebookproductrel inner join aicrm_crmentity on aicrm_crmentity.crmid=aicrm_pricebookproductrel.productid 
			inner join aicrm_products on aicrm_products.productid=aicrm_pricebookproductrel.productid 		
			where aicrm_crmentity.deleted=0 and aicrm_pricebookproductrel.productid=?";
