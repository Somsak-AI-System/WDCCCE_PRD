...
//Open Check User section(แผนก)
global $adb ,$current_user;
if($current_user->column_fields['is_admin'] != 'on'){

}
//Close Check User section(แผนก)
...
{
    $ids[] = $row["crmid"];
    $chkbox_status = $row['productcode']=='' ? 'show':'hide';
    $chkbox[$row["crmid"]]["status"] = $chkbox_status;
}
$smarty->assign("chkbox_status", $chkbox);
