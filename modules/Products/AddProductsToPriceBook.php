...
{
	$list_query .= ' and aicrm_products.discontinued<>0  ORDER BY '.$order_by.' '.$sorder;
}

$list_query .=  " and aicrm_products.discontinued<>0 group by aicrm_crmentity.crmid";
...
$sql1 = "select productid from aicrm_pricebookproductrel 
		 INNER JOIN aicrm_crmentity ON aicrm_crmentity.crmid = aicrm_pricebookproductrel.productid 
		 WHERE aicrm_crmentity.setype='Products' AND aicrm_crmentity.deleted=0 AND pricebookid=?";
