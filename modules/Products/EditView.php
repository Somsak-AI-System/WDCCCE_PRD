...
//product Unit Price (Include Vat) number format = 0
//$focus->column_fields['cf_4335'] = @number_format($focus->column_fields['cf_4335'],2);
...
//needed when creating a new product with a default aicrm_vendor name to passed 
...
$picklistDependencyDatasource = Vtiger_DependencyPicklist::getPicklistDependencyDatasource("Products");
