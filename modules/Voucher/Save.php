...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "VoucherList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_voucherlist_voucherrel  where voucherid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_voucherlist_voucherrel  values (?,?)";
