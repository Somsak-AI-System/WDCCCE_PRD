...
$_SESSION['VOUCHER_ORDER_BY'] = $order_by;
$_SESSION['VOUCHER_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Voucher','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Voucher','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Voucher");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Voucher");
}else
{
	$query = getListQuery("Voucher");
}
//<<<<<<<<customview>>>>>>>>>
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Voucher',$order_by);
...
$listview_header = getListViewHeader($focus,"Voucher",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Voucher",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Voucher",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Voucher","index",$viewid);
