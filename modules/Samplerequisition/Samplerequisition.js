...
document.write("<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyA6Xw1MLq-8RREz3-_YBOIKFtqGCb9zZ2A&callback=myMap&libraries=places&v=3&channel=2' defer></script>");
...
function set_return_specific(product_id, product_name) {
        ...
        var fldName = getOpenerObj("samplerequisition_name");
...
function set_return_project_address(project_id,project_name, formName ,account_id,account_name,cf_3995,contact_id,contacts_name,con_department,con_position,email,mobile,phone) {
		...
		if(typeof(form.samplerequisition_name) != 'undefined')
            form.samplerequisition_name.value = project_name;
