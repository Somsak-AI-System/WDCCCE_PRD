...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$associated_prod = getEdit_Tab_Promotion("Campaigns", $focus);
	$smarty->assign("PROMOTION_TAB", $associated_prod);
	$smarty->assign("COUNTPROMOTION_TAB", count($associated_prod));

	$associated_prodsum = getEdit_Tab_Promotion_Sum("Campaigns", $focus);
	$smarty->assign("PROMOTION_TAB_SUM", $associated_prodsum);
}
...
if(empty($_REQUEST['record']) && $focus->mode != 'edit'){
	...
	$focus->column_fields['campaignstatus']='Active';
}
...
if($focus->mode == 'edit')
	$smarty->display("Campaigns/EditView.tpl");
else
	$smarty->display("Campaigns/CreateView.tpl");
