...
document.write("<script type='text/javascript' src='modules/Campaigns/multifile.js'></"+"script>");
document.write("<script type='text/javascript' src='plugin/Campaigns/js/my_function_campaigns.js'></"+"script>");

function set_return_specific_campaign(campaign_id, campaign_name) {

	if(document.getElementById('from_link').value != '') {
        window.opener.document.QcEditView.campaign_name.value = campaign_name;
        window.opener.document.QcEditView.campaignid.value = campaign_id;
	} else {
        window.opener.document.EditView.campaign_name.value = campaign_name;
