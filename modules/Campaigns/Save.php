...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "Leads")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 $sql = "delete from aicrm_campaignleadrel where campaignid = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_campaignleadrel values (?,?)";
		 $adb->pquery($sql, array($focus->id ,$_REQUEST['return_id']));
	}
}
