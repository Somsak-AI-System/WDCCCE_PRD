...
global $app_strings,$mod_strings,$current_language,$current_user;
...
{
	if( $adb->dbType == "pgsql")
 	    $list_query .= ' GROUP BY aicrm_campaign.campaignid';
 	$list_query .= ' ORDER BY aicrm_campaign.campaignid DESC';	
}
//echo $list_query;
//Postgres 8 fixes
if( $adb->dbType == "pgsql")
