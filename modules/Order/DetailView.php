...
if(isPermitted("Order","EditView",$_REQUEST['record']) == 'yes')
	$smarty->assign("EDIT_DUPLICATE","permitted");

$smarty->assign("CREATEPDF","permitted");

if(isPermitted("Order","Delete",$_REQUEST['record']) == 'yes')
	$smarty->assign("DELETE","permitted");


$smarty->assign("CONVERTMODE",'ordertoinvoice');
$smarty->assign("MODULE", $currentModule);

$sql = "select pricetype from aicrm_order where orderid='".$_REQUEST['record']."' ";
...
//echo "<pre>"; print_r(getDetailAssociatedProducts('Order',$focus)); echo "</pre>"; exit;
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProductsOrder('Order',$focus));
...
$smarty->assign("order_format",$focus->column_fields["quota_form"]);

$smarty->assign("order_status",$focus->column_fields["order_status_order"]);

$smarty->assign("SITECODE",$focus->column_fields["mix_easy_site_code"]);
$smarty->assign("payment_method",$focus->column_fields["payment_method"]);
$smarty->assign("receive_money",$focus->column_fields["receive_money"]);
$smarty->assign("site_phone_delivery",$focus->column_fields["site_phone_delivery"]);
$smarty->assign("plan_date",$focus->column_fields["plan_date"]);
$smarty->assign("plan_time",$focus->column_fields["plan_time"]);
$smarty->assign("vendor_site_code",$focus->column_fields["vendor_site_code"]);
$smarty->assign("vender_plant",$focus->column_fields["vender_plant"]);

$smarty->assign('Report_URL', $report_viewer_url);
// END
global  $orderid_id,$report_viewer_url;
$orderid_id= $focus->id;
...
$smarty->display("Order/InventoryDetailView.tpl");
