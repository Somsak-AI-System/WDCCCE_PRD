...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "OrderList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_orderlist_orderrel  where orderid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_orderlist_orderrel  values (?,?)";
