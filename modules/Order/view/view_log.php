   		...
   		<tr>
   			<td>
   				<div id="RLContents">
                     ...
                     <td class="lvtCol" align="left">ข้อมูล</td>
							<td class="lvtCol" align="left">User</td>
							<!-- <td class="lvtCol" align="left">Assigned To</td> -->
						</tr>	
						<?php foreach ($data as $k => $v){?>
						<tr bgcolor="white">
							<td align="left"><?php echo date("d-m-Y",strtotime($v["log_date"]))?></td>
							<td align="left"><?php echo $v["log_time"]?></td>
							<td align="left"><?php echo $v["orderstatus"]?></td>
                     <td align="left"><?php echo $v["data_update"]?></td>
