...
function saveAndRunReport()
{
	...
	//JQuery('#next').prop('readonly', true);
}       
...
function changeSteps1() 
{
	...
	{
		var escapedOptions = new Array('account_id','contactid','contact_id','product_id','parent_id','campaignid','potential_id','assigned_user_id1','quote_id','accountname','salesorder_id','vendor_id','time_start','time_end','lastname','branchid','cf_1069');
