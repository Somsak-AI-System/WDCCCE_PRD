...
$log->info("Marketingtools detail view");
...
if(isPermitted("Marketingtools","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Marketingtools","Delete",$_REQUEST['record']) == 'yes')
...
//Get the associated Products and then display above Terms and Marketingtoolss
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Marketingtools',$focus));
