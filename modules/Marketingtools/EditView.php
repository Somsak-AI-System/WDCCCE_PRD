...
require_once('include/utils/utils.php');require_once('modules/Marketingtools/Marketingtools.php');
...
//4600 ends
// echo $_REQUEST['record']; exit;
if($_REQUEST['return_module'] == "Calendar" && $_REQUEST['record'] == $_REQUEST['return_id']){
	$focus->column_fields['activityid'] = $_REQUEST['record'];
	$_REQUEST['record'] = '';
}
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Marketingtools");
	$focus->name=$focus->column_fields['marketingtools_name'];		
}
