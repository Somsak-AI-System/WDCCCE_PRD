...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "AnnouncementList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_announcementlist_announcementrel  where announcementid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_announcementlist_announcementrel  values (?,?)";
