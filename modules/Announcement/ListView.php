...
$focus->initSortbyField('Announcement');
// END
...
$_SESSION['ANNOUNCEMENT_ORDER_BY'] = $order_by;
$_SESSION['ANNOUNCEMENT_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Announcement','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Announcement','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Announcement");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Announcement");
}else
{
	$query = getListQuery("Announcement");
}
//<<<<<<<<customview>>>>>>>>>
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
			$tablename = getTableNameForField('Announcement',$order_by);
...
$listview_header = getListViewHeader($focus,"Announcement",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Announcement",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Announcement",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Announcement","index",$viewid);
