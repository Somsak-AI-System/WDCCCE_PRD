...
if(isset($_REQUEST['record']) && isset($_REQUEST['record'])) {
    $focus->retrieve_entity_info($_REQUEST['record'],"Announcement");
...
$log->info("Announcement detail view");
...
if(isPermitted("Announcement","EditView",$_REQUEST['record']) == 'yes')
...
if(isPermitted("Announcement","Delete",$_REQUEST['record']) == 'yes')
...
$smarty->assign("ASSOCIATED_PRODUCTS",getDetailAssociatedProducts('Announcement',$focus));

$check_button = Button_Check($module);
$smarty->assign("CHECK", $check_button);

 $tabid = getTabid("Announcement");
...
$pquery = " SELECT id FROM aicrm_announcement_usersrel where announcementid = '".$focus->id."' ";
$res=$adb->pquery($pquery, array());
$count_user = $adb->num_rows($res);

$smarty->assign("count_user",$count_user);
$smarty->assign("announcement_status",$focus->column_fields['announcement_status']);
