 ...
 *
 ********************************************************************************/
document.write("<script type='text/javascript' src='modules/Announcement/multifile.js'></"+"script>");
...
function set_return_specific(announcementid, announcement_no) {
        
        var fldName = getOpenerObj("announcement_no");
        var fldId = getOpenerObj("announcementid");
        fldName.value = announcement_no;
        fldId.value = announcementid;
