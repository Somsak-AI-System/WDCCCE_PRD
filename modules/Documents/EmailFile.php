...
$dbQuery = "select filename,folderid from aicrm_notes where notesid= ?";
...
$newfileinstorage = $root_directory."/storage/$fileid"."_".$filename;

copy($fileinattachments,$newfileinstorage);
//copy($fileinattachments,iconv('utf-8', 'tis-620', $newfileinstorage));
