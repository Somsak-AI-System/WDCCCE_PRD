...
{	
	...
	{
		$query = "select notesid from aicrm_notes INNER JOIN aicrm_crmentity ON aicrm_crmentity.crmid = aicrm_notes.notesid WHERE aicrm_notes.folderid = ? and aicrm_crmentity.deleted = 0";
	...
	{
		$sql="delete from aicrm_attachmentsfolder where (folderid=? and folderid != 1)";
