...
global $app_strings,$mod_strings,$list_max_entries_per_page,$current_user;
...
$dbQuery = "select * from aicrm_attachmentsfolder";
...
if($foldercount > 0 )
{
	for($i=0;$i<$foldercount;$i++)
	{
		...
		$query .= " and aicrm_notes.folderid = $folder_id";
		...
		$folder_details['recordListRange'] = getRecordRangeMessage($list_result, $limit_start_rec, $noofrows);
		//echo $folder_details['recordListRange'];
		//echo "<br>";
		//$smarty->assign('recordListRange', getRecordRangeMessage($list_result, $limit_start_rec,$noofrows));
