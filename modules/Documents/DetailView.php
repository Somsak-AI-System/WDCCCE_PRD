...
$dbQuery="select filename,folderid,filelocationtype,filestatus from aicrm_notes where notesid = ?";
...
$fileattach = "select attachmentsid from aicrm_seattachmentsrel where crmid = ?";
