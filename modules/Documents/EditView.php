...
if (isset($_REQUEST['related_id'])) {
	//$focus->parent_id = $_REQUEST['related_id'];
	$smarty->assign("RELATEDID",vtlib_purify($_REQUEST['related_id']));
}
...
$dbQuery="select filename from aicrm_notes where notesid = ?";
