...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "PointList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_pointlist_pointrel  where pointid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_pointlist_pointrel  values (?,?)";
