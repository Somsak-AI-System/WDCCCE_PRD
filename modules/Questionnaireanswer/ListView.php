...
$focus->initSortbyField('Questionnaireanswer');
// END
...
$_SESSION['QUESTIONNAIREANSWER_ORDER_BY'] = $order_by;
$_SESSION['QUESTIONNAIREANSWER_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Questionnaireanswer','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Questionnaireanswer','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Questionnaireanswer");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Questionnaireanswer");
}else
{
	$query = getListQuery("Questionnaireanswer");
}
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Questionnaireanswer',$order_by);
...
$listview_header = getListViewHeader($focus,"Questionnaireanswer",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Questionnaireanswer",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Questionnaireanswer",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Questionnaireanswer","index",$viewid);
