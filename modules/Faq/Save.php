...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "FaqList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_faqlist_faqrel  where faqid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_faqlist_faqrel  values (?,?)";
