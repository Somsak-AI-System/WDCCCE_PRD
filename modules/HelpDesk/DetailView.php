...
global $app_strings;
global $mod_strings;
global $currentModule, $singlepane_view , $report_viewer_url ,$report_viewer_url_pdf ;
...
$chk_close=$focus->column_fields['ticketstatus'];
...
$flag_report_service = false ;

if($current_user->column_fields["section"]== "PCD" || $is_admin){
	$flag_report_service = true ;
}
...
//$smarty->assign("ticketstatus",$focus->column_fields['ticketstatus']);
$smarty->assign("ticketstatus",$focus->column_fields['case_status']);
$smarty->assign("flagassign",$flagassign);
$smarty->assign("flag_report_service",$flag_report_service);
