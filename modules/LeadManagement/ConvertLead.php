...
$sql = "SELECT firstname, lastname, company, smownerid from aicrm_leadmanage inner join aicrm_crmentity on aicrm_crmentity.crmid=aicrm_leadmanage.leadid where aicrm_leadmanage.leadid =?";
$result = $adb->pquery($sql, array($id));
$row = $adb->fetch_array($result);

//if company field is not present
if(getFieldVisibilityPermission('LeadManagement',$current_user->id,'company') == '1'){
	$row["company"] = '';
}
...
$convertlead = '<form name="ConvertLead" method="POST" action="index.php" onsubmit="VtigerJS_DialogBox.block();">
	<input type="hidden" name="module" value="LeadManagement">
	...
	<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
		<tr>
			<td class="genHeaderSmall" align="left"><IMG src="'. aicrm_imageurl('Leads.gif', $theme).'">'.$mod_strings['LBL_CONVERT_LEAD'].' '.$firstname.' '.$lastname.'</td>
