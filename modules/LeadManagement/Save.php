...
else $return_module = "LeadManagement";
...
if($_REQUEST["cf_1231"]!=""){
	$str=explode("-",$_REQUEST["cf_1231"]);
	$sql="update aicrm_leadmanagecf set cf_1393='".$str[2]."',cf_1355='".$str[1]."',cf_1354='".$str[0]."'
	where leadid='".$focus->id."'
	";
	 $adb->pquery($sql, '');
}
...
function save_customfields($entity_id)
{
	...
	global $adb;
	$dbquery="select * from customfields where module='LeadManagement'";
