...
if(isset($_REQUEST['record']))
{
    ...
    $focus->retrieve_entity_info($_REQUEST['record'],"LeadManagement");
    $focus->id = $_REQUEST['record'];
...
$val = isPermitted("LeadManagement","EditView",$_REQUEST['record']);

if(isPermitted("LeadManagement","EditView",$_REQUEST['record']) == 'yes')
	$smarty->assign("EDIT_DUPLICATE","permitted");

if(isPermitted("LeadManagement","EditView",$_REQUEST['record']) == 'yes' && isPermitted("LeadManagement","ConvertLead") =='yes' && (isPermitted("Accounts","EditView") =='yes' || isPermitted("Contacts","EditView") == 'yes') && (vtlib_isModuleActive('Contacts') || vtlib_isModuleActive('Accounts')))
{
...
if(isPermitted("LeadManagement","Delete",$_REQUEST['record']) == 'yes')
	$smarty->assign("DELETE","permitted");

if(isPermitted("Emails","EditView",'') == 'yes')
{
	//Added to pass the parents list as hidden for Emails -- 09-11-2005
	$parent_email = getEmailParentsList('LeadManagement',$_REQUEST['record'], $focus);
