...
$focus->initSortbyField('Competitor');
// END
...
if(isPermitted('Competitor','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Competitor','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Competitor");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Competitor");
}else
{
	$query = getListQuery("Competitor");
}
//<<<<<<<<customview>>>>>>>>>
if(isset($where) && $where != '')
{
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Competitor',$order_by);
...
$listview_header = getListViewHeader($focus,"Competitor",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Competitor",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Competitor",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Competitor","index",$viewid);
