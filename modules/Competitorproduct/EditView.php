...
require_once('include/utils/utils.php');require_once('modules/Competitorproduct/Competitorproduct.php');
...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->name=$focus->column_fields['competitorproduct_name'];		
}
...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == 'Competitor' && $_REQUEST['return_id'] != ''  ) {
