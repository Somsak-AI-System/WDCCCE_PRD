 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/modules/Emails/DetailView.php,v 1.22 2005/03/24 19:09:21 rank Exp $
...
if(isset($_REQUEST['record'])) 
{
	...
	$query = 'select email_flag,from_email,to_email,cc_email,bcc_email from aicrm_emaildetails where emailid = ?';
