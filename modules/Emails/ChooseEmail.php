...
if ($pmodule=='Accounts')
{
	$querystr="select fieldid,fieldlabel,columnname,tablename from aicrm_field where tabid=6 and uitype='13' and aicrm_field.presence in (0,2)"; 
}
elseif ($pmodule=='Contacts')
{
	$querystr="select fieldid,fieldlabel,columnname from aicrm_field where tabid=4 and uitype='13' and aicrm_field.presence in (0,2)";
}
elseif ($pmodule=='Leads')
{
	$querystr="select fieldid,fieldlabel,columnname from aicrm_field where tabid=7 and uitype='13' and aicrm_field.presence in (0,2)";
}
