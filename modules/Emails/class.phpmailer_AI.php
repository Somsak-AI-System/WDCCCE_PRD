...
class PHPMailer
{
    ...
    /**
     * Email aicrm_priority (1 = High, 3 = Normal, 5 = low).
     * @var int
     */
    var $Priority          = 3;
    ...
    /**
     *  Sets the hostname to use in Message-Id and Received aicrm_headers
    ...
    */
    ...
    function SmtpSend($header, $body) {
        include_once($this->PluginDir . "D:/AppServ/www/sdcc/modules/Emails/class.smtp.php");
        $error = "";
        $bad_rcpt = array();
    ...
    /**
     * Creates recipient aicrm_headers.  
     * @access private
     * @return string
     */
    ...
    /**
     * Adds an attachment from a path on the aicrm_filesystem.
    ...
    /**
     * Attaches all fs, string, and binary aicrm_attachments to the message.
    ...
    function EncodeQP ($str) {
        ...
        // Replace every spaces and aicrm_tabs when it's the last character on a line
    ...
    /**
     * Clears all previously set aicrm_filesystem, string, and binary
     * aicrm_attachments.  Returns void.
     * @return void
     */
    ...
    /**
     * Clears all custom aicrm_headers.  Returns void.
     * @return void
     */
     ...
     */
    function Lang($key) {
    	require_once('D:/AppServ/www/sdcc/config.inc.php');
