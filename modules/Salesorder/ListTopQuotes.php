...
/**	function used to get the top 5 salesorder from the ListView query
...
function getTopSalesorder($maxval,$calCnt)
{
	...
	$where = " and aicrm_crmentity.smownerid=".$current_user->id." and aicrm_salesorder.salesordertage not in('Rejected','Accepted','".$current_module_strings['Rejected']."','".$current_module_strings['Accepted']."') and  aicrm_salesorder.validtill >= '".$date_var."'";
	//$where = ' and aicrm_crmentity.smownerid='.$current_user->id.' and  aicrm_salesorder.validtill >= \''.$date_var.'\'';
	...
	$title=array('TopOpenSalesorder.gif',$current_module_strings['LBL_MY_TOP_QUOTE'],'home_mytopsalesorder');
	...
	$search_qry = "&query=true&Fields0=aicrm_crmentity.smownerid&Condition0=is&Srch_value0=".$current_user->column_fields['user_name']."&Fields1=aicrm_salesorder.validtill&Condition1=grteq&Srch_value1=".$date_var."&Fields2=aicrm_salesorder.salesordertage&Condition2=isn&Srch_value2=Rejected&Fields3=aicrm_salesorder.salesordertage&Condition3=isn&Srch_value3=Accepted&searchtype=advance&search_cnt=4&matchtype=all";
