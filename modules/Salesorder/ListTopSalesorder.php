...
function getTopSalesorder($maxval,$calCnt)
{
	...
	$where = ' and aicrm_crmentity.smownerid='.$current_user->id.' and  aicrm_salesorder.duedate >= \''.$date_var.'\'';
	...
	$search_qry = "&query=true&Fields0=aicrm_salesorder.duedate&Condition0=grteq&Srch_value0=".$date_var."&Fields1=aicrm_crmentity.smownerid&Condition1=is&Srch_value1=".$current_user->column_fields['user_name']."&searchtype=advance&search_cnt=2&matchtype=all";
