...
$mod_strings = Array(
'LBL_MIGRATE_INFO'=>'Enter Values to Migrate Data from <b><i> Source </i></b> to <b><i> Current (Latest) AICRM </i></b>',
/*'LBL_MIGRATE_INFO'=>'Enter Values to Migrate Data from <b><i> Source </i></b> to <b><i> Current (Latest) vtigerCRM </i></b>',*/
'LBL_CURRENT_VT_MYSQL_EXIST'=>'Current AI\'s MySQL Exist in',
...
'LBL_CURRENT_VT_MYSQL_PATH'=>'Current AI\'s MySQL path',
/*'LBL_SOURCE_VT_MYSQL_DUMPFILE'=>'vtiger <b>Source</b> Dump File name',*/
'LBL_SOURCE_VT_MYSQL_DUMPFILE'=>'AI <b>Source</b> Dump File name',
'LBL_NOTE_TITLE'=>'Note:',
...
'LBL_NOTES_LIST3'=>'Give the MySQL path like <b>/home/crm/AICRM4_5/mysql</b>',
...
//Added after 5 Beta 
'LBL_UPGRADE_VTIGER'=>'Upgrade AI CRM Database',
/*'LBL_UPGRADE_VTIGER'=>'Upgrade vtiger CRM Database',*/
'LBL_UPGRADE_FROM_VTIGER_423'=>'Upgrade database from AI CRM 4.2.3 to 5.0.0',
...
'LBL_RADIO_BUTTON1_TEXT'=>'I have access to AI CRM live database system',
...
'LBL_RADIO_BUTTON2_TEXT'=>'I have access to AI CRM archived database dump',
...
'LBL_RADIO_BUTTON3_DESC'=>'This option requires AI CRM 4.2.3 database system details, including database server ID, user name, and password. You cannot access data dump from a different machine (remote database server).',
...
<br>2. Create new database (Better is to create a database in the server where your AI 5.0 Database is running.)
...
'LBL_SERVER_PATH_DESC'=>'MySQL path in the server like <b>/home/5beta/AICRM5_beta/mysql/bin</b> or <b>c:\Program Files\mysql\bin</b>',
/*
...
'LBL_UPGRADE_FROM_VTIGER_5X'=>'Upgrade database from AI CRM 5.x to next version',
