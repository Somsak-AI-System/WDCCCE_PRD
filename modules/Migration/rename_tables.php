...
$migrationlog->debug("Inside the file rename_tables.php to rename the table names with prefix aicrm_");

//Rename all the tables with prefix aicrm_
...
//In these following tablename => field we have to add the prefix aicrm_ as they are the tablenames
...
$migrationlog->debug("End of file rename_tables.php. The table names renamed with prefix aicrm_");
?>
