...
function convert_html2utf8_db()
{
	...
	$skip_tables=Array('aicrm_sharedcalendar', 'aicrm_potcompetitorrel', 'aicrm_users2group', 'aicrm_group2grouprel', 'aicrm_group2role', 'aicrm_group2rs', 'aicrm_campaigncontrel', 'aicrm_campaignleadrel', 'aicrm_cntactivityrel', 'aicrm_crmentitynotesrel', 'aicrm_salesmanactivityrel', 'aicrm_vendorcontactrel', 'aicrm_salesmanticketrel', 'aicrm_seactivityrel', 'aicrm_seticketsrel', 'aicrm_senotesrel', 'aicrm_profile2globalpermissions', 'aicrm_profile2standardpermissions', 'aicrm_profile2field', 'aicrm_role2profile', 'aicrm_profile2utility', 'aicrm_activityproductrel', 'aicrm_pricebookproductrel', 'aicrm_activity_reminder', 'aicrm_actionmapping', 'aicrm_org_share_action2tab', 'aicrm_datashare_relatedmodule_permission', 'aicrm_tmp_read_user_sharing_per', 'aicrm_tmp_read_group_sharing_per', 'aicrm_tmp_write_user_sharing_per', 'aicrm_tmp_write_group_sharing_per', 'aicrm_tmp_read_user_rel_sharing_per', 'aicrm_tmp_read_group_rel_sharing_per', 'aicrm_tmp_write_user_rel_sharing_per', 'aicrm_tmp_write_group_rel_sharing_per', 'aicrm_role2picklist', 'aicrm_freetagged_objects', 'aicrm_tab', 'aicrm_blocks', 'aicrm_group2role', 'aicrm_group2rs');
