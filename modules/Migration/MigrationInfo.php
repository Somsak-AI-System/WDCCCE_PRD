		   ...
		   <tr>
			...
			<td class="mailClientBg" style="padding-left:10px;padding-top:10px;vertical-align:top;">
				<table width="100%"  border="0" cellpadding="5" cellspacing="0">
				   <tr>
					   <td width="10%"><img src="<?php echo aicrm_imageurl('migrate.gif', $theme) ?>" align="absmiddle"/></td>
					<td width="90%">
				   ...
				   <tr>
					<td colspan="2" bgcolor="#FFFFFF" class="hdrNameBg">
						...
						<div id="Mig_result" style="position:relative;border:2px solid #8BB73C;width:50%;left:25%;">
							<table>
							   <tr>
								<td><img id="migration_image" src="<?php echo aicrm_imageurl('migration_sucess.jpg', $theme) ?>" align="absmiddle" style="display:none;"/></td>
						...
						<div id="successLog" style="border:1px solid #666666;width:90%;position:relative;height:250px;overflow:auto;left:5%;top:10px;">
							...
							<!-- This aicrm_table is designed to display all the queries (before this aicrm_table a div tag is opened. so all these following queries will be put inside the div aicrm_tab as a aicrm_table format) -->
							<style>
								.MigInfo{
					...
					$migrationlog->debug("Mickie ---- Patch Process ---- Ends \n\n\n");
						...
						<!-- This aicrm_table is to show the total, success and failed queries -->
