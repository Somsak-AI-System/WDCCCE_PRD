...
$focus->initSortbyField('Sparepart');
// END
...
$_SESSION['SPAREPART_ORDER_BY'] = $order_by;
$_SESSION['SPAREPART_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Sparepart','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Sparepart','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Sparepart");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Sparepart");
}else
{
	$query = getListQuery("Sparepart");
}
//<<<<<<<<customview>>>>>>>>>
if(isset($where) && $where != '')
{
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid'){
			...
			$tablename = getTableNameForField('Sparepart',$order_by);
...
$listview_header = getListViewHeader($focus,"Sparepart",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Sparepart",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Sparepart",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Sparepart","index",$viewid);
