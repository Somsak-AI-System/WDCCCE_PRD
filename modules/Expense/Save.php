...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "ExpenseList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_expenselist_expenserel  where expenseid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_expenselist_expenserel  values (?,?)";
