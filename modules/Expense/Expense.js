 ...
 *
 ********************************************************************************/
document.write("<script type='text/javascript' src='modules/Expense/multifile.js'></"+"script>");
...
jQuery(document).ready(function() {
        jQuery(`select[name="expenses_type"]`).change(function(e){
                var expenses_type = this.value;
                // alert(expenses_type);
                if(expenses_type === "Allowance - Up Country"){
                        jQuery(`input[name="expense_amount"]`).val('1250.00');
                }else{
                        jQuery(`input[name="expense_amount"]`).val('0');
                }
        });
});
