...
$_SESSION['EXPENSE_ORDER_BY'] = $order_by;
$_SESSION['EXPENSE_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Expense','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Expense','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Expense");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Expense");
}else
{
	$query = getListQuery("Expense");
}
//<<<<<<<<customview>>>>>>>>>
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Expense',$order_by);
...
$listview_header = getListViewHeader($focus,"Expense",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Expense",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Expense",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Expense","index",$viewid);
