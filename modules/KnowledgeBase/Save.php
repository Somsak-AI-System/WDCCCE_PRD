...
if(isset($_REQUEST['return_module']) && $_REQUEST['return_module'] == "KnowledgeBaseList")
{
	if(isset($_REQUEST['return_id']) && $_REQUEST['return_id'] != "")
	{
		 
		 $sql = "delete from aicrm_knowledgebaselist_knowledgebaserel  where knowledgebaseid  = ?";
		 $adb->pquery($sql, array($focus->id));
		 $sql = "insert into aicrm_knowledgebaselist_knowledgebaserel  values (?,?)";
