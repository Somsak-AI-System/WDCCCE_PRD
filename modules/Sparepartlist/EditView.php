...
require_once('include/utils/utils.php');require_once('modules/Sparepartlist/Sparepartlist.php');
...
if(isset($_REQUEST['record']) && $_REQUEST['record'] !='') 
{
	...
	$focus->mode = 'edit'; 	
	$focus->retrieve_entity_info($_REQUEST['record'],"Sparepartlist");
	$focus->name=$focus->column_fields['sparepartlist_name'];		
}
...
if(isset($_REQUEST['parent_id']) && $_REQUEST['parent_id']!='' && $_REQUEST['record']=='')
{
    ...
    }else if ($_REQUEST['return_module'] == 'Sparepart'){
        require_once('modules/Sparepart/Sparepart.php');
        $focus->column_fields['sparepartid'] = $_REQUEST['parent_id'];
        $ins_focus = new Sparepart();
        $ins_focus->retrieve_entity_info($_REQUEST['parent_id'], "Sparepart");
        $log->debug("Inspection Id from the request is " . $_REQUEST['parent_id']);
