...
function set_return_specific(sparepartlistid, sparepartlist_no) {
        
        var fldName = getOpenerObj("sparepartlist_no");
        var fldId = getOpenerObj("sparepartlistid");
        fldName.value = sparepartlist_no;
        fldId.value = sparepartlistid;
        window.opener.document.EditView.action.value = 'EditView';
        window.opener.document.EditView.convertmode.value = 'update_sparepartlist_val';
