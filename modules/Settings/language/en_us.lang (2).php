 ...
 * $Header: /advent/projects/custprojects/vtigercrm/vtigersupport/aicrm_crm/modules/Settings/language/en_us.lang.php,v 1.2 2007/07/06 09:55:40 rajeshkannan Exp $
...
'PickList_Account'=>'PickList Account',
'PickList_User'=>'PickList User',
...
'EMAILTEMPLATES'=>'รูปแบบอีเมล์',

'WORDINTEGRATION'=>'Mail Merge Templates',

'LBL_MAIL_MERGE'=>'ผสานเมล์',

'NOTIFICATIONSCHEDULERS'=>'ตั้งเวลาประกาศ',
//currency status
'LBL_ACTIVE'=>'Active',
...
'LBL_PROXY_SETTINGS'=>'Server ป้องกัน',
'LBL_AUDIT_TRAIL'=>'ตรวจสอบเส้นทาง',
...
'LBL_USER_MANAGEMENT'=>'ผู้ใช้งานและจัดการระบบ',
...
'LBL_SHARING_ACCESS'=>'จัดการสิทธิ์',

'LBL_FIELDS_ACCESS'=>'จัดการฟิวส์ข้อมูล',
...
'LBL_COMMUNICATION_TEMPLATES'=>'แม่แบบการสื่อสาร',
...
'LBL_BACKUP_SERVER_SETTINGS'=>'สำรองข้อมูล Server',
...
'LBL_MAIL_SERVER_SETTINGS'=>'Server Mail ขาออก',
...
'LBL_COMPANY_DETAILS'=>'รายละเอียดบริษัท',
...
'INVENTORYNOTIFICATION'=>'แจ้งสินค้าคงคลัง',
'LBL_INVENTORY_NOTIFICATIONS'=>' - Edit Inventory Email Notifications',
'INVENTORYTERMSANDCONDITIONS'=>'สินค้าคงคลัง : ข้อตกลงและเงื่อนไข',//newly added for Inventory terms and conditions
...
'LBL_OTHER_SETTINGS'=>'ตั้งค่าอื่นๆ',
'LBL_SCROLL'=>'[เลื่อนขึ้นข้างบน]',
...
'LBL_ASSIGN_MODULE_OWNERS'=>'กำหนดเจ้าของโมดูล',
...
'LBL_MIGRATION_INFO'=>'Migrate your existing AI-CRM data to latest version',

//Added for 5 GA - Description of Settings UI

'LBL_USER_DESCRIPTION'=>'จัดการผู้ที่จะเข้าใช้งานระบบ AI-CRM',
'LBL_ROLE_DESCRIPTION'=>'ตั้งค่าลำดับชั้นของบทบาทและกำหนดให้ผู้ใช้',
'LBL_PROFILE_DESCRIPTION'=>'จัดการการเข้าถึงโมดูลที่ผู้ใช้กำหนดบทบาทที่แตกต่างกัน',
'LBL_GROUP_DESCRIPTION'=>'จัดการประเภทของทีมตามบทบาทผู้ใช้และโปรไฟล์',
'LBL_SHARING_ACCESS_DESCRIPTION'=>'กฎร่วมกันจัดการโมดูลและกฎร่วมกันกำหนดเอง',
'LBL_SHARING_FIELDS_DESCRIPTION'=>'กำหนดการเข้าถึงฟิวส์ข้อมูลในแต่ละโมดูล',
'LBL_MODULE_OWNERS_DESCRIPTION'=>'กำหนดเจ้าของบริการลูกค้าเพื่อ module CRM',
'LBL_ANNOUNCEMENT_DESCRIPTION'=>'จัดการ การลงประกาศของบริษัท',
'LBL_CUSTOM_FIELDS_DESCRIPTION'=>'การจัดการชนิดของเขตข้อมูลที่ผู้ใช้กำหนด',
'LBL_PICKLIST_DESCRIPTION'=>'ปรับตั้งค่า Picklist ในแต่ละโมดูล',
'LBL_EMAIL_TEMPLATE_DESCRIPTION'=>'จัดการรูปแบบของอีเมล์',
'LBL_MAIL_MERGE_DESCRIPTION'=>'จัดการรูปแบบของอีเมล์แบบผสาน',
'LBL_NOTIF_SCHED_DESCRIPTION'=>'แจ้งการจัดการที่จะแจ้งเตือนในกรณีการกระทำที่สำคัญ',
'LBL_INV_NOTIF_DESCRIPTION'=>'เปลี่ยนการตั้งค่าของสินค้าคงคลังที่แจ้ง',
'LBL_INV_TANDC_DESCRIPTION'=>'ระบุข้อกำหนดและเงื่อนไขการเสนอราคาการสั่งซื้อและใบแจ้งหนี้',
'LBL_COMPANY_DESCRIPTION'=>'ระบุที่อยู่ธุรกิจของบริษัท',
'LBL_MAIL_SERVER_DESCRIPTION'=>'ตั้งค่ารายละเอียด Mail Server',
'LBL_BACKUP_SERVER_DESCRIPTION'=>'ระบุฐานข้อมูลสำรองรายละเอียดเซิร์ฟเวอร์',
'LBL_CURRENCY_DESCRIPTION'=>'จัดการเงินตราต่างประเทศและอัตราแลกเปลี่ยน',
'LBL_TAX_DESCRIPTION'=>'จัดการและอัตราภาษีที่เกี่ยวข้อง',
'LBL_SYSTEM_DESCRIPTION'=>'ดูรายละเอียด Server',
'LBL_PROXY_DESCRIPTION'=>'ผู้รับมอบฉันทะกำหนดค่าเพื่อเข้าถึง RSS ฟีดผ่านทางอินเทอร์เน็ต',
'LBL_AUDIT_DESCRIPTION'=>'แสดง opertions ข้อมูลทำโดยผู้ใช้',
'LBL_TAX_DESC'=>'การจัดการชนิดของอัตราภาษีสำหรับภาษีเช่น Sales Tax ฯลฯ ภาษีมูลค่าเพิ่ม',
'LBL_COMPANY_DESC'=>'ระบุที่อยู่ธุรกิจของบริษัท',
'LBL_SELECT_LOGO'=>'เลือกโลโก้ใหม่:',
'LBL_INVEN_TANDC_DESC'=>'ข้อความที่ระบุสำหรับข้อตกลงและส่วนเงื่อนไขการเสนอราคา, สั่งซื้อและโมดูลใบแจ้งหนี้',
'LBL_MAIL_SERVER_DESC'=>'ตั้งค่าออก Mail Server ของคุณรายละเอียด',
'LBL_BACKUP_SERVER_DESC'=>'จัดการ Backup Server ของคุณ',
'LBL_MODULES_AND_OWNERS'=>'Modules และเจ้าของ',
'LBL_GROUP_DESC'=>'จัดการประเภทของกลุ่มผู้ใช้ภายในองค์กรของคุณ',
'LBL_MAIL_MERGE_DESC'=>'จัดการ Mail รวมแม่แบบที่ใช้ในโมดูล CRM',
...
'LBL_SUBJECT'=>'Subject',
'LBL_MESSAGE'=>'Message',
'LBL_PICKLIST_EDITOR'=>'แก้ไขข้อมูล Picklist',
...
'LBL_LOGIN_HISTORY_DETAILS'=>'ประวัติชื่อผู้ใช้',
'LBL_LOGIN_HISTORY_DESCRIPTION'=>'แสดงประวัติของผู้ใช้เข้าสู่ระบบ',
...
'LBL_DEFAULT_DETAIL_VIEW'=>'ดูรายละเอียดตั้งต้น',
'LBL_DEFAULT_MODULE_VIEW'=>'ดูโมดูลตั้งต้น',
'LBL_DEFAULT_MODULE_VIEW_DESC'=>'ดูรายละเอียดชุดเริ่มต้นสำหรับ Modules ทั้งหมด',
...
'LBL_ALLOW'=>'Allows',
'LBL_MESG_VIEW'=>'to view all information / modules of AI-CRM',
'LBL_MESG_EDIT'=>'to edit all information / modules of AI-CRM',
...
'Sorry'=>'Sorry',
'uploaded_file_exceeds_maximum_limit'=>'the uploaded file exceeds the maximum AI-CRM_filesize limit',
...
'VTLIB_LBL_MODULE_MANAGER'=>'บริหารระบบ',
'VTLIB_LBL_MODULE_MANAGER_DESCRIPTION'=>'จัดการโมดูล ภายใน AI - CRM',
...
'LBL_MAIL_SCANNER_DESCRIPTION'=>'mailbox กำหนดค่าสำหรับการสแกน',
...
'LBL_LIST_WORKFLOWS_DESCRIPTION' => 'เวิร์กโฟลว์การสร้างและแก้ไขสำหรับ AI - CRM',
...
'LBL_CUSTOMIZE_MODENT_NUMBER'=>'บันทึกกำหนดหมายเลข',
'LBL_CUSTOMIZE_MODENT_NUMBER_DESCRIPTION'=>'ปรับแต่งโมดูล Entity Number',
// END
...
'VTLIB_LBL_PACKAGE_FILE_HELP'=>'AI-CRM module is packaged as a zip file.',
...
'VTLIB_LBL_REQ_VTIGER_VERSION'=>'Req. AI-CRM version',
...
'PORTAL_EXTENSION_DESCRIPTION'=>'ช่วยให้คุณสามารถกำหนดค่าลูกค้าปลั๊กอิน Portal',
