...
$output .= '<div id="orgLay" style="display:block;" class="layerPopup"><script language="JavaScript" type="text/javascript" src="include/js/customview.js"></script>
			...
			$output .= '<td width="5%" align="right"><a href="javascript:fninvsh(\'orgLay\');"><img src="'. aicrm_imageurl('close.gif', $theme) .'" border="0"  align="absmiddle" /></a></td>
			</tr>';
...
$sql="SELECT fieldid,fieldlabel,fieldname FROM aicrm_field WHERE tabid=? AND block != ? AND block NOT IN (SELECT blockid from aicrm_blocks where blocklabel='LBL_RELATED_PRODUCTS') AND displaytype in (1,2,4) and aicrm_field.presence in (0,2) ORDER BY fieldlabel ASC"; // added by projjwal on 22-11-2007
