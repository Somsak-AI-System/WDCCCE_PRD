...
/**
 * Create HTML form to enter a new record with the minimum necessary aicrm_fields.
 * Portions created by SugarCRM are Copyright (C) SugarCRM, Inc.
 * All Rights Reserved.
 * Contributor(s): ______________________________________..
 */
...
$qcreate_get_field="select * from aicrm_field where tabid=4 and quickcreate=0 and aicrm_field.presence in (0,2) order by quickcreatesequence";
