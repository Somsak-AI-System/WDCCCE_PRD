...
$query = "select * from aicrm_".$tableName." inner join aicrm_role2picklist on aicrm_role2picklist.picklistvalueid=aicrm_$tableName.picklist_valueid where roleid=? and  presence=1 order by sortid"; 
...
$qry = "select * from aicrm_".$tableName." inner join aicrm_role2picklist on aicrm_role2picklist.picklistvalueid=aicrm_$tableName.picklist_valueid where roleid=? and presence=0 order by sortid"; 
...
$query = 'select fieldlabel from aicrm_tab inner join aicrm_field on aicrm_tab.tabid=aicrm_field.tabid where aicrm_tab.name=? and fieldname=? and aicrm_field.presence in (0,2)';
