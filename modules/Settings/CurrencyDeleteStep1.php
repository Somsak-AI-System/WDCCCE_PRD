...
$sql = "select * from aicrm_currency_info where id=?";
...
<tr>
	...
	<td align="right" width="40%"><img src="'. aicrm_imageurl('close.gif', $theme).'" border=0 alt="'.$app_strings["LBL_CLOSE"].'" title="'.$app_strings["LBL_CLOSE"].'" style="cursor:pointer;" onClick="document.getElementById(\'CurrencyDeleteLay\').style.display=\'none\'";></td>
</tr>
<table>
		...
		<td class=small >
			<table border=0 celspacing=0 cellpadding=5 width=100% align=center bgcolor=white>
				...
				$output.='<select class="select small" name="transfer_currency_id" id="transfer_currency_id">';
						 ...
						 global $adb;	
						 $sql = "select * from aicrm_currency_info where currency_status = ? and deleted=0";
