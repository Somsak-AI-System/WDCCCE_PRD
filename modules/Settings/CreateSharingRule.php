...
$output.='<div class="layerPopup" id="sharingRule" style="position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 9999; background: #fff; border: 1px solid #ccc; box-shadow: 0 0 10px rgba(0,0,0,0.5);"><form name="newGroupForm" action="index.php" method="post" onsubmit="VtigerJS_DialogBox.block();">
...
$output .= '<td align="right" class="small"><img src="'. aicrm_imageurl('close.gif', $theme).'" border=0 alt="'.$app_strings["LBL_CLOSE"].'" title="'.$app_strings["LBL_CLOSE"].'" style="cursor:pointer" onClick="hide(\'sharingRule\')";></td>
