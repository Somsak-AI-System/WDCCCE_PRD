...
$query="SELECT * FROM aicrm_weekly_plan";
...
$cnt=1;
$output='';
$list_header = array($mod_strings['LBL_LIST_TOOLS'],'Section','Date Send','Time Send','Send To');
$return_data = array();
foreach($toll_details as $id=>$toll_details)
{
	...
	$standCustFld['date_send']= $toll_details[1];
...
$smarty->display("ListweeklyTemplates.tpl");
?>
