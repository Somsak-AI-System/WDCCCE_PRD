...
$sql="select * from aicrm_inventory_tandc";
...
$inventory_id2 = $adb->query_result($result,1,'id');
$inventory_type2 = $adb->query_result($result,1,'type');
$inventory_tandc2 = $adb->query_result($result,1,'tandc');
...
if (isset($inventory_tandc)){
    ...
    $smarty->assign("INV_TERMSANDCONDITIONS2",$inventory_tandc2);
}
