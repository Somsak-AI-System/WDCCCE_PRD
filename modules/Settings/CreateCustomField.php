...
$cftextcombo = Array($mod_strings['Text'],
	...
	$mod_strings['Skype'],
//ekk========================================================================================									
	$mod_strings['PickList_product'],
	$mod_strings['PickList_Account'],
	$mod_strings['PickList_User']
//ekk========================================================================================						
);	
...
if(isset($fieldid) && $fieldid!='')
{
	...
	{
		$query = "select * from aicrm_". $adb->sql_escape_string($customfield_columnname);
...
$output .= '<div id="customfield" style="display:block;" class="layerPopup"><script language="JavaScript" type="text/javascript" src="include/js/customview.js"></script>
		...
		<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
			...
			$output .= '<td width="40%" align="right"><a href="javascript:fninvsh(\'customfield\');"><img src="'. aicrm_imageurl('close.gif', $theme).'" border="0"  align="absmiddle" /></a></td>
			</tr>';
