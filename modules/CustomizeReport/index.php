...
<div style="padding:10px 10px ; width:98%; height:100%; ">
  <div id="cc" class="easyui-layout" style="width:100%;height:820px;">
    <div data-options="region:'west',split:true" title="Report List" style="width:400px; height:100%">
      <ul class="easyui-tree">
        <li>
          <span>Reports</span>
            <ul>
            <li><a href="#" onclick="GetReportList('1','Project listing','extend/index.php/customizereport/rpt_project_listing');return false;" >1. Project listing</a></li>
            <li><a href="#" onclick="GetReportList('2','Quotation','extend/index.php/customizereport/rpt_quote_listing');return false;" >2. Quotation</a></li>
            <li><a href="#" onclick="GetReportList('3','Pipeline Detail','extend/index.php/customizereport/rpt_pipeline_detail');return false;" >3. Pipeline Detail</a></li>
            </ul>
        </li>
      </ul>
    </div>
    ...
    <div data-options="region:'center',title:'Report'" style="padding: 5px 10px 0 5px">
      <div class="display-report">
   	    <iframe  id="report_view" style="padding:0 0 0 0;min-height: 100%;"  allowfullscreen="" frameborder="0" height="785px" width="100%" height="auto" ></iframe>
      </div>
    </div>
