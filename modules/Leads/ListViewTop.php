...
function getNewLeads($maxval,$calCnt)
{
	...
	$list_query = 'select aicrm_leaddetails.firstname, aicrm_leaddetails.lastname, aicrm_leaddetails.leadid, aicrm_leaddetails.company 
		from aicrm_leaddetails inner join aicrm_crmentity on aicrm_leaddetails.leadid = aicrm_crmentity.crmid 
		where aicrm_crmentity.deleted =0 AND aicrm_leaddetails.converted =0 AND 
		aicrm_leaddetails.leadstatus not in ("Lost Lead", "Junk Lead","'.$current_module_strings['Lost Lead'].'","'.$current_module_strings['Junk Lead'].'") 
	...
	$search_qry = "&query=true&Fields0=aicrm_leaddetails.leadstatus&Condition0=isn&Srch_value0=Lost+Lead&Fields1=aicrm_leaddetails.leadstatus&Condition1=isn&Srch_value1=Junk+Lead&Fields2=aicrm_crmentity.smownerid&Condition2=is&Srch_value2=".$current_user->column_fields['user_name']."&Fields3=aicrm_crmentity.createdtime&Condition3=grteq&Srch_value3=".$start_date."&searchtype=advance&search_cnt=4&matchtype=all";
