...
if(isset($_REQUEST['campaignid']) && $_REQUEST['campaignid']!='' && $_REQUEST['record']=='')
{
        require_once('modules/Campaigns/Campaigns.php');
        $focus->column_fields['campaignid'] = $_REQUEST['campaignid'];
        $camp_focus = new Campaigns();
        $camp_focus->retrieve_entity_info($_REQUEST['campaignid'],"Campaigns");
        $log->debug("Campaings Id from the request is ".$_REQUEST['campaignid']);
}
...
if(empty($_REQUEST['record']) && $focus->mode != 'edit'){
    ...
    $focus->column_fields['leaddate'] = date('Y-m-d');
}
