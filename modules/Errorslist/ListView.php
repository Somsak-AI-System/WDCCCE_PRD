...
$focus->initSortbyField('Errorslist');
// END
...
$_SESSION['ERRORSLIST_ORDER_BY'] = $order_by;
$_SESSION['ERRORSLIST_SORT_ORDER'] = $sorder;
//<<<<<<<<<<<<<<<<<<< sorting - stored in session >>>>>>>>>>>>>>>>>>>>
...
if(isPermitted('Errorslist','Delete','') == 'yes')
{
	$other_text['del'] = $app_strings[LBL_MASS_DELETE];
}
if(isPermitted('Errorslist','EditView','') == 'yes')
{
...
if($viewid != "0")
{
	$listquery = getListQuery("Errorslist");
	$query = $oCustomView->getModifiedCvListQuery($viewid,$listquery,"Errorslist");
}else
{
	$query = getListQuery("Errorslist");
}
...
if(isset($order_by) && $order_by != '')
{
	if($order_by == 'smownerid')
        ...
        {
		$tablename = getTableNameForField('Errorslist',$order_by);
...
$listview_header = getListViewHeader($focus,"Errorslist",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("LISTHEADER", $listview_header);

$listview_header_search = getSearchListHeaderValues($focus,"Errorslist",$url_string,$sorder,$order_by,"",$oCustomView);
$smarty->assign("SEARCHLISTHEADER",$listview_header_search);

$listview_entries = getListViewEntries($focus,"Errorslist",$list_result,$navigation_array,"","","EditView","Delete",$oCustomView);
...
$navigationOutput = getTableHeaderSimpleNavigation($navigation_array, $url_string,"Errorslist","index",$viewid);
