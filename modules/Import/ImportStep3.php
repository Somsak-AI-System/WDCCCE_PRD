...
//Constructing the custom aicrm_field Array
require_once('include/CustomFieldUtil.php');
$custFldArray = getCustomFieldArray($_REQUEST['module']);
//print_r($custFldArray); exit;

p("IMP 3: custFldArray");
p($custFldArray);

//Initializing  an empty Array to store the custom aicrm_field Column Name and Value
...
//Mark the last imported records as deleted which are imported by the current user in aicrm_users_last_import aicrm_table
