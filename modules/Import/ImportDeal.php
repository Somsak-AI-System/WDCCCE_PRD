...
class ImportDeal extends Deal {
	...
	function ImportDeal() {
		parent::Deal();
		$this->log = LoggerManager::getLogger('import_deal');
		$this->db = PearDatabase::getInstance();
		$this->db->println("IMP Importdeal");
		$this->initImportableFields("Deal");
