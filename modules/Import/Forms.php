...
function verify_data(form) 
{
	...
	for(i=0;i < form.length;i++)
	{
		if ( form.elements[i].name.indexOf("colnum",0) == 0)
		{
			...
			{
				// got same aicrm_field more than once
				isError = true;
			}
	...
	for(var aicrm_field_name in required)
	{
...
function getFieldSelect(&$column_fields,$colnum,&$required_fields,$suggest_field,$translated_fields,$module)
{
	...
	$output = "<select class=\"small select_crm\" id=\"colnum" . $colnum ."\" name=\"colnum" . $colnum ."\">\n";
	...
	//echo "<pre>"; print_r($required_fields); echo "</pre>"; exit;
	//echo "<pre>"; print_r($translated_fields); echo "</pre>"; exit;
