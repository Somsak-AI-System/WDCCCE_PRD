...
<table align="center" cellpadding="5" cellspacing="0" width="95%" class="mailClient importLeadUI small">
		...
		<tr>
				...
				<?php 	$req_module = vtlib_purify($_REQUEST['module']);   
					if( $req_module == 'Agreement' || $req_module == 'Contacts' || $req_module == 'Accounts' || $req_module == 'Leads' || $req_module == 'Products' || $req_module == 'HelpDesk' || $req_module == 'Potentials' || $req_module == 'Vendors' || $req_module == 'Application' || $req_module == 'Branch' || $req_module == 'Premium' || $req_module == 'Coupon' || $req_module == 'PriceList' || $req_module == 'ServiceRequest'|| $req_module == 'EmailTarget' || $req_module == 'Resale' || $req_module == 'Plant' || $req_module == 'Deal' || $req_module == 'Promotion' || $req_module == 'Voucher' || $req_module == 'Competitorproduct' || $req_module == 'Premuimproduct' || $req_module == 'Promotionvoucher' || $req_module == 'Service')
                                	{ ?>
