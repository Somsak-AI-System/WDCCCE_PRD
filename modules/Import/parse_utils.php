...
// one aicrm_field per delimiter, to a maximum number of lines
// some aicrm_files have a header, some dont.
// keeps track of which aicrm_fields are used
...
function parse_import($file_name,$delimiter,$max_lines,$has_header)
{
	...
	while ( (( $fields = fgetcsv($fh, 12000, $delimiter) ) !== FALSE) && ( $max_lines == -1 || $line_count < $max_lines)) 
	{	
