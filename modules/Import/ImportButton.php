...
if ($_REQUEST['module'] == 'Products' ||
	...
	$_REQUEST['module'] == 'Application' ||
	$_REQUEST['module'] == 'Branch' ||
	$_REQUEST['module'] == 'Premium' ||
	$_REQUEST['module'] == 'Coupon' ||
	$_REQUEST['module'] == 'PriceList' ||
	$_REQUEST['module'] == 'ServiceRequest' ||
	$_REQUEST['module'] == 'EmailTarget')
{
