...
class ImportPromotion extends Promotion {
	 var $db;
	...
	function modseq_number() {
		$this->column_fields['promotion_no'] = '';
	}
	// END
	...
	function ImportPromotion() {
		parent::Promotion();
		$this->log = LoggerManager::getLogger('import_promotion');
		$this->db = PearDatabase::getInstance();
		$this->db->println("IMP ImportPromotion");
		$this->initImportableFields("Promotion");
