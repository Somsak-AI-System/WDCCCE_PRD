...
if($req_module != 'Accounts' || $req_module != 'Contacts' || $req_module != 'Products' || $req_module != 'Leads' || $req_module != 'HelpDesk' || $req_module != 'Potentials' || $req_module != 'PriceList' || $req_module != 'Competitor' || $req_module != 'Errors' || $req_module != 'Serial' || $req_module != 'Sparepart' || $req_module != 'Campaigns' || $req_module != 'Plant' || $req_module != 'Deal' || $req_module != 'Promotion' || $req_module != 'Voucher' || $req_module != 'Competitorproduct' || $req_module != 'Premuimproduct' || $req_module != 'Promotionvoucher' || $req_module != 'Service' || $req_module != 'Faq' || $req_module != 'KnowledgeBase')
{
	...
	<table align="center" cellpadding="5" cellspacing="0" width="95%" class="mailClient importLeadUI small">
	   ...
	   <tr>
		<td align="left"  style="padding-left:40px;width:75%;" >
			<?php	if($req_module == 'Contacts' || $req_module == 'Accounts' || $req_module == 'Leads' || $req_module == 'Products' || $req_module == 'HelpDesk' || $req_module == 'Potentials' || $req_module == 'Competitor' || $req_module == 'Errors' || $req_module == 'Serial' || $req_module == 'Sparepart' || $req_module == 'Campaigns'|| $req_module == 'Plant' || $req_module == 'PriceList' || $req_module == 'Deal' || $req_module == 'Promotion' || $req_module == 'Voucher' || $req_module == 'Competitorproduct' || $req_module == 'Premuimproduct' || $req_module == 'Promotionvoucher' || $req_module == 'Service' || $req_module == 'Faq' || $req_module == 'KnowledgeBase')
				{ ?>
...
else
{
	...
	$import_modules_array = Array(
        ...
        "Premuimproduct"=>"Premuimproduct",
        "Promotionvoucher"=>"Promotionvoucher",
        "Service"=>"Service",
        "Faq"=>"Faq",
