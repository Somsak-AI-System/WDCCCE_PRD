...
class ImportPromotionvoucher extends Promotionvoucher {
	 var $db;
	...
	function modseq_number() {
		$this->column_fields['promotionvoucher_no'] = '';
	}
	// END

	/** Constructor which will set the importable_fields as $this->importable_fields[$key]=1 in this object where key is the fieldname in the field table
	 */
	function ImportPromotionvoucher() {
		parent::Promotionvoucher();
		$this->log = LoggerManager::getLogger('import_promotionvoucher');
		$this->db = PearDatabase::getInstance();
		$this->db->println("IMP ImportPromotionvoucher");
		$this->initImportableFields("Promotionvoucher");
