...
function assign_user()
{
	...
	function map_campaign_source(){
		...
		$query = "select campaignid from aicrm_campaign inner join aicrm_crmentity on aicrm_crmentity.crmid=aicrm_campaign.campaignid WHERE aicrm_campaign.campaignname=? and aicrm_crmentity.deleted=0";
