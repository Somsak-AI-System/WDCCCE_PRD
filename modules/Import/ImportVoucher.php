...
class ImportVoucher extends Voucher {
	 var $db;
	...
	function ImportVoucher() {
		parent::Voucher();
		$this->log = LoggerManager::getLogger('import_voucher');
		$this->db = PearDatabase::getInstance();
		$this->db->println("IMP Importvoucher");
		$this->initImportableFields("Voucher");
