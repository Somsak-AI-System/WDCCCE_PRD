 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/aicrm_crm/sugarcrm/modules/Import/ImportCampaigns.php,v 1.3 2005/03/05 05:41:09 jack Exp $
...
class ImportCampaigns extends Campaigns {
	 var $db;
	...
	function modseq_number() {
		$this->column_fields['campaign_no'] = '';
	}
	// END
	...
	function ImportCampaigns() {
		parent::Campaigns();
		$this->log = LoggerManager::getLogger('import_campaigns');
		$this->db = PearDatabase::getInstance();
		$this->db->println("IMP ImportCampaigns");
		$this->initImportableFields("Campaigns");
