...
<table border=0 cellspacing=0 cellpadding=5 width=100% class="layerHeadingULine">
	<tr>
		...
		<td align=right>
			<a href="javascript:fninvsh('calSettings');"><img src="<?php echo aicrm_imageurl('close.gif', $theme) ?>" border="0"  align="absmiddle" /></a>
		</td>
	</tr>
	</table>
...
<table border=0 cellspacing=0 cellpadding=5 width=95% align=center> 
	<tr>
		<td class=small >
			...
			<tr>
		<td align="right" width="10%" valign="top"><img src="<?php echo aicrm_imageurl('cal_clock.jpg', $theme)  ?>" align="absmiddle"></td>
	...
	<tr>
		<td align="right" valign="top"><img src="<?php echo aicrm_imageurl('cal_sharing.jpg', $theme) ?>" width="45" height="38" align="absmiddle"></td>
		<td align="left">
