...
if(isset($_REQUEST['viewBirthday'])){
	$birthday = isset($_REQUEST['viewBirthday']) ? vtlib_purify($_REQUEST['viewBirthday']) : 'All';
}elseif(isset($_REQUEST['birthday'])){
	$birthday = isset($_REQUEST['birthday']) ? vtlib_purify($_REQUEST['birthday']) : 'All';
}else{
	$birthday = 'All';
}

//$birthday = vtlib_purify($_REQUEST['birthday']);
...
$calendar_arr['modulebirthday'] = $birthday;
