 ...
 * All Rights Reserved.
 ********************************************************************************/
document.write("<script type='text/javascript' src='include/js/Inventory_calendar.js'></"+"script>");
...
function set_return_specific(activityid, activityname,form) {
        var fldName = getOpenerObj("activity_name");
        var fldId = getOpenerObj("activityid");
        fldName.value = activityname;
        fldId.value = activityid;
