...
$menu_array['CustomFields']['location'] = 'index.php?module=Settings&action=LayoutBlockList&parenttab=Settings&formodule='.$module;
$menu_array['CustomFields']['image_src'] = aicrm_imageurl('orgshar.gif', $theme);
