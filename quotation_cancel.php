...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
	 	<td class="moduleName" width="80%" style="padding-left:10px;">Quotation Cancel</td>
	...
	<table width="100%" cellpadding="5" cellspacing="0" border="0"  class="homePageMatrixHdr">
		<tr>
			...
			<form id="QuoEditView" method="POST" name="QuoEditView">
                ...
                <input type="hidden" name="quotationstatus" id="quotationstatus" class="txtBox"  style="width:210px" value="<?php echo @$approve_status?>">
				<table width="100%" cellpadding="5" cellspacing="0">

				<?php if($approve_status == 'Cancel_Quotation'){?>
					<tr>
					  <td width="20%" class="dvtCellLabel small">เหตุผลการยกเลิกใบเสนอราคา</td>
					  <td width="30%" class="dvtCellInfo"><textarea id="quota_cancel" class="detailedViewTextBox" tabindex="" onfocus="this.className='detailedViewTextBoxOn'" name="quota_cancel" onblur="this.className='detailedViewTextBox'" cols="90" rows="8" required></textarea></td>
					</tr>
				<?php }else{ ?>
					<tr>
					  <td width="20%" class="dvtCellLabel small">เหตุผลการไม่อนุมัติใบเสนอราคา</td>
					  <td width="30%" class="dvtCellInfo"><textarea id="quota_notapprove" class="detailedViewTextBox" tabindex="" onfocus="this.className='detailedViewTextBoxOn'" name="quota_notapprove" onblur="this.className='detailedViewTextBox'" cols="90" rows="8"></textarea></td>
					</tr>
				<?php } ?>
