...
if(USE_CACHE) {
	...
	if ( strstr( PHP_OS, 'WIN') ) {
		...
		DEFINE('CACHE_DIR','./images/graph/');
		//DEFINE('CACHE_DIR','c:/AppServ/www/testgraph/');
	    }
	} else {
		DEFINE('CACHE_DIR','./images/graph/');
	   // DEFINE('CACHE_DIR','c:/AppServ/wwww/testgraph/images/');
	}
    }
}
...
//set font thai
		FF_THAI => array(FS_NORMAL=>'cordia.ttf', FS_BOLD=>'cordiab.ttf', FS_ITALIC=>'', FS_BOLDITALIC=>'') 
);
    }
...
class DisplayValue {
	...
	function SetFormat1($aFormat,$aNegFormat="") {
	$this->format= $aFormat;
	$this->negformat= $aNegFormat;
    }
...
// CONSTRUCTOR
	...
	if($_SESSION["graph_no"]<>"" and $_SESSION["graph_no"]=="1"){
		$this->coords1[0]=$_SESSION["datay1_1"];
	}
	//$this->loop=1;
	if( is_array($aDatax) )
