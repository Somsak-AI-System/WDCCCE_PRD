<?php
	...
	if($newcompetitor != ''){
		$pquery .= " ,aicrm_deal.newcompetitor = '".$newcompetitor."' ";
	}
	...
	$sql = "INSERT INTO tbt_log_quote_saleorder (modules, crmid, userid, status, comments, date_time, form) VALUES ('Deal',
