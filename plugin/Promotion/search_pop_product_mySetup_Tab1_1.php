<?php
	...
	if($_REQUEST["myaction"]=="search"){
		if($_REQUEST["search_pname"]!=""){
			...
			$where.=" and aicrm_premuimproduct.premuimproduct_name like '%".$_REQUEST["search_pname"]."%'";
		}else{
				...
				<table width="100%" cellpadding="5" cellspacing="0" border="0"  class="homePageMatrixHdr">
					<tr>
						<td style="padding:0px;" >
	                   	  <form name="basicSearch" method="post" enctype="multipart/form-data" action="search_pop_product_mySetup_Tab1_1.php">
							...
							<tr>
							  ...
							  <td width="30%" class="dvtCellLabel"><input type="text" name="search_pname" id="search_pname" class="txtBox" value="<?=$_SESSION["search_pname"]?>"></td>
							  </tr>
							<tr>
										...
										<table style="background-color: rgb(204, 204, 204);" class="small" border="0" cellpadding="5" cellspacing="1" width="100%">
											<tbody>
								                ...
								                <tr bgcolor=white onMouseOver="this.className='lvtColDataHover'" onMouseOut="this.className='lvtColData'"  >
										   			...
										   			<td valign="top"><a href="javascript:window.close();" id='popup_product_<?=$value['premuimproductid']?>' onclick='return_premium("<?=$value['premuimproductid']?>", "<?=$value['premuimproductid']?>", "<?=$value['premuimproduct_name']?>","<?=$value['unit']?>","<?=$value['stock_quantity']?>","<?=$value['premium_price']?>","<?=$row_id?>","mySetup_Tab1_1","<?=$value['premuimproduct_name']?>","<?=$value['premium_product_code']?>");' vt_prod_arr='{"premuimproductid":"<?=$$value['premuimproductid']?>","productid":"<?=$value['premuimproductid']?>","productname":"<?=$value['premuimproduct_name']?>","uom":"<?=$value['unit']?>","quantity":"<?=$value['stock_quantity']?>","listprice":"<?=$value['premium_price']?>","row_id":"<?=$row_id?>","tab_name":"mySetup_Tab1_1","premuimproduct_name":"<?=$value['premuimproduct_name']?>","premium_product_code":"<?=$value['premium_product_code']?>"}'  ><?=$value['premuimproduct_name']?></a></td>
										   			<td valign="top" align="center"><?=$value['unit']?></td>
								                    <td valign="top" align="center"><?=$value['stock_quantity']?></td>
