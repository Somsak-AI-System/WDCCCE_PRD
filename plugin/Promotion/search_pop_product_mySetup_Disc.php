<?php
	...
	if($_REQUEST["myaction"]=="search"){
		//echo $_REQUEST["curr_row"];
		//$_REQUEST["curr_row"]=$_REQUEST["curr_row"];
			...
			<table width="100%" cellpadding="5" cellspacing="0" border="0"  class="homePageMatrixHdr">
				<tr>
					<td style="padding:0px;" >
                   	  <form name="basicSearch" method="post" enctype="multipart/form-data" action="search_pop_product_mySetup_Disc.php">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
	<tr>
					<td style="padding-left:5px;" align="left"><input class="crmbutton small save" type="button" value="Select Products" onClick="if(InventorySelectAll_mySetup_Disc('Products',image_pth))window.close();"/></td>
   	...
   	<tr>
		...
		<tbody>
			<tr>
				...
				<td class="lvtCol"><a href='javascript:;' onClick="getListViewSorted_js('Products','&curr_row=1&popuptype=inventory_prod&select=enable&return_module=Products&order_by=product_no&sorder=DESC')" class='listFormHeaderLinks'>หมายเลขสินค้า&nbsp;</a></td>
				<td class="lvtCol"><a href='javascript:;' onClick="getListViewSorted_js('Products','&curr_row=1&popuptype=inventory_prod&select=enable&return_module=Products&order_by=product_code&sorder=DESC')" class='listFormHeaderLinks'>รหัสสินค้า&nbsp;</a></td>
				<td class="lvtCol"><a href='javascript:;' onClick="getListViewSorted_js('Products','&curr_row=1&popuptype=inventory_prod&select=enable&return_module=Products&order_by=productname&sorder=DESC')" class='listFormHeaderLinks'>ชื่อสินค้า (TH)&nbsp;<img src ='../../themes/softed/images/arrow_down.gif' border='0'></a></td>
		    	<td class="lvtCol"><a href='javascript:;' onClick="getListViewSorted_js('Products','&curr_row=1&popuptype=inventory_prod&select=enable&return_module=Products&order_by=unit&sorder=DESC')" class='listFormHeaderLinks'>หน่วยนับ</a></td>
		    	<td class="lvtCol"><a href='javascript:;' onClick="getListViewSorted_js('Products','&curr_row=1&popuptype=inventory_prod&select=enable&return_module=Products&order_by=sellingprice&sorder=DESC')" class='listFormHeaderLinks'>ราคาขาย&nbsp;</a></td>
	    	</tr>
                <?
				...
				?>            
				        <tr bgcolor=white onMouseOver="this.className='lvtColDataHover'" onMouseOut="this.className='lvtColData'"  >
			   			...
			   			<td><a href="javascript:window.close();" id='popup_product_<?=$value['productid']?>' onclick='set_return_inventory_mySetup_Disc("<?=$value['productid']?>", "<?=str_replace('"','',$value['productname'])?>", "<?=$unit_price?>", "0.000","tax1=7.000,tax2=10.000,tax3=12.500","<?=$_REQUEST["curr_row"]?>","","::","<?=$value['unit']?>");' vt_prod_arr='{"entityid":"<?=$value['productid']?>","prodname":"<?=str_replace('"','',$value['productname'])?>","unitprice":"<?=$unit_price?>","qtyinstk":"0.000","taxstring":"tax1=7.000,tax2=10.000,tax3=12.500","rowid":"<?=$_REQUEST["curr_row"]?>","desc":"","subprod_ids":"::","usageunit":"<?=$value['unit']?>"}' ><?=$value['productname']?></a></td>
			            <td><?=$value['unit']?></td>
			            <td><?=number_format($value['sellingprice'],2);?></td>
	                    </tr>
                <?
					}
				?>
