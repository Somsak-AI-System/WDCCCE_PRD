			...
			<td style="padding:0px;" >
					...
					<tr>
					  ...
					  <td width="30%" class="">
                    	...
                    	<input id="sendtime" name="sendtime" style="width:80px;" value="<?php echo date("H:i",strtotime(date("H:i")." +30 minutes"));?>" autocomplete="on" class="easyui-timespinner" data-options="showSeconds:false,editable:true">
