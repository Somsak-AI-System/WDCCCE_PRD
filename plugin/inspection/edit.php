                    ...
                    <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false" data-widget-sortable="false">
                        ...
                        <div>
                                                    ...
                                                    <fieldset id="remove_<?php echo $table;?>" class="template1-form-box" style="padding-bottom:20px;">
                                                        ...
                                                        <div class="row">
                                                            <section class="col col-10" style="margin-bottom:5px;">
                                                                <label class="input">
                                                                    <input name="<?php echo $table;?>_headtext" type="text" value="<?php echo $value['choice_title'];?>" class="template1-head user-success" style="border:0px; border-bottom:1px dotted #CCCCCC; color:#0000FF; font-style:italic; font-weight:bold;" >
                                                                </label>
                                                            </section>
                                                            ...
                                                            <table id="<?php echo $table;?>" class="table">
                                                                ...
                                                                foreach($value['list'] as $k =>$v){
                                                                    ...
                                                                    <tr class="<?php echo $tr;?>">
                                                                        <td class="temp-input">
                                                                            <div style="width:19px; margin:0 auto">
                                                                                <label class="checkbox" >
                                                                                    <input name="result_<?php echo $table;?>[]" value="" type="checkbox" disabled="disabled" <?php echo (@$v['answer']['status_list_template2'] == '1') ? 'checked' : ''; ?> ><i></i>
                                                                                </label>
                                                                            </div>
                                                                        ...
                                                                        <td>
                                                                            <label class="input">
                                                                                <input name="label_<?php echo $table;?>[]" type="text" class="pm-left pm-list-autocomplete ui-autocomplete-input user-success" value='<?php echo $v['list'];?>' >
                                                                            </label>
                                                                        </td>
                                                                ...
                                                                foreach($value['list'] as $k =>$v){
                                                                    ...
                                                                    <tr class="<?php echo $tr;?>">
                                                                        ...
                                                                        <td class="temp-input">
                                                                            <div style="width:19px; margin:0 auto">
                                                                                <label class="radio" >
                                                                                    <input name="result_<?php echo $table;?>[]" value="" type="radio" disabled="disabled" <?php echo (@$v['answer']['status_list_template2'] == '1') ? 'checked' : ''; ?> ><i></i>
                                                                                </label>
                                                                            </div>
                                                    ...
                                                    <fieldset id="remove_<?php echo $table;?>" class="template1-form-box" style="padding-bottom:20px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-4" style="margin-bottom:5px;">
                                                                <a href="javascript:ShowHideTemp4('<?php echo $table;?>');" id="<?php echo $table;?>-collapse" class="btn btn-sm btn-default"><i class="fa fa-toggle-down"></i></a>
                                                            </section>
                                                            <section class="col col-2" style="margin-bottom:5px;">
                                                                <div class="btn-group" style="float:right;">
                                                                    <a href="javascript:ShowHideTable('<?php echo $table;?>');" id="<?php echo $table;?>-collapse" class="btn btn-sm btn-default"><i class="fa fa-minus"></i></a>
                                                ...
                                                <?php }else if($value['choice_type']== 'template5'){ ?>
                                                    ...
                                                    <fieldset id="remove_<?php echo $table;?>" class="template5-form-box" style="padding-bottom:20px;">
                                                        ...
                                                        <div class="row">
                                                            <section class="col col-10" style="margin-bottom:5px;">
                                                                <label class="input">
                                                                    <input name="<?php echo $table;?>_headtext" type="text" value="<?php echo $value['choice_title'];?>" class="note-head user-success" style="border:0px; border-bottom:1px dotted #CCCCCC; color:#0000FF; font-style:italic; font-weight:bold;" >
                                                                </label>
                                                            </section>
                                                    ...
                                                    <fieldset id="remove_<?php echo $table;?>" class="template6-form-box" style="padding-bottom:20px;">
                                                        ...
                                                        <table id="<?php echo $table;?>" class="form-table">
                                                            ...
                                                            foreach($value['list'] as $k =>$v){
                                                                ...
                                                                <td>
                                                                    <label class="input">
                                                                        <input type="text" class="temp-input" name="label_<?php echo $table;?>[]" value="<?php echo $v['list'];?>" />
                                                                    </label>
                                                                </td>
                                                                </td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        foreach($choiceDetailList[$v['choicedetailid']] as $k => $v){
                                                                            ...
                                                                            <div style="padding-left:30px;">
                                                                                <label class="input">
                                                                                    <input type="hidden" name="tr_<?php echo $table;?>[]" size="100" value="<?php echo $tr;?>">
                                                                                    <input name="child_label_<?php echo $tr;?>[]" type="text" class="pm-left pm-list-autocomplete ui-autocomplete-input user-success" value='<?php echo $v['value'];?>' >
                                                                                </label>
                                                                            </div>
                                                    ...
                                                    <fieldset id="remove_<?php echo $table;?>" class="template1-form-box" style="padding-bottom:20px;">
                                                        ...
                                                        <table class="table table-bordered " id="<?php echo $table;?>">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th colspan="6">
                                                                    <label class="input">
                                                                        <input name="<?php echo $table; ?>_head_col1" type="text" class="template9-inphead" placeholder="Date:__/__/__-__/__/__" value=""
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>
                                                                    <label class="input">
                                                                        <input name="<?php echo $table; ?>_head_col11" type="text" class="template9-inphead" placeholder="" value="<?php echo $value['head_col1']; ?>"
                                                                               style="border:0px; border-bottom:1px dotted #CCCCCC; color:#0000FF; text-align: center;" >
                                                                    </label>
                                                                </th>
                                                            ...
                                                            foreach($value['list'] as $k =>$v){
                                                                ...
                                                                <tr class="<?php echo $tr;?>">
                                                                    <td style="text-align: center;">
                                                                        ...
                                                                        <input type="hidden"  name="<?php echo $table; ?>_seq[]" value="" />
                                                                    </td>
                                                                    <td>
                                                                        <input type="hidden" class="temp-input template9-inphead" name="" value="" />
                                                                    </td>
                                                                    <td>
                                                                        <input type="hidden" class="temp-input template9-inphead" name="" value="" />
                                                                    </td>
                            ...
                            <span class="fa fa-minus"></spacn>
                                                                    ...
                                                                    <td width="85%">
                                                                        <label class="input">
                                                                            <input type="text" class="temp-inputText" name="label_<?php echo $table;?>[]" value="<?php echo $v['list'];?>" placeholder="label" />
                                                                            </labe>
                                                                    </td>
                                                        ...
                                                        <table class="table table-bordered " id="<?php echo $table;?>">
                                                            ...
                                                            foreach($value['list'] as $k =>$v){
                                                                ...
                                                                <tr class="<?php echo $tr;?>">
                                                                    <td>
                                                                        <label class="input" >
                                                                            <input name="label_<?php echo $table;?>[]" type="text" class="template12-inphead" value="<?php echo $v['list'];?>"
                                                                                   style="border:0px; border-bottom:1px dotted #CCCCCC; color:#0000FF; text-align: center;" >
                                                                        </label>
                                                                    </td>
                                                                    <td style="text-align: center;">
                                                        ...
                                                        <table class="table table-bordered " id="<?php echo $table;?>">
                                                            ...
                                                            foreach($value['list'] as $k =>$v){
                                                                ...
                                                                <tr class="<?php echo $tr;?>">
                                                                    <td >
                                                                        <label class="input" >
                                                                            <input name="label_<?php echo $table;?>[]" type="text" class="template13-inphead" value="<?php echo $v['list'];?>"
                                                                                   style="border:0px; border-bottom:1px dotted #CCCCCC; color:#0000FF; text-align: left;" >
                                                                        </label>
                                                                    </td>
                                                                    <td>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <label class="input" >
                                                                            <input name="sub_label_<?php echo $table;?>[]" type="text" class="template13-inphead" value="<?php echo $v['sublist'];?>"
                                                                                   style="border:0px; border-bottom:1px dotted #CCCCCC; color:#0000FF; text-align: left;" >
                                                                        </label>
                                                                    </td>
                                                                    <td style="text-align: center;">
                                                        ...
                                                        <table class="table table-bordered " id="<?php echo $table;?>">
                                                                ...
                                                                <td>
                                                                    <label class="input">
                                                                        <input name="<?php echo $table; ?>_head_col0" type="text" class="template15-inphead" value="<?php echo $value['head_col0']; ?>"
                                                                               style="border:1px; border-bottom:1px dotted #CCCCCC; color:#0000FF; text-align: center" >
                                                                    </label>
                                                                </td>
                                                                <td>
                                                                    <label class="input">
                                                            ...
                                                            foreach($value['list'] as $k =>$v){
                                                                ...
                                                                <tr class="<?php echo $tr;?>">
                                                                    ...
                                                                    <td>
                                                                        <label class="input" >
                                                                            <input name="accept_range_<?php echo $table;?>[]" type="text" class="template12-inphead" value="<?php echo $v['accept_range'];?>"
                                                                                   style="border:0px; border-bottom:1px dotted #CCCCCC; color:#0000FF; text-align: center;" >
                                                                        </label>
                                                                    </td>
                                                                    <td>
                                                                        <div >
                                                                            <label class="radio" >
                                                                                <input name="<?php echo $tr;?>_result" value="" type="radio" disabled="disabled" <?php echo (@$v['answer']['status_list_template15_1'] == '1') ? 'checked' : ''; ?> >ใช่<i></i>
                                                                            </label>
                                                                        </div>
                                                                        <div >
                                                                            <label class="radio" >
                                                                                <input name="<?php echo $tr;?>_result" value="" type="radio" disabled="disabled" <?php echo (@$v['answer']['status_list_template15_2'] == '1') ? 'checked' : ''; ?> >ไม่ใช่<i></i>
                                                                            </label>
                                                                        </div>
                                                                    </td>
