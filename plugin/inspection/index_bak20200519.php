...
<html lang="en-us" >
	<head>
		...
		<link rel="apple-touch-startup-image" href="iphone.png" media="screen and (max-device-width: 320px)">
		...
		<script>
			if (!window.jQuery) {
				document.write('<script src="jquery-2.1.1.min.js"><\/script>');
		...
		<script>
			if (!window.jQuery.ui) {
				document.write('<script src="jquery-ui-1.10.3.min.js"><\/script>');
			 ...
			 You can also add different skin classes such as "smart-skin-1", "smart-skin-2" etc...-->
				...
				<header id="header">
					<div id="logo-group">
                        ...
                        <span id="logo"><img src="nlogo3.png" /></span>
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as is --> 
					...
					<a href="http://203.107.236.212/?page=profile&id=501" id="show-shortcut">
						<span id="show-pic-box"><img src="user.png"></span>
						<span>
							AI						</span>
					</a> 
...
<!-- END PAGE FOOTER --><!-- END PAGE FOOTER -->
		...
		<!-- CUSTOM NOTIFICATION -->
		<script src="SmartNotification.min.js"></script>

		<!-- JARVIS WIDGETS -->
		<script src="jarvis.widget.min.js"></script>

		<!-- EASY PIE CHARTS -->
		<script src="jquery.easy-pie-chart.min.js"></script>
		...
		<script src="voicecommand.min.js"></script>	

		<!-- SmartChat UI : plugin -->
		<script src="smart.chat.ui.min.js"></script>
		<script src="smart.chat.manager.min.js"></script>
