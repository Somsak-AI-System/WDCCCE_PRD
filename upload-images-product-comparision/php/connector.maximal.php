...
$opts = array(
    ...
    'bind' => array(
        ...
        'edit extract mkdir mkfile rm duplicate paste upload put' => 'clear_size_cache',
    ),
    // volume options of netmount volumes
    'optionsNetVolumes' => array(
        '*' => array( // "*" is all of netmount volumes
            'tmbURL'    => dirname($_SERVER['PHP_SELF']) . '/../images/.tmbNetmount/',
            'tmbPath'   => '../images/.tmbNetmount',
...
$tmbConfig = array(
    'tmbPath'          => '../images/.tmbCloud',
    'tmbURL'           => dirname($_SERVER['PHP_SELF']) . '/../images/.tmbCloud/',
