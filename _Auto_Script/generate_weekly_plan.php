...
$sql="
	CREATE TABLE `aicrm_activity_tran_config_monthly_plan` (
	  ...
	  `addempcd` varchar(20) default NULL COMMENT '',
	  `addpcnm` varchar(50) default NULL COMMENT '',
	  `adddt` datetime default NULL COMMENT '',
	  `updempcd` varchar(20) default NULL COMMENT '',
	  `updpcnm` varchar(50) default NULL COMMENT '',
	  `upddt` datetime default NULL COMMENT '',
...
$sql="
	CREATE TABLE `aicrm_activity_tran_weekly_plan` (
	  ...
	  `weekly_check_send` varchar(1) NOT NULL default '0' COMMENT '',
	  `addempcd` varchar(20) default NULL COMMENT '',
	  `addpcnm` varchar(50) default NULL COMMENT '',
	  `adddt` datetime default NULL COMMENT '',
	  `updempcd` varchar(20) default NULL COMMENT '',
...
$sql="
	CREATE TABLE `aicrm_activity_tran_monthly_plan` (
	  `monthly_id` int(20) NOT NULL COMMENT 'rating_id',
	  `monthly_no` int(20) NOT NULL COMMENT '',
	  `monthly_start_date` date NOT NULL,
	  `monthly_end_date` date NOT NULL,
	  `monthly_year` int(20) NOT NULL,
	  `monthly_user_id` int(20) NOT NULL,
	  `monthly_send_date` datetime NOT NULL,
	  `monthly_check_send` varchar(1) NOT NULL default '0' COMMENT '',
	  `addempcd` varchar(20) default NULL COMMENT '',
	  `addpcnm` varchar(50) default NULL COMMENT '',
	  `adddt` datetime default NULL COMMENT '',
	  `updempcd` varchar(20) default NULL COMMENT '',
...
$sql="
	CREATE TABLE `aicrm_activity_tran_daily_report` (
	  ...
	  `daily_check_send` varchar(1) NOT NULL default '0' COMMENT '',
	  `addempcd` varchar(20) default NULL COMMENT '',
	  `addpcnm` varchar(50) default NULL COMMENT '',
	  `adddt` datetime default NULL COMMENT '',
	  `updempcd` varchar(20) default NULL COMMENT '',
	  `updpcnm` varchar(50) default NULL COMMENT '',
	  `upddt` datetime default NULL COMMENT 'ا',
	  `deleted` varchar(1) NOT NULL default '0',
...
for($year_chk=date('Y'); $year_chk<=(date('Y')+1); $year_chk++){
	...
	if(count($data_chk)>0){
		...
		$endYear = $year_chk."-12-31";
        $dateData = new DateTime($endYear);
        $week = $dateData->format("W");
        $week = $week == '01' ? '52':$week;
