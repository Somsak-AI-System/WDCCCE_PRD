...
$HELPDESK_SUPPORT_EMAIL_ID = 'info@aisyst.com';
...
$dbconfig['db_server'] = '54.169.11.153';
$dbconfig['db_port'] = ':3306';
$dbconfig['db_username'] = 'root';
$dbconfig['db_password'] = 'l;ylfugvwvai';
$dbconfig['db_name'] = 'db_wdccce_prd';
...
$site_URL = 'http://'.$_SERVER['HTTP_HOST'].'/wdccceprd/';
$site_URL_service = 'http://'.$_SERVER['HTTP_HOST'].'/wdccceprd/WB_Service_AI/';
$public_path = 'http://localhost/';
// root directory path
$root_directory = 'C:/AppServ/www/WDCCCEPRD/';

// $site_URL = 'http://'.$_SERVER['HTTP_HOST'].'/GLAPCRM/';
// $site_URL_service = 'http://'.$_SERVER['HTTP_HOST'].'/GLAPCRM/WB_Service_AI/';
// // $site_URL = 'https://glapcrm.ai-crm.com/';
// // $site_URL_service = 'https://glapcrm.ai-crm.com/WB_Service_AI/';
// $public_path = 'http://localhost/';
// // root directory path
// $root_directory = 'C:/AppServ/www/GLAPCRM/';
...
$list_max_user = '100';
//ekk 01/11/2013
//config Ai-CRm Mobile
$permission_mobile=array(array('mobile_id'=>9,'mobile_name'=>'Carlendar','ios_flg'=>0,'android_flg'=>0),array('mobile_id'=>38,'mobile_name'=>'Job','ios_flg'=>0,'android_flg'=>0));
...
$application_unique_key = 'e5bdfbe0e4658822cf36f95d7de36d35';

// trim descriptions, titles in listviews to this value
$listview_max_textlength = 150;
...
$path_pic_std="moai_pic";

$report_viewer_url = "https://wdcuat.ai-crm.com:8443/birt-viewer/frameset?__showtitle=false&__report=WDCCCE/";
$report_viewer_url_service= "https://wdcuat.ai-crm.com:8443/birt-viewer/frameset?__showtitle=false&__report=WDCCCE/";
?>