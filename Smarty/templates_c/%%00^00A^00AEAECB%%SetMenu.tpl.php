<?php /* Smarty version 2.6.18, created on 2026-04-09 11:25:46
         compiled from SetMenu.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'SetMenu.tpl', 29, false),array('modifier', 'aicrm_imageurl', 'SetMenu.tpl', 64, false),)), $this); ?>
<?php 
...
<?php endforeach; endif; unset($_from); ?>
					...
					<td width="8px" valign="top"> 
						<img src="<?php echo aicrm_imageurl('panel-left.png', $this->_tpl_vars['THEME']); ?>
" title="Hide Menu" id="hideImage" style="display:inline;cursor:pointer;" onclick="toggleShowHide_panel('showImage','settingsSideMenu'); toggleShowHide_panel('showImage','hideImage');" />
						<img src="<?php echo aicrm_imageurl('panel-right.png', $this->_tpl_vars['THEME']); ?>
