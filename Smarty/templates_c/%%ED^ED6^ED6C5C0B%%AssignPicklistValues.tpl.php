<?php /* Smarty version 2.6.18, created on 2026-04-09 11:53:35
         compiled from modules/PickList/AssignPicklistValues.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'aicrm_imageurl', 'modules/PickList/AssignPicklistValues.tpl', 31, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['pick_val']; ?>
			...
			<td align="center" width="25px;">
				<img border="0" title="right" alt="Move Right" onclick="moveRight();" style="cursor: pointer" src="<?php echo aicrm_imageurl('arrow_right.png', $this->_tpl_vars['THEME']); ?>
"/>
				<img border="0" title="left" alt="Remove" onclick="removeValue();" style="cursor: pointer" src="<?php echo aicrm_imageurl('arrow_left.png', $this->_tpl_vars['THEME']); ?>
"/>
			</td>
			<td width="auto;">
...
"><?php echo $this->_tpl_vars['val']; ?>
			...
			<td align="center">
				<img border="0" title="up" alt="Move Up" onclick="moveUp();" style="cursor: pointer" src="<?php echo aicrm_imageurl('arrow_up.png', $this->_tpl_vars['THEME']); ?>
"/>
				<img border="0" title="down" alt="Move Down" onclick="moveDown();" style="cursor: pointer" src="<?php echo aicrm_imageurl('arrow_down.png', $this->_tpl_vars['THEME']); ?>
"/>
			</td>
		</tr>
		<tr>
