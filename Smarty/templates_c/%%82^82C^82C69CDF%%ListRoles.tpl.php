<?php /* Smarty version 2.6.18, created on 2026-04-09 17:24:01
         compiled from ListRoles.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'aicrm_imageurl', 'ListRoles.tpl', 91, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="<?php echo aicrm_imageurl('ico-roles.gif', $this->_tpl_vars['THEME']); ?>
...
function showhide(argg,imgId)
{
	...
	for(i=0; i<harrlen; i++)
	{
		var x=document.getElementById(harray[i]).style;
        	...
        	{
           		x.display="block";
			document.getElementById(imgId).src="<?php echo aicrm_imageurl('minus.gif', $this->_tpl_vars['THEME']); ?>
";
         	}
        	else
		{
			x.display="none";
			document.getElementById(imgId).src="<?php echo aicrm_imageurl('plus.gif', $this->_tpl_vars['THEME']); ?>
";
		}
	}
}
