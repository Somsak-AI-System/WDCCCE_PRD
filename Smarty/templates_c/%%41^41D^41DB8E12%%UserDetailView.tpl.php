<?php /* Smarty version 2.6.18, created on 2026-04-08 16:56:59
         compiled from UserDetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'aicrm_imageurl', 'UserDetailView.tpl', 25, false),array('modifier', 'getTranslatedString', 'UserDetailView.tpl', 160, false),array('modifier', 'vtlib_purify', 'UserDetailView.tpl', 274, false),)), $this); ?>
...
" style="margin:0px">
							...
							<tr>
								<td colspan=2>
									...
									<tr>
										<td width=50 rowspan="2"><img src="<?php echo aicrm_imageurl('ico-users.gif', $this->_tpl_vars['THEME']); ?>
" align="absmiddle"></td>	
										<td>
											<?php if ($this->_tpl_vars['CATEGORY'] == 'Settings'): ?>
											<span class="heading2">
...
" </b></span>
											...
											<?php endif; ?>
											<span id="vtbusy_info" style="display:none;" valign="bottom"><img src="<?php echo aicrm_imageurl('vtbusy.gif', $this->_tpl_vars['THEME']); ?>
" border="0"></span>					
										</td>
...
. <?php echo $this->_tpl_vars['UMOD']['LBL_HOME_PAGE_COMP']; ?>
										 ...
										 <td class="small" align="right"><img src="<?php echo aicrm_imageurl('showDown.gif', $this->_tpl_vars['THEME']); ?>
...
?>
										<tr><td class="dvtCellLabel" align="right" width="30%"><?php echo getTranslatedString($this->_tpl_vars['UMOD'][$this->_tpl_vars['values']], 'Home'); ?>
											...
											<?php if ($this->_tpl_vars['homeitems'] != ''): ?>
												...
												<img src="<?php echo aicrm_imageurl('prvPrfSelectedTick.gif', $this->_tpl_vars['THEME']); ?>
...
" height="12" width="12"></td><td class="dvtCellInfo" align="left"><?php echo $this->_tpl_vars['UMOD']['LBL_SHOWN']; ?>
												...
												<?php else: ?>	
												<td class="dvtCellInfo" align="center" width="5%">
												<img src="<?php echo aicrm_imageurl('no.gif', $this->_tpl_vars['THEME']); ?>
...
. <?php echo $this->_tpl_vars['UMOD']['LBL_MY_GROUPS']; ?>
										...
										<img src="<?php echo aicrm_imageurl('showDown.gif', $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['APP']['LBL_EXPAND_COLLAPSE']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_EXPAND_COLLAPSE']; ?>
