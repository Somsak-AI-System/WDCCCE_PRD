<?php /* Smarty version 2.6.18, created on 2026-04-08 16:51:40
         compiled from Home/MainHomeBlock.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'getTranslatedString', 'Home/MainHomeBlock.tpl', 3, false),array('modifier', 'aicrm_imageurl', 'Home/MainHomeBlock.tpl', 19, false),)), $this); ?>
...
<?php if (( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Default' || $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['keymetrics_title'] ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Default' || $this->_tpl_vars['tablestuff']['Stufftitle'] != $this->_tpl_vars['homepagedashboard_title'] ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Tag Cloud' ) && ( $this->_tpl_vars['tablestuff']['Stufftype'] != 'Notebook' )): ?>
				<a id="editlink" style='cursor:pointer;' onclick="showEditrow(<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
					...
					<img src="<?php echo aicrm_imageurl('windowSettings.gif', $this->_tpl_vars['THEME']); ?>
" border="0" alt="Edit" title="Edit" hspace="2" align="absmiddle"/>
				</a>	
<?php else: ?>
				<img src="<?php echo aicrm_imageurl('windowSettings-off.gif', $this->_tpl_vars['THEME']); ?>
" border="0" alt="Edit" title="Edit" hspace="2" align="absmiddle"/>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['tablestuff']['Stufftitle'] == $this->_tpl_vars['homepagedashboard_title']): ?>
				<a style='cursor:pointer;' onclick="fetch_homeDB(<?php echo $this->_tpl_vars['tablestuff']['Stuffid']; ?>
					...
					<img src="<?php echo aicrm_imageurl('windowRefresh.gif', $this->_tpl_vars['THEME']); ?>
...
)"><img src="<?php echo aicrm_imageurl('windowMinMax.gif', $this->_tpl_vars['THEME']); ?>
" border="0" alt="Hide" title="Hide" hspace="5" align="absmiddle"/></a>
<?php else: ?>
				<img src="<?php echo aicrm_imageurl('windowMinMax-off.gif', $this->_tpl_vars['THEME']); ?>
...
)"><img src="<?php echo aicrm_imageurl('windowClose.gif', $this->_tpl_vars['THEME']); ?>
" border="0" alt="Close" title="Close" hspace="5" align="absmiddle"/></a>
<?php else: ?>
				<img src="<?php echo aicrm_imageurl('windowClose-off.gif', $this->_tpl_vars['THEME']); ?>
