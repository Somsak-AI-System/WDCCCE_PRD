<?php /* Smarty version 2.6.18, created on 2026-04-08 16:55:22
         compiled from ActivityListView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'aicrm_imageurl', 'ActivityListView.tpl', 233, false),array('function', 'html_options', 'ActivityListView.tpl', 267, false),)), $this); ?>
...
<table width="100%" cellpadding="5" cellspacing="0"  class="searchUIBasic small" align="center" border=0>
 ...
 <?php echo $this->_tpl_vars['APP']['LNK_ADVANCED_SEARCH']; ?>
		...
		<!-- <img src="<?php echo aicrm_imageurl('basicSearchLens.gif', $this->_tpl_vars['THEME']); ?>
				   ...
				   <table border=0 cellspacing=0 cellpadding=0 class="small">
					<tr>
                        ...
                        <td style="padding-left:5px;padding-right:5px">
                           <select id='pagesize' class="small" style="width:50px;border-radius:3px;"  onchange="per_padding()" ><!-- onchange="per_padding()"onchange="showpagesize(this,'<?php echo $this->_tpl_vars['MODULE']; ?>
')" -->
...
' onClick=check_object(this); toggleSelectAll(this.name,"selectall")>
                            	</td>
                            <?php endif; ?>
                  	<?php else: ?>
