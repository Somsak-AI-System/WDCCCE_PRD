<?php /* Smarty version 2.6.18, created on 2026-04-08 16:51:38
         compiled from Home/HomeButtons.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'aicrm_imageurl', 'Home/HomeButtons.tpl', 37, false),array('modifier', 'getTranslatedString', 'Home/HomeButtons.tpl', 301, false),)), $this); ?>
										...
										<table border=0 cellspacing=0 cellpadding=2>
											<tr>
												<td style="padding-left: 10px;">
													<!-- <img onClick='fnAddWindow(this,"addWidgetDropDown");' onMouseOut='fnRemoveWindow();' src="<?php echo aicrm_imageurl('btnL3Add.gif', $this->_tpl_vars['THEME']); ?>
" border="0" title="<?php echo $this->_tpl_vars['MOD']['LBL_HOME_ADDWINDOW']; ?>
" alt"<?php echo $this->_tpl_vars['MOD']['LBL_HOME_ADDWINDOW']; ?>
" style="cursor:pointer;"> -->
													<img src="themes/softed/images/create.png" border= "0" style="width: 20px; height: 20px; vertical-align: middle; cursor:pointer;" onClick='fnAddWindow(this,"addWidgetDropDown");' onMouseOut='fnRemoveWindow();' order="0" title="<?php echo $this->_tpl_vars['MOD']['LBL_HOME_ADDWINDOW']; ?>
" alt="<?php echo $this->_tpl_vars['MOD']['LBL_HOME_ADDWINDOW']; ?>
"> 
...
" border=0  onClick='fnvshobj(this,"miniCal");getMiniCal();'/> -->
												...
												<td style="padding-left: 10px;">
													<!-- <img src="<?php echo aicrm_imageurl('btnL3Clock.gif', $this->_tpl_vars['THEME']); ?>
...
" border=0 onClick="fnvshobj(this,'wclock');"> -->
													<!-- <img src="themes/softed/images/icon_clock_black.png" alt="<?php echo $this->_tpl_vars['APP']['LBL_CLOCK_ALT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CLOCK_TITLE']; ?>
" border=0 onClick="fnvshobj(this,'wclock');" style="width: 25px; height: 25px; vertical-align: middle;">
													<a style=" font-family: PromptMedium; font-size: 12px; color: #2B2B2B; font-weight: 400;" href="javascript:void(0)" onClick="fnvshobj(this,'wclock');">
														<?php echo $this->_tpl_vars['APP']['LBL_CLOCK_TITLE']; ?>
												...
												<td style="padding-left: 10px;">
													<!-- <img src="<?php echo aicrm_imageurl('btnL3Calc.gif', $this->_tpl_vars['THEME']); ?>
...
" border=0 onClick="fnvshobj(this,'calculator_cont');fetch_calc();"> -->
													<!-- <img src="themes/softed/images/icon_calculator_black.png" alt="<?php echo $this->_tpl_vars['APP']['LBL_CALCULATOR_ALT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CALCULATOR_TITLE']; ?>
" border=0 onClick="fnvshobj(this,'calculator_cont');fetch_calc();" style="width: 25px; height: 25px; vertical-align: middle;">
													<a href="javascript:void(0)" style=" font-family: PromptMedium; font-size: 12px; color: #2B2B2B; font-weight: 400;" onClick="fnvshobj(this,'calculator_cont');fetch_calc();">
														<?php echo $this->_tpl_vars['APP']['LBL_CALCULATOR_TITLE']; ?>
												...
												<td style="padding-left: 10px;">
													<!-- <img src="<?php echo aicrm_imageurl('tbarChat.gif', $this->_tpl_vars['THEME']); ?>
...
" border=0  onClick='return window.open("index.php?module=Home&action=vtchat","Chat","width=600,height=450,resizable=1,scrollbars=1");'> -->
													<!-- <img src="themes/softed/images/icon_chat_black.png" alt="<?php echo $this->_tpl_vars['APP']['LBL_CHAT_ALT']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_CHAT_TITLE']; ?>
" border=0  onClick='return window.open("index.php?module=Home&action=vtchat","Chat","width=600,height=450,resizable=1,scrollbars=1");' style="width: 25px; height: 25px; vertical-align: middle;">
													<a href="javascript:void(0)" style=" font-family: PromptMedium; font-size: 12px; color: #2B2B2B; font-weight: 400;" onClick='return window.open("index.php?module=Home&action=vtchat","Chat","width=600,height=450,resizable=1,scrollbars=1");'>
														<?php echo $this->_tpl_vars['APP']['LBL_CHAT_TITLE']; ?>

													</a> -->
												</td>	
												<?php endif; ?>
												<td style="padding-left: 10px;">
													<!-- <img  src="<?php echo aicrm_imageurl('btnL3Tracker.gif', $this->_tpl_vars['THEME']); ?>
...
" border="0" onClick="fnvshobj(this,'tracker');"> -->
													<img src="themes/softed/images/icon_lastview_black.png" alt="<?php echo $this->_tpl_vars['APP']['LBL_LAST_VIEWED']; ?>
" title="<?php echo $this->_tpl_vars['APP']['LBL_LAST_VIEWED']; ?>
" border="0" onClick="fnvshobj(this,'tracker');" style="width: 25px; height: 25px; vertical-align: middle;">
													<a href="javascript:void(0)" style=" font-family: PromptMedium; font-size: 12px; color: #2B2B2B; font-weight: 400;" onClick="fnvshobj(this,'tracker');">
														<?php echo $this->_tpl_vars['APP']['LBL_LAST_VIEWED']; ?>

													</a>
												</td>
												<td style="padding-left: 10px;">
													<!-- <img src="<?php echo aicrm_imageurl('btnL3AllMenu.gif', $this->_tpl_vars['THEME']); ?>
...
" title="<?php echo $this->_tpl_vars['APP']['LBL_ALL_MENU_TITLE']; ?>
" border="0" onmouseout="fninvsh('allMenu');" onClick="$('allMenu').style.display='block'; $('allMenu').style.visibility='visible';placeAtCenter($('allMenu'))" style="width: 25px; height: 25px; vertical-align: middle;">
												...
												<td style="padding-left: 10px;">
													<!-- <img  onClick='showOptions("changeLayoutDiv");' src="<?php echo aicrm_imageurl('orgshar.gif', $this->_tpl_vars['THEME']); ?>
" border="0" title="<?php echo $this->_tpl_vars['MOD']['LBL_HOME_LAYOUT']; ?>
" alt="<?php echo $this->_tpl_vars['MOD']['LBL_HOME_LAYOUT']; ?>
" style="cursor:pointer;"> -->
													<!-- <img src="themes/softed/images/icon_changelayout_black.png" onClick='showOptions("changeLayoutDiv");' border="0" title="<?php echo $this->_tpl_vars['MOD']['LBL_HOME_LAYOUT']; ?>
" alt="<?php echo $this->_tpl_vars['MOD']['LBL_HOME_LAYOUT']; ?>
" style="cursor:pointer; width: 25px; height: 25px; vertical-align: middle;">
												...
												<td width="100%" align="center">
													<div id="vtbusy_info" style="display: none;">
														<img src="<?php echo aicrm_imageurl('status.gif', $this->_tpl_vars['THEME']); ?>
" border="0" />
													</div>
												</td>
											</tr>
...
<?php endif; ?>
		...
		<tr>
			...
			<td align="right"><a href="javascript:;" onclick="fnhide('addWidgetsDiv');$('stufftitle_id').value='';"><img src="<?php echo aicrm_imageurl('close.gif', $this->_tpl_vars['THEME']); ?>
...
<div id="changeLayoutDiv" class="layerPopup" style="z-index:2000; display:none;">
	...
	<tr class="layerHeadingULine">
		...
		<td>
			<img onclick="hideOptions('changeLayoutDiv');" src="<?php echo aicrm_imageurl('close.gif', $this->_tpl_vars['THEME']); ?>
