...
<?php elseif ($this->_tpl_vars['MODULE'] == 'Products' || $this->_tpl_vars['MODULE'] == 'PriceBooks'): ?>
...
">
        <input type="hidden" name="isDuplicate" value=false>
        <input type="hidden" name="isRevise" value=false>
        <input type="hidden" name="action">
        <input type="hidden" name="convertmode">
        <input type="hidden" name="return_module">
        <input type="hidden" name="return_action">
...
">
        ...
        <input type="hidden" name="return_action">
        <input type="hidden" name="return_id">
<?php elseif ($this->_tpl_vars['MODULE'] == 'Samplerequisition'): ?>
        <input type="hidden" name="module" value="<?php echo $this->_tpl_vars['MODULE']; ?>
">
        <input type="hidden" name="record" value="<?php echo $this->_tpl_vars['ID']; ?>
">
