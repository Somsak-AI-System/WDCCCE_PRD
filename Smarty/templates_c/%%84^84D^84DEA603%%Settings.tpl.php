<?php /* Smarty version 2.6.18, created on 2026-04-09 11:25:43
         compiled from Settings.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'aicrm_imageurl', 'Settings.tpl', 17, false),array('modifier', 'getTranslatedString', 'Settings.tpl', 43, false),)), $this); ?>
...
">
											<img src="<?php echo aicrm_imageurl($this->_tpl_vars['data']['icon'], $this->_tpl_vars['THEME']); ?>
" alt="<?php echo $this->_tpl_vars['label']; ?>
" width="48" height="48" border=0 title="<?php echo $this->_tpl_vars['label']; ?>
">
										</a>
									</td>
									<td width="90%" valign=top class=big >
										<a href="<?php echo $this->_tpl_vars['data']['link']; ?>
">
