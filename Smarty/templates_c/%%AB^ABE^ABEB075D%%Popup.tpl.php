<?php /* Smarty version 2.6.18, created on 2026-04-08 16:51:29
         compiled from Popup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'aicrm_imageurl', 'Popup.tpl', 100, false),array('modifier', 'vtlib_purify', 'Popup.tpl', 126, false),array('function', 'html_options', 'Popup.tpl', 111, false),)), $this); ?>
<script>
...
<?php if ($this->_tpl_vars['RETURN_MODULE'] != 'Quotes'): ?>
	<script language="JavaScript" type="text/javascript" src="include/js/Inventory_<?php echo $this->_tpl_vars['RETURN_MODULE']; ?>
.js"></script>
<?php endif; ?>
...
&nbsp;<?php echo $this->_tpl_vars['APP'][$this->_tpl_vars['PARENT_MODULE']]; ?>
			...
			<div id="status" style="position:absolute;display:none;right:135px;top:15px;height:27px;white-space:nowrap;"><img src="<?php echo aicrm_imageurl('status.gif', $this->_tpl_vars['THEME']); ?>
"></div>
			<table width="100%" cellpadding="5" cellspacing="0" border="0"  class="homePageMatrixHdr">
				<tr>
					<td style="padding:10px;" >
						<form name="basicSearch" action="index.php" onSubmit="return false;" style="margin-block-end:1px;">
						<table width="100%" cellpadding="5" cellspacing="0">
						<tr>
							<td width="20%" class="dvtCellLabel"><img src="<?php echo aicrm_imageurl('basicSearchLens.gif', $this->_tpl_vars['THEME']); ?>
"></td>
...
">
								<input name="module_return" id="module_return" type="hidden" value="<?php echo $this->_tpl_vars['MODULE_RETURN']; ?>
">
...
">
                                <input type="hidden" id="field"  value="<?php echo $_REQUEST['field']; ?>
">
                                
                                <input type="hidden" id="relmod_id"  value="<?php echo $this->_tpl_vars['relmod_id']; ?>
">
                                
                                <input name="pricetype" id="pricetype" type="hidden" value="<?php echo $this->_tpl_vars['pricetype']; ?>
">

								<?php if ($this->_tpl_vars['MODULE'] == 'Quotes'): ?>
									<input name="price_type" id="price_type" type="hidden" value="<?php echo $this->_tpl_vars['PRICE_TYPE']; ?>
">
								<?php endif; ?>

								<?php if ($this->_tpl_vars['MODULE'] == 'Accounts'): ?>
									<input name="return_field" id="return_field" type="hidden" value="<?php echo $this->_tpl_vars['return_field']; ?>
">
								<?php endif; ?>
...
&nbsp; " onClick="callSearch('Basic');" class="crmbutton small create">
						 ...
						 <tr>
							<td colspan="4" align="center">
								...
								<?php if ($this->_tpl_vars['recid_var_value'] != '' && ( $this->_tpl_vars['MODULE'] != 'Contacts' && $this->_tpl_vars['MODULE'] != 'Accounts' && $this->_tpl_vars['MODULE'] != 'Products' )): ?>
                                <tr>
...
function callSearch(searchtype)
{
	...
	<?php if ($this->_tpl_vars['MODULE'] == 'Quotes'): ?>
		...
		urlstring += '&price_type='+price_type;
	<?php endif; ?>

	<?php if ($this->_tpl_vars['MODULE'] == 'Accounts'): ?>
		return_field = $('return_field').value;
		urlstring += '&return_field='+return_field;
	<?php endif; ?>
...
Ajax&ajax=true&search=true';
	...
	relmod_id = document.basicSearch.relmod_id.value;

	field = document.basicSearch.field.value;
	urlstring += '&field='+field;
	
	if(relmod_id!='')
		urlstring += '&relmod_id='+relmod_id;
...
function gethiddenelements()
{
	...
	var module_return = document.getElementById('module_return').value;
	if(module_return != '')
		urlstring += '&module_return='+module_return;	

	var pricetype = document.getElementById('pricetype').value;
	if(pricetype != '')
		urlstring += '&pricetype='+pricetype;	
