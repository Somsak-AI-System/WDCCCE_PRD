	...
	<table border=0 cellspacing=0 cellpadding=5 width=100% class=layerHeadingULine>
		<tr>
			...
			<td width="10%" align="right">
				<a href="javascript:fninvsh('roleLay');"><img title="{$APP.LBL_CLOSE}" alt="{$APP.LBL_CLOSE}" src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
			</td>
		</tr>
	</table>
							...
							<table border="0" cellpadding="5" cellspacing="0" width="90%">
								...
								<tr>
									...
									{if $PERMIT eq '0'}
										...
										{else}
											<td align="left"><b>{$elements.0}</b><br>({$MOD.LBL_MULTIPLE} {$APP[$FROM_MODULE]})</td>
										{/if}
