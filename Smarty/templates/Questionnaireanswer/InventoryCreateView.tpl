...
<table border=0 cellspacing=0 cellpadding=0 width=99% align=center>
   <tr>
	...
	<td class="showPanelBg" valign=top width=100%>
		 ...
		 <hr style="border: 1px solid #F7F7F7; margin-top: 0.5em !important;margin-bottom: 0.5em !important;">
		 <br>
				...
				<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
				   <tr>
					...
					{else}
	                    ...
	                    <button title="{$APP.LBL_SAVE_BUTTON_TITLE}" accesskey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; template_questionnaire(); return formValidate()" type="submit" name="button" style="width:70px"> 
								...
								<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
								   <!-- <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
										<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; template_questionnaire(); return formValidate(); " type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
                                   ...
                                   {if $header eq "Answer Information" && $MODULE eq "Questionnaireanswer"}

                                  		<!-- <input type="hidden" name="data_template" id="data_template" class="data_template" value="{$DATA_TEMPLATE}" > -->
                                  		<input type="hidden" name="data_template" id="data_template" class="data_template" value="{$DATA_TEMPLATE}" >
                                  		<!-- <input type="hidden" name="qustionnairetemplate" id="qustionnairetemplate" > -->
                                        ...
                                        <tr>
                                            <td  colspan=4 style="padding:5px">{include_php file='modules/Questionnaireanswer/survey/create.html'}</td>
                                        </tr>
								   {else}
