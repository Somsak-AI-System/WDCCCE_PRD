   ...
   <tr valign="top" id="row1">
	...
	<td class="crmTableRow small lineOnTop" align="right">
		<table width="100%" cellpadding="0" cellspacing="0">
		   <tr>
			<td align="right">
				<input id="listPrice1" name="listPrice1" value="{$UNIT_PRICE}" type="text" class="small " style="width:70px" onBlur="calcTotal();setDiscount(this,'1'); callTaxCalc(1);calcTotal();"/>&nbsp;<img src="{'pricebook.gif'|@aicrm_imageurl:$THEME}" onclick="priceBookPickList(this,1)">
			</td>
		   </tr>
		   <tr>
				...
				<div class="discountUI" id="discount_div1">
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">
					   <tr>
						...
						<td align="right"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0" onClick="fnHidePopDiv('discount_div1')" style="cursor:pointer;"></td>
					   </tr>
					   <tr>
