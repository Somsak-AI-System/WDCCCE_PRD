...
{if ($tablestuff.Stufftype neq "Default" || $tablestuff.Stufftitle neq $keymetrics_title) && ($tablestuff.Stufftype neq "Default" || $tablestuff.Stufftitle neq $homepagedashboard_title) && ($tablestuff.Stufftype neq "Tag Cloud") && ($tablestuff.Stufftype neq "Notebook")}
				<a id="editlink" style='cursor:pointer;' onclick="showEditrow({$tablestuff.Stuffid})">
					<img src="{'windowSettings.gif'|@aicrm_imageurl:$THEME}" border="0" alt="Edit" title="Edit" hspace="2" align="absmiddle"/>
				</a>	
{else}
				<img src="{'windowSettings-off.gif'|@aicrm_imageurl:$THEME}" border="0" alt="Edit" title="Edit" hspace="2" align="absmiddle"/>
{/if}
...
{if $tablestuff.Stufftitle eq $homepagedashboard_title}
				<a style='cursor:pointer;' onclick="fetch_homeDB({$tablestuff.Stuffid});">
					<img src="{'windowRefresh.gif'|@aicrm_imageurl:$THEME}" border="0" alt="Refresh" title="Refresh" hspace="2" align="absmiddle"/>
				</a>
{else}
...
{if $tablestuff.Stufftype eq "Default" || $tablestuff.Stufftype eq "Tag Cloud"}
				<a style='cursor:pointer;' onclick="HideDefault({$tablestuff.Stuffid})"><img src="{'windowMinMax.gif'|@aicrm_imageurl:$THEME}" border="0" alt="Hide" title="Hide" hspace="5" align="absmiddle"/></a>
{else}
				<img src="{'windowMinMax-off.gif'|@aicrm_imageurl:$THEME}" border="0" alt="Hide" title="Hide" hspace="5" align="absmiddle"/>
{/if}
...
{if $tablestuff.Stufftype neq "Default" && $tablestuff.Stufftype neq "Tag Cloud"}
				<a id="deletelink" style='cursor:pointer;' onclick="DelStuff({$tablestuff.Stuffid})"><img src="{'windowClose.gif'|@aicrm_imageurl:$THEME}" border="0" alt="Close" title="Close" hspace="5" align="absmiddle"/></a>
{else}
				<img src="{'windowClose-off.gif'|@aicrm_imageurl:$THEME}" border="0" alt="Close" title="Close" hspace="5" align="absmiddle"/>
{/if}
