				...
				<table class="listTable" border="0" cellpadding="3" cellspacing="0" width="100%">
					...
					{foreach item=entries key=id from=$CFENTRIES name=outer}
						{if $entries.blockid ne $RELPRODUCTSECTIONID || $entries.blocklabel neq '' }
							...
							<tr>
							  <td><img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;</td>
							</tr>
							{/if}
							<tr>
								...
								<td class="colHeader small"  id = "blockid"_{$entries.blockid} colspan="2" align='right'> 
									...
									<!-- Edit Block -->
									<img style="cursor:pointer;" onClick=" editCustomBlock(this,'editlabelblock','{$MODULE}','{$entries.blockid}','{$entries.no}','{$entries.blocklabel}')" src="{'editfield.gif'|@aicrm_imageurl:$THEME}" border="0"  alt="Edit" title="Edit"/>&nbsp;&nbsp;
									<!-- Delete Block -->
									<img style="cursor:pointer;" onClick=" deleteCustomBlock('{$MODULE}','{$entries.blockid}','{$entries.no}')" src="{'delete.gif'|@aicrm_imageurl:$THEME}" border="0"  alt="Delete" title="Delete"/>&nbsp;&nbsp;
									{/if}
									{if $entries.blockid neq $COMMENTSECTIONID && $entries.blockid neq $SOLUTIONBLOCKID}
									<img src="{'hidden_fields.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;"  onclick="fnvshobj(this,'hiddenfields_{$entries.blockid}');" alt="{$MOD.HIDDEN_FIELDS}" title="{$MOD.HIDDEN_FIELDS}"/>&nbsp;&nbsp;
									{/if}	
		 										...
		 										<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
													<tr>
														...
														<td width="5%" align="right">
															<a href="javascript:fninvsh('hiddenfields_{$entries.blockid}');"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
														</td>
													</tr>
												</table>
									...
									{if $MODULE eq 'Faq'}
                                   		{if $entries.blockid neq $COMMENTSECTIONID && $entries.blockid neq $SOLUTIONBLOCKID }
                                        <img src="{'plus_layout.gif'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;"  onclick="fnvshobj(this,'addfield_{$entries.blockid}'); " alt="Add CustomField" title="Add CustomField"/>&nbsp;&nbsp;
                                        {/if}
                                    {else}
												...
												<div id="addfield_{$entries.blockid}" style="display:none; position:absolute; width:500px;" class="layerPopup">
	  												...
	  												<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
														<tr>
															...
															<img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
															</td>
														</tr>
													</table>
																				...
																				<tr>
																					<td>
																						<div name="cfcombo" id="cfcombo" class="small"  style="width:205px; height:150px; overflow-y:auto ;overflow-x:hidden ;overflow:auto; border:1px  solid #CCCCCC ;">
																							<table>
																								<tr><td align="left"><a id="field0_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'text.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,0,{$entries.blockid});">  {$MOD.Text} </a></td></tr>
																								<tr><td align="left"><a id="field1_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'number.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,1,{$entries.blockid})" >  {$MOD.Number} </a></td></tr>
																								<tr><td align="left"><a id="field2_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'percent.gif'|@aicrm_imageurl:$THEME});" 	onclick = "makeFieldSelected(this,2,{$entries.blockid});">  {$MOD.Percent} </a></td></tr>
																								<tr><td align="left"><a id="field3_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'cfcurrency.gif'|@aicrm_imageurl:$THEME});" 	onclick = "makeFieldSelected(this,3,{$entries.blockid});">  {$MOD.Currency} </a></td></tr>
																								<tr><td align="left"><a id="field4_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'date.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,4,{$entries.blockid});">  {$MOD.Date} </a></td></tr>
																								<tr><td align="left"><a id="field5_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'email.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,5,{$entries.blockid});">  {$MOD.Email} </a></td></tr>
																								<tr><td align="left"><a id="field6_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'phone.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,6,{$entries.blockid});">  {$MOD.Phone} </a>	</td></tr>
																								<tr><td align="left"><a id="field7_{$entries.blockid}" 	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'cfpicklist.gif'|@aicrm_imageurl:$THEME});" 	onclick = "makeFieldSelected(this,7,{$entries.blockid});">  {$MOD.PickList} </a></td></tr>
																								<tr><td align="left"><a id="field8_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'url.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,8,{$entries.blockid});">  {$MOD.LBL_URL} </a></td></tr>
																								<tr><td align="left"><a id="field9_{$entries.blockid}" 	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'checkbox.gif'|@aicrm_imageurl:$THEME});" 	onclick = "makeFieldSelected(this,9,{$entries.blockid});">  {$MOD.LBL_CHECK_BOX} </a></td></tr>
																								<tr><td align="left"><a id="field10_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'text.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,10,{$entries.blockid});"> {$MOD.LBL_TEXT_AREA} </a></td></tr>
																								<tr><td align="left"><a id="field11_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'cfpicklist.gif'|@aicrm_imageurl:$THEME});" 	onclick = "makeFieldSelected(this,11,{$entries.blockid});"> {$MOD.LBL_MULTISELECT_COMBO} </a></td></tr>
																								<tr><td align="left"><a id="field12_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'skype.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,12,{$entries.blockid});"> {$MOD.Skype} </a></td></tr>
                                                                                                
<!--ekk=====================================================================================-->
																								<tr><td align="left"><a id="field13_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'products.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,13,{$entries.blockid});"> {$MOD.PickList_product} </a></td></tr>
                                                                                                <tr><td align="left"><a id="field14_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'user.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,14,{$entries.blockid});"> {$MOD.PickList_Account} </a></td></tr>
                                                                                                 <tr><td align="left"><a id="field15_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'user.gif'|@aicrm_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,15,{$entries.blockid});"> {$MOD.PickList_User} </a></td></tr>                                                                                              
<!--ekk=====================================================================================-->
									...
									{if $entries.blockid neq $COMMENTSECTIONID && $entries.blockid neq $SOLUTIONBLOCKID}
										<img src="{'moveinto.png'|@aicrm_imageurl:$THEME}" border="0"  style="cursor:pointer; height:16px; width:16px" onClick="fnvshobj(this,'movefields_{$entries.blockid}');"  alt="Move Fields" title="Move Fields"/>&nbsp;&nbsp;
									{/if}
											...
											<div style="position:relative; display:block">
		 										<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
													<tr>
														...
														<td width="5%" align="right">
															<a href="javascript:fninvsh('movefields_{$entries.blockid}');"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
														</td>
													</tr>
												</table>
												<table border="0" cellspacing="0" cellpadding="0" width="95%">
									...
									{if $smarty.foreach.outer.first}
									 	<img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;
										<img src="{'arrow_down.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeBlockorder('block_down','{$entries.tabid}','{$entries.blockid}','{$MODULE}') " alt="{$MOD.DOWN}" title="{$MOD.DOWN}">&nbsp;&nbsp;
									{elseif $smarty.foreach.outer.last}
										<img src="{'arrow_up.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeBlockorder('block_up','{$entries.tabid}','{$entries.blockid}','{$MODULE}') " alt="{$MOD.UP}" title="{$MOD.UP}">&nbsp;&nbsp;
										<img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;
									{else}
									 	<img src="{'arrow_up.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeBlockorder('block_up','{$entries.tabid}','{$entries.blockid}','{$MODULE}') " alt="{$MOD.UP}" title="{$MOD.UP}">&nbsp;&nbsp;
									 	<img src="{'arrow_down.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeBlockorder('block_down','{$entries.tabid}','{$entries.blockid}','{$MODULE}') " alt="{$MOD.DOWN}" title="{$MOD.DOWN}">&nbsp;&nbsp;
							...
							<tr>
								...
								<td width="19%" align = "right" class="colData small" ><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="fnvshNrm('editfield_{$value.fieldselect}'); posLay(this, 'editfield_{$value.fieldselect}');" alt="Popup" title="{$MOD.LBL_EDIT_PROPERTIES}"/>&nbsp;&nbsp;
		 									...
		 									<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">
												<tr class="detailedViewHeader">
													...
													<th width="5%" align="right">
														<a href="javascript:fninvsh('editfield_{$value.fieldselect}');"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
													</th>
												</tr>
											</table>
											<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">												
									...
									{if $smarty.foreach.inner.first}
										...
										<img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;
								 		{if $value.no != ($entries.field|@count - 2) && $entries.no!=1}
											<img src="{'arrow_down.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeFieldorder('down','{$value.fieldselect}','{$value.blockid}','{$MODULE}') " alt="{$MOD.DOWN}" title="{$MOD.DOWN}">&nbsp;&nbsp;
										{else}
											<img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;
										{/if}
										{if $entries.no!=1}
											<img src="{'arrow_right.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeFieldorder('Right','{$value.fieldselect}','{$value.blockid}','{$MODULE}')" alt="{$MOD.RIGHT}" title="{$MOD.RIGHT}"/>&nbsp;&nbsp;
										{else}
											<img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;
										{/if}
									{elseif $smarty.foreach.inner.last}
										{if $value.no % 2 != 0}
											<img src="{'arrow_left.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeFieldorder('Left','{$value.fieldselect}','{$value.blockid}','{$MODULE}')" alt="{$MOD.LEFT}" title="{$MOD.LEFT}"/>&nbsp;&nbsp;
										{/if}
										{if $value.no != 1}
											<img src="{'arrow_up.png'|@aicrm_imageurl:$THEME}" border="0" style="cursor:pointer;" onclick="changeFieldorder('up','{$value.fieldselect}','{$value.blockid}','{$MODULE}') " alt="{$MOD.UP}" title="{$MOD.UP}"/>&nbsp;&nbsp;
									 	{else}
											<img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;
										{/if}
										<img src="{'blank.gif'|@aicrm_imageurl:$THEME}" style="width:16px;height:16px;" border="0" />&nbsp;&nbsp;
					...
					<div id="editlabelblock" style="display:none; position:absolute; width:500px;" class="layerPopup">
						<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
							<tr>
								<td width="95%" align="left" class="layerPopupHeading">{$MOD.LBL_EDIT_BLOCK}
								</td>
								<td width="5%" align="right"><a href="javascript:fninvsh('editlabelblock');"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
								</td>
							</tr>
						</table>
							...
							<tr>
								<td class="small" >
											...
											<td width="50%">
												<table width="100%" border="0" cellpadding="5" cellspacing="0">
													<tr>
														...
														<td align="left" width="70%">
														<input id="edit_blockid" type="hidden" class="txtBox">
														<input id="edit_blocklabel" value="" type="text" class="txtBox">
														</td>
													</tr>
									...
									<table border=0 cellspacing=0 cellpadding=5 width=100% >
										<tr>
											<td align="center">
												<input type="button" name="save"  value= "{$APP.LBL_SAVE_BUTTON_LABEL}"  class="crmButton small save" onclick=" EditCustomBlockForm('{$MODULE}','edit') "/>&nbsp;
												<input type="button" name="cancel" value="{$APP.LBL_CANCEL_BUTTON_LABEL}"  class="crmButton small cancel" onclick= "fninvsh('editlabelblock');" />
											</td>
										</tr>
									</table>
								</td>
					...
					<div id="addblock" style="display:none; position:absolute; width:500px;" class="layerPopup">
						<table width="100%" border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
							<tr>
								...
								<td width="5%" align="right"><a href="javascript:fninvsh('addblock');"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a>
								</td>
							</tr>
						</table>
						<table border="0" cellspacing="0" cellpadding="0" width="95%" align="center"> 
