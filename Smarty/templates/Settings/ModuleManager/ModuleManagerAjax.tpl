...
{if $modinfo.customized eq true}
	...
	<tr>
		<td class="cellText small" width="20px"><img src="{'uparrow.gif'|@aicrm_imageurl:$THEME}" border="0"></td>
		<td class="cellLabel small">{$modulelabel}</td>
		<td class="cellText small" width="15px" align=center>
			<a href="index.php?module=Settings&action=ModuleManager&module_update=Step1&src_module={$modulename}&parenttab=Settings"><img src="{'reload.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$MOD.LBL_UPGRADE} {$modulelabel}" title="{$MOD.LBL_UPGRADE} {$modulelabel}"></a>
		</td>
		<td class="cellText small" width="15px" align=center>
		{if $modinfo.presence eq 0}
			<a href="javascript:void(0);" onclick="vtlib_toggleModule('{$modulename}', 'module_disable');"><img src="{'enabled.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$MOD.LBL_DISABLE} {$modulelabel}" title="{$MOD.LBL_DISABLE} {$modulelabel}"></a>
		{else}
			<a href="javascript:void(0);" onclick="vtlib_toggleModule('{$modulename}', 'module_enable');"><img src="{'disabled.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$MOD.LBL_ENABLE} {$modulelabel}" title="{$MOD.LBL_ENABLE} {$modulelabel}"></a>
		{/if}
		</td>
		<td class="cellText small" width="15px" align=center>
			{if $modulename eq 'Calendar' || $modulename eq 'Home'}
				<img src="{'menuDnArrow.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle">
			{else}
				<a href="index.php?modules=Settings&action=ModuleManagerExport&module_export={$modulename}"><img src="{'webmail_uparrow.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$APP.LBL_EXPORT} {$modulelabel}" title="{$APP.LBL_EXPORT} {$modulelabel}"></a>
			{/if}
		</td>
		<td class="cellText small" width="15px" align=center>
			{if $modinfo.presence eq 0 && $modinfo.hassettings}<a href="index.php?module=Settings&action=ModuleManager&module_settings=true&formodule={$modulename}&parenttab=Settings"><img src="{'Settings.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$modulelabel} {$MOD.LBL_SETTINGS}" title="{$modulelabel} {$MOD.LBL_SETTINGS}"></a>
...
{foreach key=langprefix item=langinfo from=$TOGGLE_LANGINFO}
	...
	{assign var="totalCustomModules" value=$totalCustomModules+1}
	<tr>
		<td class="cellText small"><img src="{'text.gif'|@aicrm_imageurl:$THEME}" border=0"></td>
		<td class="cellLabel small">{$langinfo.label}</td>
		<td class="cellText small" width="15px" align=center>
			<a href="index.php?module=Settings&action=ModuleManager&module_update=Step1&src_module={$langprefix}&parenttab=Settings"><img src="{'reload.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$MOD.LBL_UPGRADE} {$langinfo.label}" title="{$MOD.LBL_UPGRADE} {$langinfo.label}"></a>
		</td>
		<td class="cellText small" width="15px" align=center>
		{if $langinfo.active eq 1}
			<a href="javascript:void(0);" onclick="vtlib_toggleModule('{$langprefix}', 'module_disable', 'language');"><img src="{'enabled.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$MOD.LBL_DISABLE} Language {$langinfo.label}" title="{$MOD.LBL_DISABLE} Language {$langinfo.label}"></a>
		{else}
			<a href="javascript:void(0);" onclick="vtlib_toggleModule('{$langprefix}', 'module_enable', 'language');"><img src="{'disabled.gif'|@aicrm_imageurl:$THEME}" border="0" align="absmiddle" alt="{$MOD.LBL_ENABLE} Language {$langinfo.label}" title="{$MOD.LBL_ENABLE} Language {$langinfo.label}"></a>
		{/if}
		</td>
