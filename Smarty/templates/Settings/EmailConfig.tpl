...
<br>
	...
	<div align=center>
			...
			{include file="SetMenu.tpl"}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'ogmailserver.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_USERS}" width="48" height="48" border=0 title="{$MOD.LBL_USERS}"></td>
				...
				<td>
					...
					<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          ...
                          <tr valign="top">
                            <td nowrap class="small cellLabel"><strong>{$MOD.LBL_PORT}</strong></td>
                            <td class="small cellText">{$PORT}&nbsp;</td>
                          </tr>
                          <tr> 
			...
			<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                <tr>
	              ...
	              <tr> 
	                <td nowrap class="small cellLabel"><strong>{$MOD.LBL_PORT}</strong></td>
	                <td class="small cellText">
	                  	<input type="text" class="detailedViewTextBox small" value="{$PORT}" name="port">
	    			</td>
	              </tr>
	              <tr> 
	                <td nowrap class="small cellLabel"><strong>{$MOD.LBL_REQUIRES_AUTHENT}</strong></td>
