	...
	<div style="position:relative;display: block;" id="orgLay" class="layerPopup">
		<table border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
			<tr>
				...
				<td align="right" width="60%"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" align="middle" border="0" onclick="Myhide('deletediv');"></td>
			</tr>
		</table>
	...
	<div style="position:relative;display: block;" id="orgLay" class="layerPopup">
		<table border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
			<tr>
				...
				<td align="right" width="60%"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" align="middle" border="0" onclick="Myhide('modifydiv');"></td>
			</tr>
		</table>
	...
	<div style="position:relative;display: block;" id="orgLay" class="layerPopup">
		<table border="0" cellpadding="5" cellspacing="0" class="layerHeadingULine">
			<tr>
				...
				<td align="right" width="60%"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" align="middle" border="0" onclick="Myhide('adddiv');"></td>
			</tr>
		</table>
