...
<br>
	<div align=center>
			...
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'announ.gif'|@aicrm_imageurl:$THEME}" width="48" height="48" border=0></td>
					<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > {$MOD.LBL_ANNOUNCEMENT} </b><div id="an_busy" style="display:none;float:left;position:relative;"><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" align="right"></div></td>
				</tr>
				<tr>
