...
<table width="100%" cellpadding="5" cellspacing="0" class="listTable" >
	...
	{/if}
	<td class="listTableRow small"><img onClick="fnvshobj(this,'editdiv');fetchEditNotify('{$smarty.foreach.notifyfor.iteration}');" style="cursor:pointer;" src="{'editfield.gif'|@aicrm_imageurl:$THEME}" title="{$APP.LBL_EDIT}" alt="{$APP.LBL_EDIT}"></td>
	</tr>
	{/foreach}
	</table>
