...
<br>
	...
	<input type="hidden" name="action">
			{include file="SetMenu.tpl"}	
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'company.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_USERS}" width="48"  border=0 title="{$MOD.LBL_USERS}"></td>
					...
					<tr>
						<td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
                          ...
                          <tr valign="top">
                            ...
                            <td class="small cellText" style="background-image: url({$ORGANIZATIONLOGOPATH}/{$ORGANIZATIONLOGONAME}); background-position: left; background-repeat: no-repeat;" width="48" height="170" border="0"></td>
                          </tr>
                          <tr valign="top">
                            <td class="small cellLabel"><strong>{$MOD.LBL_ORGANIZATION_FOOTER}</strong></td>
                            <td class="small cellText" style="background-image: url({$ORGANIZATIONFOOTERPATH}/{$ORGANIZATIONIMGFOOTER}); background-position: left; background-repeat: no-repeat;" width="48" height="170" border="0"></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="small cellText">{$ORGANIZATIONTAX}</td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="small cellText">{$ORGANIZATION_EMAIL}</td>
                          </tr>                          
                        </table>
						...
						<td class="small" valign=top >
                           <table width="100%"  border="0" cellspacing="0" cellpadding="5">
                              <tr>
                                ...
                                <td width="80%" class="small cellText">{$ORGANIZATIONLIMITTIME} Minute</td>
                              </tr>
                              <tr>
                                <td width="20%" class="small cellLabel"><strong>Project Code Mobile</strong></td>
                                <td width="80%" class="small cellText">{$PROJECT_CODE}</td>
                              </tr>
<!-- -->                   <!--<tr>
                                <td width="20%" class="small cellLabel"><strong>Campaigns Batn/Point</strong></td>
                                <td width="80%" class="small cellText">{$ORGANIZATION_CAM_BATH}</td>
                              </tr>
                              <tr>
                                <td width="20%" class="small cellLabel"><strong>Point EXP</strong></td>
                                <td width="80%" class="small cellText">{$ORGANIZATION_EXP_YEAR}</td>
                              </tr>
                              <tr>
                                <td width="20%" class="small cellLabel"><strong>SMS URL</strong></td>
                                <td width="80%" class="small cellText">{$ORGANIZATIONSMSURL}</td>
                              </tr>
                              <tr>
                                <td width="20%" class="small cellLabel"><strong>SMS Sender Name</strong></td>
                                <td width="80%" class="small cellText">{$ORGANIZATIONSMSSENDERNAME}</td>
                              </tr>
                               <tr>
                                <td width="20%" class="small cellLabel"><strong>SMS Username</strong></td>
                                <td width="80%" class="small cellText">{$ORGANIZATIONSMSUSERNAME}</td>
                              </tr>
                              <tr>
                                <td width="20%" class="small cellLabel"><strong>SMS Password</strong></td>
                                <td width="80%" class="small cellText">********</td>
                              </tr>  
                              <tr>
                                <td width="20%" class="small cellLabel"><strong>Questionnaire Back Up</strong></td>
                                <td width="80%" class="small cellText">ระบบ Questionnaire On Mobile จะทำการ Back Up ทุกๆวันที่ {$ORGANIZATIONQUESTIONNAIREBACKUP} ของทุกเดือน</td>
                              </tr>-->
                              <!--<tr>
                                <td width="20%" class="small cellLabel"><strong>ต้นทุนซื้อ</strong></td>
                                <td width="80%" class="small cellText">{$ORGANIZATION_PURCHASE_COST} %</td>
                              </tr>
                              <tr>
                                <td width="20%" class="small cellLabel"><strong>ค่าที่ปรึกษา</strong></td>
                                <td width="80%" class="small cellText">{$ORGANIZATION_CONSULTANT_COST} %</td>
                              </tr>-->                                                            
                            </table>
                         </td>
                    </tr>
