...
<input type="hidden" name="parenttab" value="Settings">
	<div align=center>
			...
			{include file="SetMenu.tpl"}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'terms.gif'|@aicrm_imageurl:$THEME}" width="48" height="48" border=0></td>
					...
					<tr>
						...
						{if $INV_TERMS_MODE eq 'view'}
							<table border=0 cellspacing=0 cellpadding=5 width=100% >
								<tr>
									<td class="listRow small" valign=top style="padding:20px" width="10%"><b>Conditions TH</b></td> 
									<td class="listRow small" valign=top style="padding:20px" width="90%">{$INV_TERMSANDCONDITIONS} </td> 
							    </tr>
							    <tr>
							    	<td class="listRow small" valign=top style="padding:20px" width="10%"><b>Conditions EN</b></td> 
									<td class="listRow small" valign=top style="padding:20px" width="90%">{$INV_TERMSANDCONDITIONS2} </td> 
							    </tr>
							</table>
						...
						{else}
							...
							<tr>
								<td class="listTableRow small" valign=top>
								<textarea class=small name="inventory_tandc2" style="width:95%; height:200px;text-align:left;">{$INV_TERMSANDCONDITIONS2}</textarea>
								</td>
							</tr>
							</table>	
						{/if}
