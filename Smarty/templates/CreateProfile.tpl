...
<tbody><tr>
	...
	<div align=center>
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'ico-profile.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_PROFILES}" width="48" height="48" border=0 title="{$MOD.LBL_PROFILES}"></td>
				...
				<tr>
					...
					<tr>
						...
						<input type="button" value=" {$APP.LBL_CANCEL_BUTTON_LABEL} " title="{$APP.LBL_CANCEL_BUTTON_TITLE}" name="Cancel" onClick="gotourl('index.php?module=Settings&action=ListProfiles&parenttab=Settings')" class="crmButton small cancel"/>
						</td>
					</tr>
					</table>
