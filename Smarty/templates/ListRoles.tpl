...
<br>
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'ico-roles.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_ROLES}" width="48" height="48" border=0 title="{$MOD.LBL_ROLES}"></td>
...
{ldelim}
	...
	{ldelim}
		var x=document.getElementById(harray[i]).style;
        	...
        	{ldelim}
           		x.display="block";
			document.getElementById(imgId).src="{'minus.gif'|@aicrm_imageurl:$THEME}";
         	{rdelim}
        	else
		{ldelim}
			x.display="none";
			document.getElementById(imgId).src="{'plus.gif'|@aicrm_imageurl:$THEME}";
		{rdelim}
	{rdelim}
{rdelim}
