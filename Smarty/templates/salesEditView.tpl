					...
					<table border=0 cellspacing=0 cellpadding=4 width=100% class="small">
					   <tr>
						...
						<td class="dvtTabCache" align="right" style="width:30%">
							...
							{elseif $MODULE eq 'Leads' || $MODULE eq 'Leads'}
                            	<button title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; return formValidate() " type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
                            ...
                            {else}
								...
								<button title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; displaydeleted(); return formValidate() " type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
									<img src="themes/softed/images/save_button_w.png" border="0" style="width: 15px; height: 17px; vertical-align: middle;">
									&nbsp;{$APP.LBL_SAVE_BUTTON_LABEL}
								</button>
							{/if}
					   ...
					   <tr>
						...
						<td align=left>
										...
										<td  colspan=4 style="padding:5px">
											<div align="center">
												...
												{if $MODULE eq 'Webmails'}
													<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save';this.form.module.value='Webmails';this.form.send_mail.value='true';this.form.record.value='{$ID}'" type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
                                                {elseif $MODULE eq 'Accounts'}
                                                <input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; displaydeleted();  if(formValidate()) {ldelim} AjaxDuplicateValidate('Accounts','accountname',this.form); AddressSync(this.form,{$ID}); {rdelim}"  type="button" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
                                                {else}
							...
							{foreach key=header item=data from=$BLOCKS}
								...
								{if $header== $MOD.LBL_ADDRESS_INFORMATION && ( $MODULE == 'Quotes')}
									<tr>
										<td colspan=2 class="detailedViewHeader"><b>{$header}</b></td>
										<td class="detailedViewHeader">
											<input name="cpy" onclick="return copyAddressLeft(EditView,'{$MODULE}')" type="radio"><b>{$APP.LBL_RCPY_ADDRESS}</b>
										</td>
										<td class="detailedViewHeader">
											<input name="cpy" onclick="return copyAddressRight(EditView,'{$MODULE}')" type="radio"><b>{$APP.LBL_LCPY_ADDRESS}</b>
										</td>
									</tr>
								{elseif $header== $MOD.LBL_ADDRESS_INFORMATION && $MODULE == 'Contacts'}
	                                <tr>
										<td colspan=4 class="detailedViewHeader"><b>{$header}</b></td>	
									</tr>	
							    {elseif $MODULE eq 'HelpDesk'}
							    	...
							    	{/if}
							    {elseif $MODULE eq 'Job' && $header== 'Image Infomation'}
								   ...
								   <tr>
									<td  colspan=4 style="padding:5px">
										...
										{elseif $MODULE eq 'Accounts'}
	                                        ...
	                                        <button title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; if(formValidate()) {ldelim} AjaxDuplicateValidate('Accounts','accountname',this.form); AddressSync(this.form,{$ID}); {rdelim}" type="button" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}" style="width:70px">
												<img src="themes/softed/images/save_button_w.png" border="0" style="width: 15px; height: 17px; vertical-align: middle;">
												&nbsp;{$APP.LBL_SAVE_BUTTON_LABEL}
											</button>
										{elseif $MODULE eq 'Leads' || $MODULE eq 'Leads'}
