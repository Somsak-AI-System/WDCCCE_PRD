						...
						<form name="DetailView" method="POST" action="index.php" ENCTYPE="multipart/form-data" id="form" style="margin:0px" onsubmit="VtigerJS_DialogBox.block();">
							...
							<tr>
								<td colspan=2>
									...
									<tr>
										<td width=50 rowspan="2"><img src="{'ico-users.gif'|@aicrm_imageurl:$THEME}" align="absmiddle"></td>	
										<td>
											{if $CATEGORY eq 'Settings'}
											<span class="heading2">
											...
											{/if}
											<span id="vtbusy_info" style="display:none;" valign="bottom"><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span>					
										</td>
								...
								<td align="left" valign="top">
									...
									<tr>
										...
										<strong>{$list_numbering+1}. {$UMOD.LBL_HOME_PAGE_COMP}</strong>
										 ...
										 <td class="small" align="right"><img src="{'showDown.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EXPAND_COLLAPSE}" title="{$APP.LBL_EXPAND_COLLAPSE}" onClick="ShowHidefn('home_comp');"></td>	
									</tr>
									</table>
									
									<div style="float: none; display: ;" id="home_comp">	
									<table border="0" cellpadding="5" cellspacing="0" width="100%">
									{foreach item=homeitems key=values from=$HOMEORDER}
										<tr><td class="dvtCellLabel" align="right" width="30%">{$UMOD.$values|@getTranslatedString:'Home'}</td>
											{if $homeitems neq ''}
												...
												<img src="{'prvPrfSelectedTick.gif'|@aicrm_imageurl:$THEME}" alt="{$UMOD.LBL_SHOWN}" title="{$UMOD.LBL_SHOWN}" height="12" width="12"></td><td class="dvtCellInfo" align="left">{$UMOD.LBL_SHOWN}</td> 		
												{else}	
												<td class="dvtCellInfo" align="center" width="5%">
												<img src="{'no.gif'|@aicrm_imageurl:$THEME}" alt="{$UMOD.LBL_HIDDEN}" title="{$UMOD.LBL_HIDDEN}" height="12" width="12"></td><td class="dvtCellInfo" align="left">{$UMOD.LBL_HIDDEN}</td> 		
											{/if}	
										</tr>			
									{/foreach}
									</table>	
									...
									<tr>
										...
										<td class="small" align="right"><img src="{'showDown.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EXPAND_COLLAPSE}" title="{$APP.LBL_EXPAND_COLLAPSE}" onClick="ShowHidefn('tagcloud_disp');"></td>
									</tr>
									</table>
									...
									<tr>
										...
										{if $GROUP_COUNT > 0}
										<img src="{'showDown.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EXPAND_COLLAPSE}" title="{$APP.LBL_EXPAND_COLLAPSE}" onClick="fetchGroups_js({$ID});">
										{else}
											&nbsp;
										{/if}
										</td>	
									...
									<table class="tableHeading" border="0" cellpadding="5" cellspacing="0" width="100%">
										...
										<strong>{$list_numbering+4}. {$UMOD.LBL_LOGIN_HISTORY}</strong>
										 ...
										 <td class="small" align="right"><img src="{'showDown.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EXPAND_COLLAPSE}" title="{$APP.LBL_EXPAND_COLLAPSE}" onClick="fetchlogin_js({$ID});"></td>	
										</tr>
									</table>
