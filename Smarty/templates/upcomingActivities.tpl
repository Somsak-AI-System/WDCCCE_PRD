...
<div id='todayUpcoming'>
	...
	<tr>
		<td><img src="{'upcoming_left.gif'|@aicrm_imageurl:$THEME}" align="top"  /></td>
		<td width="100%" background="{'upcomingEvents.gif'|@aicrm_imageurl:$THEME}" style="background-repeat:repeat-x; "></td>
		<td><img src="{'upcoming_right.gif'|@aicrm_imageurl:$THEME}" align="top"  /></td>
	</tr>
	<tr>
