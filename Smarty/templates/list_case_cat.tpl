	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > {$CMOD.LBL_Case_Cat}</b></td>
				</tr>
				<tr>
					<td valign=top class="small">{$MOD.LBL_Case_Cat_DESC}</td>
				</tr>
				</table>
				<br>
				...
				<td>
					...
					<tr>
						<td class="big"><strong>{$MOD.LBL_Case_Cat}</strong></td>
						<td class="small" align=right>{$CMOD.LBL_TOTAL} {$GRPCNT} {$CMOD.LBL_Case_Cat} </td>
					</tr>
					</table>
					...
					<tr>
						...
						<td class="colHeader small" valign=top width=10% align="center">{$LIST_HEADER.0}</td>
						<td class="colHeader small" valign=top width=20% align="left">{$LIST_HEADER.1}</td>
						<td class="colHeader small" valign=top width=15% align="center">{$LIST_HEADER.2}</td>
                        <td class="colHeader small" valign=top width=30% align="center">{$LIST_HEADER.3}</td>
					  </tr>
					  ...
					  <tr>
						...
						<td class="listTableRow small" valign=top nowrap align="center">
							  	<a href="#" onClick="javascript:window.open('modules/Settings/edit_case_cat.php?action=edit&cf_2249id={$otvalues.cf_2249id}' , '','menuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=0,width=400,height=230,top=220,left=400 ' )";><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LNK_EDIT}" title="{$APP.LNK_EDIT}" border="0" align="absmiddle"></a>
						...
						<td class="listTableRow small" valign=top align="left"><font color="#FF0000"><strong>{$otvalues.cf_2249}</strong></font></td>
                        <td class="listTableRow small" valign=top align="center">{$otvalues.branch_id}</td>
                        <td class="listTableRow small" valign=top align="left">{$otvalues.branch_name}</td>
					  </tr>
					{/foreach}
					</table>
