	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > {$CMOD.LBL_ALERT_Menu2}</b></td>
				</tr>
				<tr>
					<td valign=top class="small">{$MOD.LBL_ALERT_Menu2}</td>
				</tr>
				</table>
				<br>
				...
				<td>
					...
					<tr>
						<td class="big"><strong>{$MOD.LBL_ALERT_Menu2}</strong></td>
					 ...
					 <tr>
					  ...
					  <tr>
						...
						<td class="listTableRow small" valign=top nowrap align="center">
							  	<a href="#" onClick="javascript:window.open('modules/Settings/edit_alert.php?action_type=list_alert_sms&action=edit&id={$otvalues.id}' , '','menuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=0,width=500,height=250,top=220,left=400 ' )";><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EDIT}" title="{$APP.LBL_EDIT}" border="0" align="absmiddle"></a>
