...
<form id="UnifiedSearch_moduleform" name="UnifiedSearch_moduleform">
	...
	<tr>
		<td>
			...
			<tr>
				<td height="30px" background="{'qcBg.gif'|@aicrm_imageurl:$THEME}" class="mailSubHeader"><b>{$APP.LBL_SELECT_MODULES_FOR_SEARCH}</b></td>
				<td align=right background="{'qcBg.gif'|@aicrm_imageurl:$THEME}" class="mailSubHeader">
					...
					<a href='javascript:void(0)' onclick="UnifiedSearch_SelectModuleCancel();"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border=0></a>
				</td>
			</tr>
			</table>
