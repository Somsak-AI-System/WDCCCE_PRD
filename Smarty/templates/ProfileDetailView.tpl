...
<tbody><tr>
	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tbody><tr>
					<td rowspan="2" valign="top" width="50"><img src="{'ico-profile.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_PROFILES}" title="{$MOD.LBL_PROFILES}" border="0" height="48" width="48"></td>
                      ...
                      <tbody><tr>
                        <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody><tr class="small">
                              <td><img src="{'prvPrfTopLeft.gif'|@aicrm_imageurl:$THEME}"></td>
                              <td class="prvPrfTopBg" width="100%"></td>
                              <td><img src="{'prvPrfTopRight.gif'|@aicrm_imageurl:$THEME}"></td>
                            </tr>
                          </tbody></table>
                                            ...
                                            <tbody><tr>
                                              <td><!-- Module name heading -->
                                                  <table class="small" border="0" cellpadding="2" cellspacing="0">
                                                    <tbody><tr>
                                                      <td valign="top"><img src="{'prvPrfHdrArrow.gif'|@aicrm_imageurl:$THEME}"> </td>
						...
						<td align="right" width="40%"><a href="javascript:fnhide('renameProfile');"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" align="middle" border="0"></a></td>
						</tr>
						</table>
...
<br>
			...
			<table class="small" align="center" border="0" cellpadding="5" cellspacing="0" width="90%">
			  <tbody><tr>
				...
				<img src="{'showDown.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EXPAND_COLLAPSE}" title="{$APP.LBL_EXPAND_COLLAPSE}" onclick="fnToggleVIew('{$modulename}_view')" border="0" height="16" width="40">
				{/if}
				</div></td>
				  </tr>
      ...
      <table class="small" border="0" cellpadding="0" cellspacing="0" width="100%">
           <tbody><tr>
                <td><img src="{'prvPrfBottomLeft.gif'|@aicrm_imageurl:$THEME}"></td>
                <td class="prvPrfBottomBg" width="100%"></td>
                <td><img src="{'prvPrfBottomRight.gif'|@aicrm_imageurl:$THEME}"></td>
                </tr>
            </tbody>
      </table></td>
      </tr>
