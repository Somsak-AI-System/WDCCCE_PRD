...
<!--										{foreach key=tyeparrkey item=typearr from=$ACTIVITYDATA.activitytype}
							...
							<tr>
			                     <td class="cellLabel" align="right" valign="top"><b><font color="red">{$TYPEOFDATA.site_location}</font>{$MOD.LBL_APP_LOCATION}</b></td>
								<td class="cellInfo" align="left"><input name="site_location" type="text" class="textbox" value="{$ACTIVITYDATA.site_location}" style="width:50%">
							</tr>
							{/if}
