...
<tr><td>
	...
	<!-- Buttons -->
			...
			<td width=100% align="right">
				...
				<select id="select_module" onChange="changeModule(this);" class="small" style="border-radius:3px;">
	...
	<tr>
		<td style="background-color:#efefef;height:340px" align="center" colspan="{$smarty.foreach.listviewforeach.iteration+2}">
			...
			<tr>
				<td align="center">
					<div style="border:3px solid rgb(204, 204, 204); background-color: rgb(255, 255, 255);width:90%;border-radius:6px;">	
					<table cellspacing=0 cellpadding=5 width=98%  border=0 align=center>
						<tr>
							<td rowspan="2" width="30%" align='right'><img src="{'empty.jpg'|@aicrm_imageurl:$THEME}" height="60"></td>	
