...
<tr><td valign=top><img src="{'showPanelTopLeft.gif'|@aicrm_imageurl:$THEME}"></td>
...
<div style="display: none;" class="veil_new small" id="rb_empty_conf_id">
	<table cellspacing="0" cellpadding="18" border="0" class="options small" style="margin-left: 33% !important;">
	<tbody>
		<tr>
