        ...
        <td class="showPanelBg" style="padding: 10px;" valign="top" width="100%">
			...
			<div align=center>
				...
				<table border=0 cellspacing=0 cellpadding=5 width=100% class="settingsSelUITopLine">
					<tr>
						<td width=50 rowspan=3 valign=top><img src="{'Call.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_SOFTPHONE_SERVER_SETTINGS}" width="48" height="38" border=0 title="{$MOD.LBL_SOFTPHONE_SERVER_SETTINGS}"></td>
