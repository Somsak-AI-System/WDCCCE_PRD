...
<div id="view">
	...
	<table class="tableHeading" width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
		<tr>
			...
			<td class="small" align="right">
				<span id="new_field_expression_busyicon"><b>{$MOD.LBL_CHECKING}</b><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span>
	...
	<div align='right' style='padding-right: 5px;' id="expressionlist_busyicon"><b>{$MOD.LBL_CHECKING}</b><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></div>
</div>
