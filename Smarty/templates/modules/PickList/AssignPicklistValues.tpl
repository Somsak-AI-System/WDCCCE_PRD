	...
	<tbody>
		<tr>	
			...
			<td align="center" width="25px;">
				<img border="0" title="right" alt="Move Right" onclick="moveRight();" style="cursor: pointer" src="{'arrow_right.png'|@aicrm_imageurl:$THEME}"/>
				<img border="0" title="left" alt="Remove" onclick="removeValue();" style="cursor: pointer" src="{'arrow_left.png'|@aicrm_imageurl:$THEME}"/>
			</td>
			<td width="auto;">
			...
			<td align="center">
				<img border="0" title="up" alt="Move Up" onclick="moveUp();" style="cursor: pointer" src="{'arrow_up.png'|@aicrm_imageurl:$THEME}"/>
				<img border="0" title="down" alt="Move Down" onclick="moveDown();" style="cursor: pointer" src="{'arrow_down.png'|@aicrm_imageurl:$THEME}"/>
			</td>
		</tr>
		<tr>
			<td>
