	...
	<table border=0 cellspacing=0 cellpadding=5 width=100% class="listTable">
		...
		<tr>
			...
			<td class="listTableRow small" valign=top nowrap>
	  			<a href="javascript:void(0);" onclick="editDependencyPicklist('{$FIELD_MODULE}','{$dependencyvalues.sourcefield}','{$dependencyvalues.targetfield}');"><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EDIT}" title="{$APP.LBL_EDIT}" border="0" align="absmiddle"></a>&nbsp;|
				<a href="javascript:void(0);" onClick="if(confirm('Are you sure delete?')) deleteDependencyPicklist('{$FIELD_MODULE}','{$dependencyvalues.sourcefield}','{$dependencyvalues.targetfield}');"><img src="{'delete.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_DELETE}" title="{$APP.LBL_DELETE}" border="0" align="absmiddle"></a>
			</td>
  		</tr>
		{/foreach}
	</table>
