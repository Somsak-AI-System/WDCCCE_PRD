	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > Weekly Plan </b></td>
				</tr>
				<tr>
					<td valign=top class="small">Config Alert Report Sales Visit (Weekly Plan)</td>
				</tr>
				</table>
				<br>
				...
				<td>
					...
					<tr>
						<td class="big"><strong>Weekly Plan</strong></td>
					...
					<tr>
						...
						<td class="colHeader small" valign=top width=10% align="left">{$LIST_HEADER.2}</td>
					  ...
					  <tr>
						...
						<td class="listTableRow small" valign=top nowrap align="center">
							  	<a href="#" onClick="javascript:window.open('modules/Settings/weekly_config.php?action=edit&id={$otvalues.id}' , '','menuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=0,width=400,height=400,top=220,left=400 ' )";><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EDIT}" title="{$APP.LBL_EDIT}" border="0" align="absmiddle"></a>
						...
						<td class="listTableRow small" valign=top align="left">{$otvalues.section}</td>
                        <td class="listTableRow small" valign=top align="left">{$otvalues.date_send}</td>
                        <td class="listTableRow small" valign=top align="left">{$otvalues.time_send}</td>
                        <td class="listTableRow small" valign=top align="left">{$otvalues.send_to}</td>                    
					  </tr>
					{/foreach}
					</table>
