...
<script type="text/javascript" src="include/js/Inventory_pro.js"></script>
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0" class="crmTable" id="proTab">
   ...
   <tr id="row{$row_no}" valign="top">
	...
	{if $MODULE eq 'Quotes' || $MODULE eq 'SalesOrder' || $MODULE eq 'Invoice' || $MODULE == 'Projects'}
	...
	<td class="crmTableRow small lineOnTop" align="right" valign="top">
		<table width="100%" cellpadding="0" cellspacing="0">
		   <tr>
			<td align="right">
				<input id="{$listPrice}" name="{$listPrice}" value="{$data.$listPrice}" type="text" class="small " style="width:70px" onBlur="calcTotal(); setDiscount(this,'{$row_no}');callTaxCalc('{$row_no}');"/>&nbsp;<img src="{'pricebook.gif'|@aicrm_imageurl:$THEME}" onclick="priceBookPickList(this,'{$row_no}')">
			</td>
		   </tr>
		   <tr>
				...
				<div class="discountUI" id="discount_div{$row_no}">
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small">
					   <tr>
						...
						<td align="right"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0" onClick="fnHidePopDiv('discount_div{$row_no}')" style="cursor:pointer;"></td>
					   </tr>
					   <tr>
				...
				<div class="discountUI" id="tax_div{$row_no}">
					...
					<table width="100%" border="0" cellpadding="5" cellspacing="0" class="small" id="tax_table{$row_no}">
					   <tr>
						...
						<td>&nbsp;</td>
						<td align="right"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0" onClick="fnHidePopDiv('tax_div{$row_no}')" style="cursor:pointer;"></td>
					   </tr>
