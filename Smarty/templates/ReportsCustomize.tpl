...
<!-- Customized Reports Table Starts Here  -->
	...
	{assign var=poscount value=$poscount+1}
		...
		<table  border="0" cellpadding="3" cellspacing="1" width="100%">
			...
			{if $reportdetails.customizable eq '1' && $reportdetails.editable eq 'true'}
				<a href="javascript:;" onClick="editReport('{$reportdetails.reportid}');"><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" title="Customize..." border="0"></a>
			{/if}
			{if $reportdetails.state neq 'SAVED' && $reportdetails.editable eq 'true'}
			&nbsp;| &nbsp;<a href="javascript:;" onClick="DeleteReport('{$reportdetails.reportid}');"><img src="{'delete.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" title="Delete..." border="0"></a>
			{/if}
			</td>
			</tr>
			{/foreach}
