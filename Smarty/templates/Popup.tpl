...
{if $RETURN_MODULE != 'Quotes'}
	<script language="JavaScript" type="text/javascript" src="include/js/Inventory_{$RETURN_MODULE}.js"></script>
{/if}
...
<script language="JavaScript" type="text/javascript" src="modules/{$MODULE}/{$MODULE}.js?v={$smarty.now}"></script>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="mailClient mailClientBg">
	<tr>
		<td>
			...
			<div id="status" style="position:absolute;display:none;right:135px;top:15px;height:27px;white-space:nowrap;"><img src="{'status.gif'|@aicrm_imageurl:$THEME}"></div>
			<table width="100%" cellpadding="5" cellspacing="0" border="0"  class="homePageMatrixHdr">
				<tr>
					<td style="padding:10px;" >
						...
						<tr>
							<td width="20%" class="dvtCellLabel"><img src="{'basicSearchLens.gif'|@aicrm_imageurl:$THEME}"></td>
							...
							<td width="30%" class="dvtCellLabel"><b>{$APP.LBL_IN}</b>&nbsp;
								...
								<input name="module_return" id="module_return" type="hidden" value="{$MODULE_RETURN}">
                                ...
                                <input type="hidden" id="field"  value="{$smarty.request.field}">
                                
                                <input type="hidden" id="relmod_id"  value="{$relmod_id}">
                                
                                <input name="pricetype" id="pricetype" type="hidden" value="{$pricetype}">

								{if $MODULE eq 'Quotes'}
									<input name="price_type" id="price_type" type="hidden" value="{$PRICE_TYPE}">
								{/if}

								{if $MODULE eq 'Accounts'}
									<input name="return_field" id="return_field" type="hidden" value="{$return_field}">
								{/if}
						 ...
						 <tr>
							<td colspan="4" align="center">
								...
								{if $recid_var_value neq '' && ($MODULE neq 'Contacts' && $MODULE neq 'Accounts' && $MODULE neq 'Products')}
                                <tr>
