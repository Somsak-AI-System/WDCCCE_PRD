				...
				<tr>
					...
					<td class="mailClientBg" style="padding-left:10px;padding-top:10px;vertical-align:top;">
						<table width="100%"  border="0" cellpadding="5" cellspacing="0" class="small">
					   		<tr>
								<td width="10%"><img src="{'migrate.gif'|@aicrm_imageurl:$THEME}" align="absmiddle"/></td>
								<td width="90%">
...
<!--							<tr>
										...
										<ul>
											...
											<li> <a name='create_db'></a> <b>How to create a database?</b><br />
												...
												3. Execute the following command to create a new database<br />&nbsp;&nbsp;
														...
														More Information about database UTF-8 support is <a href="http://www.vtiger.com/products/crm/help/5.1.0/aicrm_CRM_Database_UTF8Config.pdf" target="_new"><b>here</b></a>.<br />
							...
							<tr>
								<td colspan="2" align="center">
									<table width="40%" cellpadding="0" cellspacing="5" style="border: 1px solid #777;">
										...
										<tr><th>{$CONFIG_CHARSET}
											{if $CONFIG_STATUS eq '1'} <img src="{'yes.gif'|@aicrm_imageurl:$THEME}" /> 
											{else} <img src="{'no.gif'|@aicrm_imageurl:$THEME}" /> 
											{/if}
											</th>
											<th>{$DB_CHARSET}
												{if $DB_STATUS eq '1'} <img src="{'yes.gif'|@aicrm_imageurl:$THEME}" /> 
												{else} <img src="{'no.gif'|@aicrm_imageurl:$THEME}" /> 
												{/if}
											</th>
										</tr>
							...
							<tr>
	           					<td colspan="2" align="center">
						            <img src="{'no.gif'|@aicrm_imageurl:$THEME}" /> Not recommended setting for UTF-8 Support. &nbsp;
						            <img src="{'yes.gif'|@aicrm_imageurl:$THEME}" /> Meets recommended setting for UTF-8 Support.
					           </td>
					        </tr>
