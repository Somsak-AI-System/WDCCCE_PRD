                    ...
                    <td class="dvtTabCache" align="right" style="width:100%">
                            ...
                            {if $EDIT_DUPLICATE eq 'permitted' || $is_permmited eq true}
                                ...
                                {if $flagassign eq true && ($convertflag eq '0' && $quotation_status eq 'ปิดการขาย')}
                                    ...
                                    <!-- index.php?module=Salesorder&action=EditView&return_action=DetailView&parenttab=Sales -->
                                {/if}
           ...
           {if $MODULE eq 'Purchasesorder'}
                ...
                <tr>
                    <td align="left" style="padding:10px 10px 20px;">
                        <a class="webMnu" href="{$Report_URL}rpt_purchasesorder.rptdesign&purchasesorderid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                        <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Purchase Order Report
                        </a>
                    </td>
                </tr>
            {/if}
