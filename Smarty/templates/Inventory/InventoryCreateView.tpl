						   ...
						   <tr>
							...
							<!-- General details -->
								<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
								   ...
								   {if $MODULE eq 'PurchaseOrder' || $MODULE eq 'SalesOrder' || $MODULE eq 'Invoice'}
								   ...
								   {/if}
								    ...
								    {if $MODULE eq 'Quotes'}
										...
										<!-- This if is added when we want to populate product details from the related entity  for ex. populate product details in new SO page when select Quote -->
										{if $AVAILABLE_PRODUCTS eq true}
											{include file="Inventory/QuotesProductDetailsEditView.tpl"}
										{else}
											{include file="Inventory/QuotesProductDetails.tpl"}
										{/if}
								   ...
								   {if $MODULE eq 'Quotes'}
									   <tr>
										<td colspan=4>
											{include_php file="./modules/Quotes/DeliveryDate/list.php"}
										</td>
									   </tr>
									{/if}
