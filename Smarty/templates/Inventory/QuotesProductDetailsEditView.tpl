   ...
   <tr id="row{$row_no}" valign="top">
    ...
    {/if}
			...
			<td class="crmTableRow small lineOnTop" style="white-space: nowrap;" align="center">
				<input data-rowno="{$row_no}" id="{$regular_price}" name="{$regular_price}" type="text" class="detailedViewTextBox small regular_price" 
					onfocus="this.className='regular_price detailedViewTextBoxOn'" onBlur="this.className='regular_price detailedViewTextBox';setDiscount(this,'{$row_no}'); callTaxCalc({$row_no});calcTotal();" value="{$data.$regular_price}" style="display: inline-block; vertical-align: middle; width:80px;"/>
			...
			<td class="crmTableRow small lineOnTop" align="center">
				<input data-rowno="{$row_no}" id="{$selling_price}" name="{$selling_price}" type="text" class="small selling_price " style="width:70px"  onfocus="this.className='selling_price detailedViewTextBoxOn'" onBlur="this.className='selling_price detailedViewTextBox';setDiscount(this,'{$row_no}'); callTaxCalc({$row_no});calcTotal();" value="{$data.$selling_price}"/>
			</td>
   ...
   <tr valign="top"  style="visibility:hidden;display:none;height: 0;">
	...
	<tr valign="top">
		...
		<td width="12%" class="crmTableRow small lineOnTop" align="right">
			<input class="small" type="text" id="discount_coupons" value="{$FINAL.discount_coupon}" onBlur="calcTotal();" name="discount_coupon" size="5" value="0.00" style="width:70px; text-align: right !important;" >
		</td>
   </tr>
