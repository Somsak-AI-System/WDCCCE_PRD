...
<table width="100%"  border="0" align="center" cellpadding="11" cellspacing="0" class="crmTable" id="proTab">
   ...
   <!-- Header for the Product Details -->
    <tr valign="top">
		...
		<td width=7%  class="lvtCol" align="center" colspan="2"><b>รวม</b></td><!-- {$APP.LBL_TOTAL} -->
   ...
   {foreach key=row_no item=data from=$ASSOCIATEDPRODUCTS name=outer1}
    ...
    {assign var="product_finish" value="product_finish"|cat:$row_no}
    {assign var="product_size_mm" value="product_size_mm"|cat:$row_no}
   ...
   <tr id="row{$row_no}" valign="top">
    ...
    <td class="crmTableRow small lineOnTop">
   		<input data-rowno="{$row_no}" id="{$product_finish}" name="{$product_finish}" type="text" class="small detailedViewTextBox product_finish" onfocus="this.className='product_finish detailedViewTextBoxOn ';" onblur="this.className='product_finish detailedViewTextBox ';"  value="{$data.$product_finish}"/>
   	</td>

   	<td class="crmTableRow small lineOnTop">
   		<input data-rowno="{$row_no}" id="{$product_size_mm}" name="{$product_size_mm}" type="text" class="small detailedViewTextBox product_size_mm" onfocus="this.className='product_size_mm detailedViewTextBoxOn ';" onblur="this.className='product_size_mm detailedViewTextBox ';"  value="{$data.$product_size_mm}"/>
   	</td>
   	
   	<td class="crmTableRow small lineOnTop">
   		<input data-rowno="{$row_no}" id="{$product_thinkness}" name="{$product_thinkness}" type="text" class="small detailedViewTextBox product_thinkness" onfocus="this.className='product_thinkness detailedViewTextBoxOn ';" onblur="this.className='product_thinkness detailedViewTextBox ';"  value="{$data.$product_thinkness}"/>
   	</td>
	
	<td class="crmTableRow small lineOnTop" valign="top">
		<input data-rowno="{$row_no}" id="{$qty}" name="{$qty}" type="text" class="detailedViewTextBox small qty "onfocus="this.className='detailedViewTextBoxOn qty'" onblur="this.className='detailedViewTextBox qty';settotalnoofrows();calcTotal(); set_tax_manual();loadTaxes_Ajax(1); setDiscount(this,'1');{if $MODULE eq 'Invoice'}stock_alert(1);{/if}" value="{$data.$qty}"/>
	</td>

	<td class="crmTableRow small lineOnTop" valign="top">
		<input id="{$uom}" name="{$uom}" type="text" class="detailedViewTextBox small uom" onblur="this.className='detailedViewTextBox uom';"  onfocus="this.className='detailedViewTextBoxOn uom'" value="{$data.$uom}"/>
	</td>

	<td class="crmTableRow small lineOnTop">
   		<input data-rowno="{$row_no}" id="{$product_cost_avg}" name="{$product_cost_avg}" type="text" class="small detailedViewTextBox product_cost_avg" onfocus="this.className='product_cost_avg detailedViewTextBoxOn ';" onblur="this.className='product_cost_avg detailedViewTextBox ';"  value="{$data.$product_cost_avg}"/>
   	</td>

   	<td class="crmTableRow small lineOnTop">
   		<input data-rowno="{$row_no}" id="{$competitor_price}" name="{$competitor_price}" type="text" class="small detailedViewTextBox competitor_price" onfocus="this.className='competitor_price detailedViewTextBoxOn ';" onblur="this.className='competitor_price detailedViewTextBox ';"  value="{$data.$competitor_price}"/>
   	</td>
