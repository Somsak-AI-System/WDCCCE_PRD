                ...
                <tr>
                    <td align="left" style="padding:10px 10px 20px;">
                        ...
                        {elseif $quotation_type eq 'ขายสินค้าพร้อมบริการ' || $quotation_type eq 'สินค้าปูพื้นบุผนัง (MT, ลามิเนตปิดพื้นผิว)' || $quotation_type eq 'กระเบื้อง'}
                            ...
                            <br>
                            <br>
                            <a class="webMnu" href="{$site_URL}export/report/quotation_report/Attachments/Attachments_rpt_quotation_goods_and_services_sold.pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
