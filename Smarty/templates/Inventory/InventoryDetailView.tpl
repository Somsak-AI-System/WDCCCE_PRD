    ...
    <td class="showPanelBg" valign=top width=100%>
                    ...
                    <td class="dvtTabCache" align="right" style="width:100%">
                            ...
                            {if $EDIT_DUPLICATE eq 'permitted' || $is_permmited eq true}
                                ...
                                {if $quotation_status eq 'ขออนุมัติใบเสนอราคา' && $approveflg eq true }
                                    {if $levelflg eq '4'}
                                        <button title="Final Approve" class="crmbutton small edit Request_Approve" onclick="confirm_approve('Approve','{$ID}','{$levelflg}');" type="button" name="finalapprove" value="Final Approve">
                                            <img src="themes/softed/images/approval.png" border="0" style="width: 17px;height: 19px; vertical-align: middle;">&nbsp;Final Approve
                                        </button>&nbsp;
                                        <button title="Cancel Final Approve" class="crmbutton small cancel Cancel_Approve" onclick="confirm_approve('Cancel_Approve','{$ID}','{$levelflg}')">
                                    ...
                                    {else}
                                        <button title="Approve" class="crmbutton small edit Approve" onclick="confirm_approve('Approve','{$ID}','{$levelflg}');" type="button" name="approvelevel" value="Approve Level {$levelflg}">
                                            <img src="themes/softed/images/approval.png" border="0" style="width: 17px;height: 19px; vertical-align: middle;">&nbsp;Approve Level {$levelflg}
                                        </button>&nbsp;
                                        <button title="Cancel Approve" class="crmbutton small cancel Cancel_Approve" onclick="confirm_approve('Cancel_Approve','{$ID}','{$levelflg}')">
                                            <img src="themes/softed/images/cancel_o.png" border="0" style="width: 17px;height: 17px; vertical-align: middle;">&nbsp;Cancel Approve Level {$levelflg}
                                        </button>&nbsp;
                                    {/if}
                                {/if}
                                
                                {if $flagassign eq true && ($quotation_status eq 'เปิดใบเสนอราคา' || $quotation_status eq 'ขออนุมัติใบเสนอราคา')}
                                    <button title="Cancel Quotation" class="crmbutton small cancel Cancel_Quotaion" onclick="confirm_approve('Cancel_Quotation','{$ID}','')">
                                        <img src="themes/softed/images/cancel_o.png" border="0" style="width: 17px;height: 17px; vertical-align: middle;">&nbsp;Cancel Quotaion
                                    </button>&nbsp;
                                {/if}

                                 {if ( $quotation_status eq 'อนุมัติใบเสนอราคา'  && $sono eq ''  && $flag_erp_response_status neq '1')}
                                    <button title="Send to ERP" class="crmbutton small edit btnedit send_data_to_erp" onclick="send_data_to_erp('{$ID}');" type="button" name="Send to ERP" value="Send to ERP">
                                ...
                                {*{if $quotation_status eq 'อนุมัติใบเสนอราคา' ||  $quotation_status eq 'ไม่อนุมัติใบเสนอราคา' || ($is_permmited eq true && $quotation_status eq 'อนุมัติใบเสนอราคา' ||  $quotation_status eq 'ไม่อนุมัติใบเสนอราคา')}   
                                    <button title="Revise" class="crmbutton small edit Request_Approve" onclick="DetailView.return_module.value='{$MODULE}'; DetailView.return_action.value='DetailView'; DetailView.isRevise.value='true';DetailView.module.value='{$MODULE}'; submitFormForAction('DetailView','EditView');" type="button" name="revise" value="Revise"><img src="themes/softed/images/revise.png" border="0" style="width: 17px;height: 17px; vertical-align: middle;">&nbsp;Revise</button>
                                {/if}*}
                                ...
                                {*{if ( $quotation_status eq 'อนุมัติใบเสนอราคา')}
                                    ...
                                    <button title="Complete" class="crmbutton small edit Complete"; onclick="confirm_approve('Complete','{$ID}','');" type="button" name="complete" value="Complete">
                                        <img src="themes/softed/images/Complete.png" border="0" style="width: 15px;height: 15px; vertical-align: middle;">&nbsp;Complete
                                    </button>&nbsp;
                                {/if}*}

                                {if $flagassign eq true && ($convertflag eq '0' && $quotation_status eq 'ปิดการขาย')}
                                    <!-- <a href="index.php?module=Salesorder&action=EditView&return_action=DetailView&parenttab=Sales&return_module={$MODULE}&quotesid={$ID}" >
        ...
        <tr>
                    ...
                    <table border=0 cellspacing=0 cellpadding=0 width=100%>
                            ...
                            {/if}
                                ...
                                {if $header neq 'Comments' && $header neq 'Comment Information'}
                                           ...
                                           {assign var=display_type value=$data.displaytype}
                                            ...
                                            {if $label ne ''}
                                                ...
                                                {if $EDIT_PERMISSION eq 'yes' && $display_type neq '2'}
                                                    ...
                                                    {elseif ($keyfldname eq 'delivery_date' || $keyfldname eq 'shipping_value') && ($assigned eq 1 ||$IS_ADMIN eq 'on')}
                                                        {include file="DetailViewUI.tpl"}
                                                    {else}
                                    ...
                                    {/foreach}
                                    {*{if $header=="Remark" && $MODULE=="Quotes"}
                                        {include_php file='modules/Quotes/log_change_status.php'}
                                    {/if}*}
                                    </table>
                                    </div>
                                {/if}
           ...
           {if $MODULE eq 'Quotes'}
                <tr>
                    <td align="center" style="padding:10px !important;">
                        {include_php file="./modules/Quotes/DeliveryDate/list_view.php"}
                    </td>
                </tr>
            {/if}
            ...
            {if $MODULE eq 'Quotes'}
                ...
                <tr>
                    <td align="left" style="padding:10px 10px 20px;">
                        {if $quotation_type eq 'กาวซีเมนต์'}
                            <a class="webMnu" href="{$Report_URL}rpt_quotation_glue_cement.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                        ...
                        {elseif $quotation_type eq 'ขายสินค้าพร้อมบริการ' || $quotation_type eq 'สินค้าปูพื้นบุผนัง (MT, ลามิเนตปิดพื้นผิว)' || $quotation_type eq 'กระเบื้อง'}
                            <a class="webMnu" href="{$Report_URL}rpt_quotation_goods_and_services_sold.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;" >
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation (TH)
                            </a>
                            <br>
                            <br>
                            <a class="webMnu" href="{$Report_URL}rpt_quotation_goods_and_services_sold_en.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation (EN)
                            </a>
                            <br>
                            <br>
                            <a class="webMnu" href="{$site_URL}export/report/quotation_report/Attachments/Attachments_rpt_quotation_goods_and_services_sold.pdf?v=1" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>ข้อแนะนำในการปูกระเบื้อง
                            </a>
                        {elseif $quotation_type eq 'ค่าตัดกระเบื้อง'}
                            <a class="webMnu" href="{$Report_URL}rpt_tile_cutting_cost.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;" >
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation (TH)
                            </a>
                            <br>
                            <br>
                            <a class="webMnu" href="{$Report_URL}rpt_tile_cutting_cost_en.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation (EN)
                            </a>
                            <br>
                            <br>
                        ...
                        {elseif $quotation_type eq 'ค่าติดตั้ง'}
                            <a class="webMnu" href="{$Report_URL}rpt_quotation_installation.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation (TH)
                            </a>
                            <br>
                            <br>
                            <a class="webMnu" href="{$Report_URL}rpt_quotation_installation_en.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation (EN)
                            </a>
                        {elseif $quotation_type eq 'สุขภัณฑ์' || $quotation_type eq 'สุขภัณฑ์และชุดครัว'}
                            <a class="webMnu" href="{$Report_URL}rpt_quotation_sanitaryware.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation
                            </a>
                        {elseif $quotation_type eq 'ค่าบริการออกแบบ'}
                            <a class="webMnu" href="{$Report_URL}rpt_quotation_designfee.rptdesign&quoteid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                                <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Quotation
                            </a>
                        {elseif $quotation_type eq 'ค่าขนส่ง'}
                ...
                <tr>
                    ...
                    <td class="dvtTabCacheBottom" align="right" style="width:100%">
                        ...
                        {if $EDIT_DUPLICATE eq 'permitted' || $is_permmited eq true}
                            ...
                            {*top $flagassign eq true &&*}
                            {*{if $quotation_status eq 'อนุมัติใบเสนอราคา' ||  $quotation_status eq 'ไม่อนุมัติใบเสนอราคา' || ($is_permmited eq true && $quotation_status eq 'อนุมัติใบเสนอราคา' ||  $quotation_status eq 'ไม่อนุมัติใบเสนอราคา')}
                                <button title="Revise" class="crmbutton small edit Request_Approve" onclick="DetailView.return_module.value='{$MODULE}'; DetailView.return_action.value='DetailView'; DetailView.isRevise.value='true';DetailView.module.value='{$MODULE}'; submitFormForAction('DetailView','EditView');" type="button" name="revise" value="Revise">
                                        <img src="themes/softed/images/revise.png" border="0" style="width: 17px;height: 17px; vertical-align: middle;">&nbsp;Revise
                                </button>&nbsp;
                            {/if}*}
    ...
    {foreach item=field key=count from=$HIDDEN_FIELDS}
        {if $field.visible == 1}
            ...
            for (let i = 0; i < {$field.class}.length; i++) {ldelim}
                ...
                {$field.class}[i].insertAdjacentHTML('afterend', '<td class="crmTableRow small lineOnTop" align="center">-</td>');
            {rdelim}
        {/if}
    {/foreach}
{rdelim}
