...
<tr>
	<td style="border-bottom:1px dotted #cccccc">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td align="left">		
					<span class="lvtHeaderText"><font color="purple">[ {$ID} ] </font>{$NAME} -  {$SINGLE_MOD} {$APP.LBL_INFORMATION}</span>&nbsp;&nbsp;<span class="small">{$UPDATEINFO}</span>&nbsp;<span id="vtbusy_info" style="display:none;" valign="bottom"><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span><span id="vtbusy_info" style="visibility:hidden;" valign="bottom"><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span>
				</td>
				<td align="right">		
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					...
					<table border=0 cellspacing=0 cellpadding=0 width=100%>
					     ...
					     <td style="padding:3px">
							...
							{/if}
							{if $LABEL.site_location neq ''}
							<tr>
								<td class="cellLabel" align="right" valign="top"><b>{$LABEL.site_location}</b></td>
								<td class="cellInfo" colspan=3 align="left" >{$ACTIVITYDATA.site_location}&nbsp;</td>
							</tr>
							{/if}	
							 <tr>
	...
	<td width=22% valign=top style="border-left:2px dashed #cccccc;padding:13px">
		...
		{if $TAG_CLOUD_DISPLAY eq 'true' &&  $MODULE neq 'Calendar'}
		<!-- Tag cloud display -->
