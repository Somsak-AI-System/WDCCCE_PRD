                                 ...
                                 <td> 
                                         ...
                                         <tr> 
                                                 ...
                                                 <td class="small" align=right> 
                                                         <!--<input class="crmbutton small edit" type="button" value="Upload Image" onclick="JavaScript: void window.open('sena_pic/page_add_email_template.php','Application','resizable=yes,left=200,top=0,width=900,height=230,toolbar=no,scrollbars=no,menubar=no,location=no')"  />&nbsp;-->
