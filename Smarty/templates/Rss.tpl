...
<tr>
	<td valign=top align=right width=8><img src="{'showPanelTopLeft.gif'|@aicrm_imageurl:$THEME}"></td>
			...
			<!-- RSS Reader UI Starts here--><br>
				...
				<tr>
					<td align=left>
						...
						<tr>
							<td width=95% align=left><img src='{'rssroot.gif'|@aicrm_imageurl:$THEME}' align='absmiddle'/><a href="javascript:;" onClick="fnvshobj(this,'PopupLay');$('rssurl').focus();" title='{$APP.LBL_ADD_RSS_FEEDS}'>{$MOD.LBL_ADD_RSS_FEED}</a></td>
	...
	<td valign=top align=right width=8><img src="{'showPanelTopRight.gif'|@aicrm_imageurl:$THEME}"></td>			
	</tr>
	</table>
	...
	<tr>
	<td class="layerPopupHeading" align="left"><img src="{'rssroot.gif'|@aicrm_imageurl:$THEME}" width="24" height="22" align="absmiddle" />&nbsp;{$MOD.LBL_ADD_RSS_FEED}</td>
	<td align="right"><a href="javascript:fninvsh('PopupLay');"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" border="0"  align="absmiddle" /></a></td>
	</tr>
	</table>
