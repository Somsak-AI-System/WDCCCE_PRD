				...
				<table width="100%"  border="0" cellspacing="0" cellpadding="0">
					...
					<td colspan="3" style="padding:10px;vertical-align:middle;height:2px;">
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
						   <tr>
							<td width="10%">
								<img src="{'check_mail.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />
				   ...
				   <tr>
					<td colspan=2> 
						...
						<td rowspan=6 valign=top class="MatrixLayer1">
							...
							<tr>
							<td>
								<img src="{'mymail.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />&nbsp;<span ><b class="txtGreen">{$MOD.LBL_MY_MAILS}</b>&nbsp;&nbsp;<span id="folderOpts" style="position:absolute;display:none">{$MOD.ADD_FOLDER}</span></span>
								<div id="box_list">
						...
						<ul style="list-style-type:none;">
							<li >
								<img src="{'opened_folder.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />&nbsp;&nbsp;
