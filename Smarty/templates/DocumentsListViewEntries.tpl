							...
							<table border=0 cellspacing=0 cellpadding=0>
                        		...
                        		{if $MASS_DELETE eq 'yes'}
            						<td style="padding-right:5px">
            							<!-- <input type="button" name="delete" value="{$APP.LBL_DELETE}" class="crmbutton small delete" onClick="return massDelete('{$MODULE}');"> -->
            							<button type="button" name="delete" value="{$APP.LBL_DELETE}" class="crmbutton small delete" onClick="return massDelete('{$MODULE}');">
            								<img src="themes/softed/images/delete_w.png" border="0" style="width: 15px; vertical-align: middle;">&nbsp;&nbsp;{$APP.LBL_DELETE}
            							</button>
            						</td>
                        		{/if}
											...
											<table  class="layerHeadingULine" border="0" cellpadding="5" cellspacing="0" width="100%">
												<tr>
													...
													<td align="right" width="10%">
														...
														<img border="0" align="absmiddle" src="{'close.gif'|@aicrm_imageurl:$THEME}"/></a>
													</td>
												</tr>
											</table>
							...
							<table border=0 cellspacing=0 cellpadding=0 class="small">
								<tr>
									...
									<td style="padding-left:5px;padding-right:5px">
			                            <SELECT NAME="viewname" id="viewname" class="small" onchange="showDefaultCustomView(this,'{$MODULE}','{$CATEGORY}')" style="border-radius:3px;">{$CUSTOMVIEW_OPTION}</SELECT>
									</td>
			                        {if $ALL eq 'All'}
											...
											{if $foldercount eq 1}
												<tr>
													<td align="center" style="background-color:#efefef;height:340px" colspan="{$header_count+1}">
														<div style="border: 3px solid rgb(201 201 201); background-color: rgb(255, 255, 255); width: 45%; position: relative;border-radius: 6px;">
															...
															{else}
																<table border="0" cellpadding="5" cellspacing="0" width="98%">
																<tr>
																<td rowspan="2" width="25%"><img src="{'denied.gif'|@aicrm_imageurl:$THEME}"></td>
																<td style="border-bottom: 1px solid rgb(204, 204, 204);" nowrap="nowrap" width="75%"><span class="genHeaderSmall">
				...
				<tr onmouseout="this.className='lvtColData'" onmouseover="this.className='lvtColDataHover'">
					...
					<td align=right>
						{if $IS_ADMIN eq "on" && $folder.folderid neq "1"}
							<a href="javascript:;" onclick="DeleteFolderCheck({$folder.folderid});"><img border="0" src="{'delete.gif'|@aicrm_imageurl:$THEME}" style="cursor: pointer;"/></a>
						{else}
							&nbsp;
						{/if}
					</td>					
