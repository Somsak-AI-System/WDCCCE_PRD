{include file='com_aicrm_workflow/Header.tpl'}
		...
		<tr>
			...
			<td width="40%" align="right">
				<a href="javascript:void(0);" id="new_template_popup_close">
					<img border="0" align="middle" src="{'close.gif'|@aicrm_imageurl:$THEME}"/>
				</a>
			</td>
		</tr>
	</table>
...
{include file='com_aicrm_workflow/ErrorMessageBox.tpl'}
<!--Done popups-->

{include file='SetMenu.tpl'}
<div id="view">
	{include file='com_aicrm_workflow/ModuleTitle.tpl'}
			...
			<tr>
				...
				<td align="right">
					...
					<input type="button" value="{$APP.LBL_CANCEL_BUTTON_LABEL}" class="crmButton small cancel" 
						onclick="window.location.href='index.php?module=com_aicrm_workflow&action=workflowlist&parenttab=Settings'">
				</td>
			</tr>
		</table>
			...
			<tr>
				...
				<td class="small" align="right">
					<span id="workflow_loading" style="display:none">
					  <b>{$MOD.LBL_LOADING}</b><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0">
					</span>
			...
			<td class="listTableRow small">
				<a href="{$module->editTaskUrl($task->id)}">
					<img border="0" title="Edit" alt="Edit" \
						...
						src="{'editfield.gif'|@aicrm_imageurl:$THEME}"/>
				</a>
				<a href="{$module->deleteTaskUrl($task->id)}">
					<img border="0" title="Delete" alt="Delete"\
			 			src="{'delete.gif'|@aicrm_imageurl:$THEME}" \
...
{include file='com_aicrm_workflow/Footer.tpl'}
