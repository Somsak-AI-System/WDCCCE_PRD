...
<script src="modules/com_aicrm_workflow/resources/createeventtaskscript.js" type="text/javascript" charset="utf-8"></script>
...
<div id="view">
	...
	<tr valign="top">
		...
		<td class='dvtCellInfo'>
			<span id="event_status_busyicon"><b>{$MOD.LBL_LOADING}</b><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span>
	...
	<tr valign="top">
		...
		<td class='dvtCellInfo'>
			<span id="event_type_busyicon"><b>{$MOD.LBL_LOADING}</b><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span>
