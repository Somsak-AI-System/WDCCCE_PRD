...
<script src="modules/com_aicrm_workflow/resources/createtodotaskscript.js" type="text/javascript" charset="utf-8"></script>
...
<div id="view">
	...
	<tr valign="top">
		...
		<td class='dvtCellLabel'>
			<span id="task_status_busyicon"><b>{$MOD.LBL_LOADING}</b><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span>
	...
	<tr valign="top">
		...
		<td class='dvtCellLabel'>
			<span id="task_priority_busyicon"><b>{$MOD.LBL_LOADING}</b><img src="{'vtbusy.gif'|@aicrm_imageurl:$THEME}" border="0"></span>
