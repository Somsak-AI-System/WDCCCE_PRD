								...
								<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
								   <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
										<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; template_data(); return formValidate(); return SaveForm(); " type="submit" name="button" value="{$APP.LBL_SAVE_BUTTON_LABEL}" style="width:70px" ><!-- template_questionnaire(); return -->
                                   ...
                                   {if $header eq "Template" && $MODULE eq "Inspectiontemplate"}
                                  		 <input type="hidden" name="data_template" id="data_template" class="data_template" value="{$DATA_TEMPLATE}" >
                                         <tr>
                                            <td  colspan=4 style="padding:5px">

                                               {include_php file='/plugin/inspection/template.php'}
								   ...
								   <tr>
									<td  colspan=4 style="padding:5px">
									   <div align="center">
										<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; template_data(); return formValidate(); return SaveForm();" type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
										<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="crmbutton small cancel" onclick="window.history.back()" type="button" name="button" value="  {$APP.LBL_CANCEL_BUTTON_LABEL}  " style="width:70px">
