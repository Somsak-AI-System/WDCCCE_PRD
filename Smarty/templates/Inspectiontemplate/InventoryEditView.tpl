					...
					<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
					   <tr>
						<td class="dvtTabCache" style="width:10px" nowrap>&nbsp;</td>
                        	...
                        	<td class="dvtSelectedCell" align=center nowrap>{$APP.SINGLE_Inspectiontemplate} {$APP.LBL_INFORMATION}</td>
									...
									<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
									   <tr>
										<td  colspan=4 style="padding:5px">
										   <div align="center">
											<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save';  template_data(); return formValidate(); return SaveForm(); " type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" ><!-- displaydeleted() -->
									   ...
									   {if $header eq "Template" && $MODULE eq "Inspectiontemplate"}
                                             ...
                                             <tr>
                                                <td  colspan=4 style="padding:5px">
													{include_php file='/plugin/inspection/edit.php'}
                                                </td>
                                            </tr>
                                       {else}
