...
<TABLE border=0 cellspacing=0 cellpadding=0 width=100% class=small>
	...
	<table border=0 cellspacing=0 cellpadding=0 style="width: 100%">
		<tr>
			<td style="width:90%">{include file="Buttons_List1.tpl"}</td>		
...
<div id="reportContents" style=" padding:7px;">
...
<div id="orgLay" style="display:none;width:350px;" class="layerPopup">
	...
	<tr>
		...
		<td align="right"><a href="javascript:;" onClick="closeEditReport();"><img src="{'close.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" border="0"></a></td>
	</tr>
	</table>
