...
-->*}
<body class=small>
{include file='QuickCreateInformHidden.tpl'}
<table border="0" align="center" cellspacing="0" cellpadding="0" width="90%" class="mailClient mailClientBg">
<tr>
<td>
	<table border="0" cellspacing="0" cellpadding="0" width="100%" class=small>
	<tr>
		<td width="90%" class="mailSubHeader" background="{'qcBg.gif'|@aicrm_imageurl:$THEME}"><b >{$APP.LBL_CREATE_BUTTON_LABEL} {$QCMODULE}</b></td>
		...
		<table border="0" cellspacing="0" cellpadding="5" width="100%" class=qcTransport>
			<tr>
				...
				<td width="50%" align="left">
					<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="crmbutton small cancel" onclick="hide('newqcform'); $('qccombo').options.selectedIndex=0;" type="button" name="button" value="  {$APP.LBL_CANCEL_BUTTON_LABEL}  " style="width:70px">
				</td>
			</tr>
		</table>
