			...
			{foreach name=reportdtls item=reportdetails from=$reportfolder.details}
				...
				{if $MOD[$reportdetails.reportname] neq ''}
					...
					{if $reportdetails.sharingtype eq 'Shared'}
						<img src="{'Meetings.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" border=0 height=12 width=12 /> 
					{/if}
					</td>
				{else}
				...
				<td align="center" nowrap>
					{if $reportdetails.customizable eq '1' && $reportdetails.editable eq 'true'}
						<a href="javascript:;" onClick="editReport('{$reportdetails.reportid}');"><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" title="{$MOD.LBL_CUSTOMIZE_BUTTON}..." border="0"></a>
					{/if}
					{if $reportdetails.state neq 'SAVED' && $reportdetails.editable eq 'true'}
						&nbsp;| &nbsp;<a href="javascript:;" onclick="DeleteReport('{$reportdetails.reportid}');"><img src="{'delete.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" title="{$MOD.LBL_DELETE}..." border="0"></a>
					{/if}
				</td>
				</tr>
			{/foreach}
