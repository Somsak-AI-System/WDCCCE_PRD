	...
	<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					...
					<td class=heading2 valign=bottom><b><a href="index.php?module=Settings&action=index&parenttab=Settings">{$MOD.LBL_SETTINGS}</a> > {$CMOD.LBL_ALERT_Menu1}</b></td>
				</tr>
				<tr>
					<td valign=top class="small">{$MOD.LBL_ALERT_Menu1}</td>
				</tr>
				</table>
				<br>
				...
				<td>
					...
					<tr>
						<td class="big"><strong>{$MOD.LBL_ALERT_Menu1}</strong></td>
						<td class="small" align=right>{$CMOD.LBL_TOTAL} {$GRPCNT} Record </td>
					</tr>
					</table>
					<!--<table border=0 cellspacing=0 cellpadding=5 width=100% class="listTableTopButtons">
					<tr>
						<td class=small align=right><a href="#" onClick="javascript:window.open('modules/Settings/edit_alert.php?action_type=list_alert_email&action=add' , '','menuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=0,width=400,height=150,top=220,left=400 ' )";><input type="button" value="New Sender" title="New Sender" class="crmButton create small"></a></td>
					</tr>
					</table>-->
					...
					<tr>
						...
						<td class="colHeader small" valign=top width=30% align="left">{$LIST_HEADER.1}</td>
						<td class="colHeader small" valign=top width=50% align="left">{$LIST_HEADER.2}</td>
					  ...
					  <tr>
						...
						<td class="listTableRow small" valign=top nowrap align="center">
							  	<a href="#" onClick="javascript:window.open('modules/Settings/edit_alert.php?action_type=list_alert_email&action=edit&id={$otvalues.id}' , '','menuber=no,toorlbar=no,location=no,scrollbars=no, status=no,resizable=0,width=500,height=250,top=220,left=400 ' )";><img src="{'editfield.gif'|@aicrm_imageurl:$THEME}" alt="{$APP.LBL_EDIT}" title="{$APP.LBL_EDIT}" border="0" align="absmiddle"></a>
						...
						<td class="listTableRow small" valign=top align="left"><font color="#FF0000"><strong>{$otvalues.alert_name}</strong></font></td>
                        <td class="listTableRow small" valign=top align="left">{$otvalues.alert_msg}</td>
