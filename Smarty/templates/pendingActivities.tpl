...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="small">
        <tr>
		<td><img src="{'pending_left.gif'|@aicrm_imageurl:$THEME}"></td>
                <td width="100%" background="{'pendingEvents.gif'|@aicrm_imageurl:$THEME}" valign="bottom" style="background-repeat:repeat-x;">
                ...
                <td><img src="{'pending_right.gif'|@aicrm_imageurl:$THEME}"></td>
        </tr>
        <tr>
