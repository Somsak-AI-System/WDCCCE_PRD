                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tr><td align="left" class="genHeaderSmall">{$APP.LBL_REPORT}</td></tr>
                        <td align="left" style="padding-left:10px;">
                            <a class="webMnu" href="{$Report_PDF}rpt_priceList.rptdesign&pricelistid={$ID}&__format=pdf" target="_blank" style="font-family: PromptMedium; font-weight: 400; color: #2B2B2B; font-size: 11px;">
                            <img src="{'themes/softed/images/pdf.png'|@aicrm_imageurl:$THEME}" hspace="5" align="absmiddle" border="0" style="width: 28px; margin-right: 10px;"/>Price List (Export)
                            </a>
                        </td>
