	...
	<td class="showPanelBg" valign=top width=100%>
		...
		<div class="small" style="padding:20px">
			...
			{if $OP_MODE eq 'edit_view'}
				...
				<span class="lvtHeaderText"><font color="purple">[ {$USE_ID_VALUE} ] </font>{$NAME} - {$APP.LBL_EDITING} PriceList {$APP.LBL_INFORMATION}</span> <br>
				{$UPDATEINFO}	 
			{/if}
					...
					<table border=0 cellspacing=0 cellpadding=3 width=100% class="small">
					   <tr>
                	    ...
                	    <td class="dvtTabCache" align="right" style="width:100%">
                	    	...
                	    	<button title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="this.form.action.value='Save'; return validateInventory('{$MODULE}');  displaydeleted(); " type="submit" name="button" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
								...
								<!-- General details -->
									<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
									   ...
									   <!-- This is added to display the existing comments -->
									    ...
									    <tr>
											{if $header== $MOD.LBL_ADDRESS_INFORMATION && ($MODULE == 'PriceList' || $MODULE == 'Accounts' || $MODULE == 'Contacts' || $MODULE == 'Quotes' || $MODULE == 'PurchaseOrder' || $MODULE == 'SalesOrder'|| $MODULE == 'Invoice')}
											...
											<td colspan=4 class="detailedViewHeader">
												<img id="aidAccountInformation" src="themes/softed/images/slidedown_b.png" style="border: 0px solid #000000; width: 15px; height: 12px; margin-top: 2px;" alt="Hide" title="Hide">&nbsp;&nbsp;&nbsp;{$header}</b>
											{/if}
											</td>
										</tr>
									   ...
									   <tr>
										<td colspan=4>
											...
											{include file="PriceList/ProductDetailsEditView.tpl"}
