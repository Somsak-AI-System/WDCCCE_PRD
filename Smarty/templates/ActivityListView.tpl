...
<table width="100%" cellpadding="5" cellspacing="0"  class="searchUIBasic small" align="center" border=0>
	<tr>
		...
		<!-- <img src="{'basicSearchLens.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" alt="{$APP.LNK_BASIC_SEARCH}" title="{$APP.LNK_BASIC_SEARCH}" border=0>&nbsp;&nbsp;-->
		</td>
		...
		<tr>
			<td>
				...
				<tr>
                    ...
                    <td class="dvtUnSelectedCell" align="center" nowrap="nowrap"><a href="index.php?action=index&module=Calendar&parenttab={$CATEGORY}" />Sales Visit</a></td>
     ...
     <input name="current_page_boxes" id="current_page_boxes" type="hidden" value="{$CURRENT_PAGE_BOXES}">
               <table border=0 cellspacing=1 cellpadding=0 width=100% class="lvtBg">
		        ...
		        <td>
		         <table border=0 cellspacing=0 cellpadding=2 width=100% class="small">
			      <tr>
					 <td style="padding-right:200px" nowrap>
	                     {foreach key=button_check item=button_label from=$BUTTONS}
	                        {if $button_check eq 'del'}
	                            ...
	                            <button class="crmbutton small delete" type="button" value="{$button_label}" onclick="return massDelete('{$MODULE}')">
	                             	<img src="themes/softed/images/delete_w.png" border="0" style="width: 15px; vertical-align: middle;">
	                             	&nbsp;{$button_label}
	                             </button>
				   ...
				   <table border=0 cellspacing=0 cellpadding=0 class="small">
					<tr>
                        ...
                        <td style="padding-left:5px;padding-right:5px">
                           <select id='pagesize' class="small" style="width:50px;border-radius:3px;"  onchange="per_padding()" ><!-- onchange="per_padding()"onchange="showpagesize(this,'{$MODULE}')" -->
						...
						<td>{$APP.LBL_VIEW}</td>
						<td style="padding-left:5px;padding-right:5px">
                            <SELECT NAME="viewname" id="viewname" class="small" onchange="showDefaultCustomView(this,'{$MODULE}','{$CATEGORY}')"
                            style="border-radius:3px; width: 100% !important">{$CUSTOMVIEW_OPTION}</SELECT>
                        </td>
                        <td>
                            {if $ALL eq 'All'}
			 ...
			 <table border=0 cellspacing=1 cellpadding=3 width=100% class="lvt small" class="small">
				 ...
				 {foreach name="listviewforeach" item=header from=$LISTHEADER}
			      ...
			      <tr bgcolor=white onMouseOver="this.className='lvtColDataHover'" onMouseOut="this.className='lvtColData'" id="row_{$entity_id}">
				    ...
				    {if $MODULE eq 'Calendar' }
                            ...
                            {else}
                                <td width="2%">
                                <input type="checkbox" NAME="selected_id" id="{$entity_id}" value='{$entity_id}' onClick=check_object(this); toggleSelectAll(this.name,"selectall")>
                            	</td>
                            {/if}
                  	{else}
				...
				<tr><td style="background-color:#efefef;height:340px" align="center" colspan="{$smarty.foreach.listviewforeach.iteration+1}">
						<div style="border: 3px solid rgb(201 201 201); background-color: rgb(255, 255, 255); width: 45%; position: relative; z-index: 10000000;border-radius: 6px;">
