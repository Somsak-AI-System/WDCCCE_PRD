	...
	<table width="100%"  border="0" align="center" cellpadding="7" cellspacing="0" class="crmTable" id="proTab">
		...
		{/if}
			...
			<td class="dvInnerHeader" align="center" colspan="1">
		        ...
		        {*else*}
				<!-- <select id="taxtype" name="taxtype" class="small user-success" onchange="decideTaxDiv(); calcTotal();">
	   ...
	   <!-- Header for the Product Details -->
		<tr valign="top">
			...
			<td width=10% class="lvtCol" align="center"><strong>จำนวน</strong></td>{*$APP.LBL_QTY*}
			...
			<td width=12% nowrap class="lvtCol" align="center" colspan="2"><b>รวม</b></td>{*$APP.LBL_TOTAL*}
		...
		<!-- Following code is added for form the first row. Based on these we should form additional rows using script -->
	   	...
	   	<tr valign="top" id="row1">
			...
			<td class="crmTableRow small lineOnTop" align="right"><span id="qtyInStock1">{$QTY_IN_STOCK}</span></td>
			<!-- column 3 - Quantity in Stock - ends -->

		   	<td class="crmTableRow small lineOnTop">
		   		<input id="uom1" name="uom1" type="text" class="small uom" width="90%" onfocus="this.className='uom detailedViewTextBoxOn ';" onblur="this.className='uom detailedViewTextBox ';"  value=""/>
		   	</td>

			<!-- column 4 - Quantity - starts -->
			<td class="crmTableRow small lineOnTop">
				<input data-rowno="1" id="qty1" name="qty1" type="text" width="90%" class="small qty" onfocus="this.className='qty detailedViewTextBoxOn'" onBlur="this.className='qty detailedViewTextBox';settotalnoofrows();calcTotal(); set_tax_manual(); loadTaxes_Ajax(1); setDiscount(this,'1');{if $MODULE eq 'Invoice'}stock_alert(1);{/if}" value="1"/><br><span id="stock_alert1"></span>
			</td>

			<td class="crmTableRow small lineOnTop" style ="display:none">
				<input data-rowno="1" name="price_list_std1" type="text" class="small price_list_std " id="price_list_std1" onfocus="this.className='detailedViewTextBoxOn price_list_std'"  onblur="this.className='price_list_std detailedViewTextBox';calcTotal();setDiscount(this,'1'); callTaxCalc(1);calcTotal();" value="0.00"/>
			</td>
			...
			<td class="crmTableRow small lineOnTop" align="right">
				<table width="100%" cellpadding="0" cellspacing="0">
				   	<tr>
						<td align="right">
							<input data-rowno="1" id="listPrice1" name="listPrice1" type="text" class="small listPrice" width="90%" onfocus="this.className='listPrice detailedViewTextBoxOn'" onBlur="this.className='listPrice detailedViewTextBox'; setDiscount(this,'1');callTaxCalc(1);calcTotal();set_tax_manual(); " value="0.00"/>
						</td>
				   	</tr>
				</table>
			</td>
