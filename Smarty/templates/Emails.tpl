...
<table width="100%" border="0" cellpadding="0" cellspacing="0" height="100%">
	<tr>
		<td valign=top align=right><img src="{'showPanelTopLeft.gif'|@aicrm_imageurl:$THEME}"></td>
		...
		<!-- Email Client starts here -->
			...
			<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="mailClient">
						...
						<table width="100%"  border="0" cellspacing="0" cellpadding="0">
									...
									<td align=left>
										...
										<table cellpadding="5" cellspacing="0" border="0">
											<tr>
												...
												<img src="{'compose.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />
							&nbsp;<a href="javascript:;" onClick="OpenCompose('','create');" >{$MOD.LBL_COMPOSE}</a>
												</td>
												<td nowrap style="padding-left:20px;padding-right:20px" class=small>
												<img src="{'webmail_settings.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />
							&nbsp;<a href="index.php?module=Users&action=AddMailAccount&record={$USERID}" >{$MOD.LBL_SETTINGS}</a>
										...
										<td align=right>
											<table >
											<tr>
												<td class="componentName" align=right>{$MOD.LBL_VTIGER_EMAIL_CLIENT}<!-- <img src="{'titleMailClient.gif'|@aicrm_imageurl:$THEME}" align="right"/> --></td>
											</tr>
											</table>
									</td>
									</tr>
							...
							<tr>
								...
								<!-- Mailbox Tree -->
								<!-- Inbox -->
								<img src="{'folder_.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />&nbsp;<b class="txtGreen">{$MOD.LBL_INBOX}</b>
								<ul style="list-style-type:none;margin-left:10px;margin-top:5px;padding:2px">
									<li><img src="{'folder.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />&nbsp;&nbsp;
										<a href="javascript:;" onClick="ShowFolders(6)" class="webMnu">{$MOD.LBL_QUAL_CONTACT}</a>&nbsp;<b></b>
									</li>
									<li><img src="{'mymail.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />&nbsp;&nbsp;
									<a href="javascript:;" onClick="gotoWebmail();" class="webMnu">{$MOD.LBL_MY_MAILS}</a>&nbsp;<b></b>
									</li>
								</ul>
								<!-- Sent mail -->
								<img src="{'sentmail.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />&nbsp;<b class="txtGreen">{$MOD.LBL_SENT_MAILS}</b>
								<ul style="list-style-type:none;margin-left:10px;margin-top:5px;padding:2px">
									<li><img src="{'folder1.gif'|@aicrm_imageurl:$THEME}" align="absmiddle" />&nbsp;&nbsp;
				...
				<!-- <tr>
					<td width="7" height="8" style="font-size:1px;font-family:Arial, Helvetica, sans-serif;"><img src="{'bottom_left.jpg'|@aicrm_imageurl:$THEME}" align="bottom"  /></td>
					<td bgcolor="#ECECEC" height="8" style="font-size:1px;" ></td>
					<td width="8" height="8" style="font-size:1px;font-family:Arial, Helvetica, sans-serif;"><img src="{'bottom_right.jpg'|@aicrm_imageurl:$THEME}" align="bottom" /></td>
				</tr>-->
			</table><br/>
		</td>
