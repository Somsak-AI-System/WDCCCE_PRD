	...
	<form action="index.php" method="post" id="form" onsubmit="VtigerJS_DialogBox.block();">
		...
		<div align=center>
			{include file='SetMenu.tpl'}
				...
				<tr>
					<td width=50 rowspan=2 valign=top><img src="{'mailScanner.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_MAIL_SCANNER}" width="48" height="48" border=0 title="{$MOD.LBL_MAIL_SCANNER}"></td>
	         	    ...
	         	    <td class="small" valign=top ><table width="100%"  border="0" cellspacing="0" cellpadding="5">
						...
						<tr>
							<td nowrap class="small cellLabel">
								...
								{if $NEXT_RULEID}
<a href="index.php?module=Settings&action=MailScanner&parenttabl=Settings&mode=rulemove_down&scannername={$SCANNERINFO.scannername}&targetruleid={$NEXT_RULEID}&ruleid={$SCANNERRULE->ruleid}" title="{$MOD.LBL_MOVE} {$MOD.LBL_DOWN}"><img src="{'arrow_down.gif'|@aicrm_imageurl:$THEME}" border=0></a>
								{/if}
								{if $PREV_RULEID}
<a href="index.php?module=Settings&action=MailScanner&parenttabl=Settings&mode=rulemove_up&scannername={$SCANNERINFO.scannername}&targetruleid={$PREV_RULEID}&ruleid={$SCANNERRULE->ruleid}" title="{$MOD.LBL_MOVE} {$MOD.LBL_UP}"><img src="{'arrow_up.gif'|@aicrm_imageurl:$THEME}" border=0></a>
								{/if}
								</span>
							</td>
