...
<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" style="text-align:center;" onLoad="JavaScript:window.print()">
	...
	<tr>
		...
		<h2>{$REPORT_NAME}{*$MOD.$REPORT_NAME*}</h2>
		<font  color="#666666"><div id="report_info"></div></font>
		</td>
		<td align="right" style="border:0px solid #000000;vertical-align: bottom;" valign="top"><h3 style="color:#CCCCCC">{$COUNT} {$APP.LBL_RECORDS}</h3></td>
	</tr>
	<tr>
