...
<tbody><tr>
		...
		<div align=center>
			...
			<!-- DISPLAY -->
				...
				<tr align="left">
					<td rowspan="2" valign="top" width="50"><img src="{'custom.gif'|@aicrm_imageurl:$THEME}" alt="{$MOD.LBL_USERS}" title="{$MOD.LBL_USERS}" border="0" height="48" width="48"></td>
				...
				<tr>
					...
					<!-- <td class="colHeader small" valign="top" width="23%">{$APP.Deal}</td> -->
				...
				<tr>
					...
					<td class="listTableRow small">
						<select name='{$fldnameacc}' id='{$fldnameacc}' onChange='return validateTypeforCFMapping("{$cfarray.fieldtype}","{$cfarray.typeofdata}","{$fldnameacc}",this);' class="small" >
					...
					{foreach item=con_cf key=fldnamecon from=$cfarray.deal}
                    <td class="listTableRow small">
                        <select name='{$fldnamecon}' id='{$fldnamecon}' onChange='return validateTypeforCFMapping("{$cfarray.fieldtype}","{$cfarray.typeofdata}","{$fldnamecon}",this);'class="small" >
						<option value='None'>{$APP.LBL_NONE}</option>
					...
					<td class="listTableRow small">
						<select name='{$fldnamepot}' id='{$fldnamepot}' onChange='return validateTypeforCFMapping("{$cfarray.fieldtype}","{$cfarray.typeofdata}","{$fldnamepot}",this);'class="small" >
						<option value='None'>{$APP.LBL_NONE}</option>
