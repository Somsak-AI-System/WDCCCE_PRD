...
<table width="100%" border="0" cellpadding="5" cellspacing="0">
   ...
   {if $MODULE neq 'PurchaseOrder' && $MODULE neq 'Projects'}
   <tr>
...
{if $MODULE neq 'Projects' && $MODULE neq 'Services' && $MODULE neq 'Vendors'}
...
{if $MODULE eq 'Projects' || $MODULE eq 'Projects' || $MODULE eq 'Quotes' || $MODULE eq 'Invoice'}
