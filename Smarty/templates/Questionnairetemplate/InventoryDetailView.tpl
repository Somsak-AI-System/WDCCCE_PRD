			...
			<td>
				...
				<tr>
					...
					<td class="dvtTabCache" align="right" style="width:100%">
                        ...
                        {if $MODULE eq 'Questionnairetemplate'}
                            <button input class="crmbutton btnviewsend save" type="button" onclick="javascript:void window.open('survey/home/questionnaire_template_view/{$ID}/0','Preview Questionnaire Template','resizable=1,left=200,top=50,width=1100,height=800,toolbar=no,scrollbars=yes,menubar=no,location=no')"><img src="themes/softed/images/preview_w.png" border="0" style="width: 15px;height: 17px; vertical-align: middle;">&nbsp;Preview</button>&nbsp;
                        {/if}
                ...
                <tr>
					...
					<!-- Command Buttons -->
				  	<table border=0 cellspacing=0 cellpadding=0 width=100%>
                        ...
                        {if $header eq "Template" && $MODULE eq "Questionnairetemplate"}
                            ...
                            <tr>
                                <td colspan=4>
                                   {include_php file='modules/Questionnairetemplate/survey/detail.html'}
                                </td>
                            </tr>
                            </table>
                            </div>
				...
				<tr>
					...
					<td class="dvtTabCacheBottom" align="right" style="width:100%">
                        ...
                        {if $EDIT_DUPLICATE eq 'permitted' && $MODULE neq 'Documents'}
                        	<button title="Duplicate [Alt+U]" accesskey="U" class="crmbutton small btnduplicate" onclick="DetailView.return_module.value='Accounts'; DetailView.return_action.value='DetailView'; DetailView.isDuplicate.value='true';DetailView.module.value='Accounts'; submitFormForAction('DetailView','EditView');" name="Duplicate" style="width: 95px;">
                                <img src="themes/softed/images/duplicate_w.png" border="0" style="width: 15px; height: 17px; vertical-align: middle;">&nbsp;Duplicate
                            </button>
                        <!-- <input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="crmbutton small create" onclick="DetailView.return_module.value='{$MODULE}'; DetailView.return_action.value='DetailView'; DetailView.isDuplicate.value='true';DetailView.module.value='{$MODULE}'; submitFormForAction('DetailView','EditView');" type="button" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}">&nbsp; -->
                        {/if}
