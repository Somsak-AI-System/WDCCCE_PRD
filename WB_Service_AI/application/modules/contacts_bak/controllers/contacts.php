...
class Contacts extends REST_Controller
{
	...
	private function set_param($a_param = array())
    {
        ...
        if (isset($a_param["username"]) && $a_param["username"] != "") {
            $a_condition["aicrm_contactdetails.username"] = $a_param["username"];
        }
        
        if (isset($a_param["password"]) && $a_param["password"] != "") {
            $a_condition["aicrm_contactdetails.password"] = $a_param["password"];
        }
       
        $a_condition["aicrm_contactdetails.con_contactstatus"] = 'Active';
	...
	public function login_post(){
        ...
        $a_data = $this->get_login($a_request);
       
        $this->return_data($a_data);
    }

    private function get_login($a_params=array())
    {
