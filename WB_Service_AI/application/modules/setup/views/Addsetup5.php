...
<table style="width:100%">
        ...
        <td style="width:60%">
            <select class="easyui-combobox" name="main_channel[]" id="main_channel" style="width:90%;">
                <?php foreach($main_channel as $main_channel){
                    $selected = @$setUppoint5['main_channel'] == $main_channel['main_channel'] ? 'selected':'';
                    ?>
        ...
        <td style="width:60%">
            <select class="easyui-combobox" name="sub_channel[]" id="sub_channel" style="width:90%;">
                <?php foreach($sub_channel as $sub_channel){
                    $selected = @$setUppoint5['sub_channel'] == $sub_channel['sub_channel'] ? 'selected':'';
                    ?>
    ...
    <tr>
        ...
        <td style="width:60%"><input style="width:90%;height:30px;" name="startdate" id="startdate" value="<?php echo @$setUppoint5['startdate']; ?>"></td>
    </tr>
    <tr>
        <td style="width:40%"><span>Period End </span><span style="color:red">*</span></td>
        <td style="width:60%"><input style="width:90%;height:30px;" name="enddate" id="enddate" value="<?php echo @$setUppoint5['enddate']; ?>"></td>
    </tr>

    <tr>
        <td style="width:40%"><span>Point </span><span style="color:red">*</span></td>
        <td style="width:60%"><input type="number" class="detailedViewTextBox" name="number" id="number" min="0" value="<?php echo (@$setUppoint5['number'] != '') ? @$setUppoint5['number'] : 0; ?>"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="width:60%">
            <select class="detailedViewTextBox" name="operator" id="operator">
                <option value="+" <?php if($setUppoint5['operator'] == '+') echo 'selected'; ?>>+</option>
                <option value="*" <?php if($setUppoint5['operator'] == '*') echo 'selected'; ?>>*</option>
            </select>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td style="width:60%"><input type="number" class="detailedViewTextBox" name="minimum" id="minimum" min="0" value="<?php echo (@$setUppoint5['minimum'] != '') ? @$setUppoint5['minimum'] : 0; ?>" ></td>
    </tr>

    <tr>
        <td colspan="2" style="text-align:center">
            <input type="hidden" id="userID" value="<?php echo $userID; ?>">
            <button class="crmbutton small save" style="cursor:pointer" onclick="saveSetpoint5('<?php echo $action; ?>', '<?php echo $id; ?>')">Save</button>
...
<script type="text/javascript">
    ...
    var sub_channel = <?php echo json_encode(@$setUppoint5['sub_channel']); ?>;
    ...
    var main_channel = <?php echo json_encode(@$setUppoint5['main_channel']); ?>;
