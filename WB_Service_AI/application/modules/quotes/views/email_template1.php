            ...
            <tr>
                <td>
                    ...
                    <table width="1000" border="0" cellspacing="0" cellpadding="0" class="small">
                        <tr>
                            <td class="dvInnerHeader" align="left" colspan="15">
                        ...
                        <tr>
                            ...
                            <td class="dvtCellLabel" align="center">
                                <strong>ชนิดผิว</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>ขนาด (มม.)</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>ความหนา (มม.)</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>แบรนด์สินค้ากรีนแลม</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>ราคากรีนแลม (Exc.VAT)</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>แบรนด์คู่แข่ง</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>ราคาคู่แข่ง (Exc.VAT)</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>แบรนด์คู่แข่งในโครงการ</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                                <strong>ราคาคู่แข่งในโครงการ (Exc.VAT)</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                            ...
                            <td class="dvtCellLabel" align="center">
                                <strong>รวมต้นทุนจริงเฉลี่ย</strong>
                            </td>
                            <td class="dvtCellLabel" align="center">
                        ...
                        <tr>
                            ...
                            <td class="dvtCellInfo" align="center"><?php echo $item['product_finish']; ?></td>
                            <td class="dvtCellInfo" align="center"><?php echo $item['product_size_mm']; ?></td>
                            <td class="dvtCellInfo" align="center"><?php echo $item['product_thinkness']; ?></td>
                            <td class="dvtCellInfo" align="center"><?php echo $item['competitor_brand']; ?></td>
                            <td class="dvtCellInfo" align="right"><?php echo number_format($item['competitor_price'], 2); ?></td>
                            <td class="dvtCellInfo" align="center"><?php echo $item['compet_brand_in_proj']; ?></td>
                            <td class="dvtCellInfo" align="right"><?php echo number_format($item['compet_brand_in_proj_price'], 2); ?></td>
                            <td class="dvtCellInfo" align="right"></td>
                            <td class="dvtCellInfo" align="right"></td>
                            <td class="dvtCellInfo" align="right"><?php echo $item['quantity']; ?></td>
                            <td class="dvtCellInfo" align="center"><?php echo $item['product_unit']; ?></td>
                            <td class="dvtCellInfo" align="right"><?php echo number_format($item['product_cost_avg'], 2); ?></td>
                            <td class="dvtCellInfo" align="right"><?php echo number_format($item['selling_price'], 2); ?></td>
                            <td class="dvtCellInfo" align="right"><?php echo number_format($item['quantity'] * $item['selling_price'], 2); ?></td>
                        </tr>
                        <?php } ?>

                        <!-- <tr>
                            <td class="dvtCellInfo" colspan="14" align="right">
                                <strong>Total Qty.</strong>
                            </td>
                            <td class="dvtCellInfo" align="right">
                                <strong><?php echo number_format($itemList[0]['quantity'], 2); ?></strong>
                            </td>
                        </tr> -->
                        <tr>
                            <td class="dvtCellInfo" colspan="14" align="right">
                            ...
                            <td class="dvtCellInfo" align="right">
                                <strong><?php echo number_format($itemList[0]['nettotal'], 2); ?></strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="dvtCellInfo" colspan="14" align="right">
                        ...
                        <tr>
                            ...
                            <td class="dvtCellInfo" align="right">
                                <strong><?php echo number_format($itemList[0]['total_without_vat'], 2); ?></strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="dvtCellInfo" colspan="14" align="right">
                                <strong>Vat <?php echo number_format($itemList[0]['tax1'], 2); ?> %</strong>
                            </td>
                            <td class="dvtCellInfo" align="right">
                                <strong><?php echo number_format($itemList[0]['vat'], 2); ?></strong>
                            </td>
                        </tr>
                        <tr>
                            <td class="dvtCellInfo" colspan="14" align="right">
                            ...
                            <td class="dvtCellInfo" align="right">
                                <strong><?php echo $itemList[0]['sum_vat']; ?></strong>
                            </td>
                        </tr>
                    </table>
                </td>
