...
|--------------------------------------------------------------------------
|
|  This determines which set of files upload size should be used.

*/

$config['filesize']	= 15728640;
...
/*DSN Value defined */
$config['oauth_db_host']=$dbconfig['db_server'];
$config['oauth_db_database']='oauth';
$config['oauth_db_username']=$dbconfig['db_username'];
$config['oauth_db_password']=$dbconfig['db_password'];
/* End DSN Value defined */

/*Port Socket.io */
$config['socketIOPort']='3001';
/*Port Socket.io */
