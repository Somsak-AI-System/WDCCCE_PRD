...
class sql {
	...
	}//end function sql connect
	
	//start function sql disconnect
	...
	function Sql_procress($query, $id){	//echo "555";
			global $dbtype;
			global $sql_debug;
			$sql_debug = 0;
			//$this->sql_Connect();
	...
	//start function sql fetch array
	...
	}//end function sql fetch array
	
	//start function sql fetch object
	...
	}//end function sql fetch object
	
	//start function sql free result
	...
	switch ($dbtype) {
		...
		case "Mssql":
			$rows=mssql_free_result($res);
			return $rows; 
		break;;
		}
	}//end function sql free result
	
	//start function sql error messge
	...
	global $dbtype;
		...
		{
			case "MySQL":
				$errmsg = "error ". mysql_errno(). " : ". mysql_error();
				return $errmsg;
			break;; 
