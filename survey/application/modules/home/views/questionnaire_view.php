<script type="text/javascript">
 ...
 <div class="vertical-center" >
    <div class="container div_box" >
      <div class="row">
        <div class="col-lg-12"> 
          <img src="<?php echo "http://".$_SERVER['HTTP_HOST'].'/moaistd/'.@$image['imgHeader']['path'].@$image['imgHeader']['attachmentsid'].'_'.@$image['imgHeader']['name'];?>" style="width:100%" alt="" class="index-tab"/>
...
<!--//////////////////////////////////////////////-->
        ...
        <img src="<?php echo "http://".$_SERVER['HTTP_HOST'].'/moaistd/'.@$image['imgFooter']['path'].@$image['imgFooter']['attachmentsid'].'_'.@$image['imgFooter']['name'];?>" style="width:100%" alt="" class="index-tab"/>
    </div>
  </div>
