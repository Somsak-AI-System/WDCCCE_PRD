...
class Users extends CRMEntity {
	...
	var $search_fields = Array(
		'First Name'=>Array('aicrm_users'=>'first_name'),
		'Last Name'=>Array('aicrm_users'=>'last_name'),
		'Email'=>Array('aicrm_users'=>'email1')
	);
	...
	var $sortby_fields = Array('status','email1','phone_work','is_admin','user_name','first_name','last_name','roleid');	  
	...
	var $list_fields = Array(
		...
		'Status'=>Array('aicrm_users'=>'status'), 
		'Email'=>Array('aicrm_users'=>'email1'),
		'Admin'=>Array('aicrm_users'=>'is_admin'),
		'Phone'=>Array('aicrm_users'=>'phone_work')
	);
	...
	function doLogin($user_password) {
		...
		switch (strtoupper($AUTHCFG['authType'])) {
			...
			default:
				...
				//เปิดกรณี ไม่ต้องการ check pass
	...
	function insertUserdetails($inVal)
	{
		...
		$visibility=0;
		$sql="insert into aicrm_homestuff values($tc, 15, 'Tag Cloud', $uid, $visibility, 'Tag Cloud')";
		$adb->query($sql);
