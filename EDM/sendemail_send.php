...
echo "<script type='text/javascript'>alert('Send Email Complete');window.close();  window.opener.parent.location.replace('../index.php?action=DetailView&module=Smartemail&record=".$crmid."&parenttab=Marketing');</script>";
