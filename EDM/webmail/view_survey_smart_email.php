  ...
  <header>
     <div style="height:1000px;">
      <div class="container_24">
        ...
        <nav>
          <ul>
          	<li><a href="view_survey_smart_email.php?campaing=<?=$crmid?>" class="current">Overview</a></li>
            <li><a href="home-2.php?campaing=<?=$crmid?>">Click Link</a></li>
            <li><a href="survey-home-3.php?campaing=<?=$crmid?>">Summary</a></li>
          </ul>
        </nav>
      </div>
    </div>
        ...
        <div class="wrapper" >
            <div style="position:absolute;">
             <div style="position:absolute; margin-top: -850px; background-color:#FFF; width:1000px; border:solid 5px #006093; -webkit-border-radius:10px; -moz-border-radius:10px; border-radius:10px;">
                ...
                $sql7="select surveysmartemailid from aicrm_surveysmartemail where surveysmartemailid='".$crmid."' limit 1";
                $data7 = $generate->process($sql7,"all");

                $table="tbt_email_log_surveysmartemailid_".$data7[0]['surveysmartemailid'];
			   ...
			   ?>
                ...
                <table cellpadding="2" cellspacing="2" width="98%" style="line-height:30px; border:1px solid #CCC; margin:10px">
                    <tr>
                        <td >
                        	<? 
							getData1($crmid, 'surveysmartemail');
							?>
