...
//get email====================================================================================
	...
	$record_smartemail = $genarate->process($new_table,"all");
				...
				<table align="center" class="mceItemTable" id="Table_01" border="0" cellspacing="0" cellpadding="0" width="800">
					<tbody>
						<tr>
							...
							<div style="text-align: right; color: rgb(106, 106, 106); line-height: 20px; font-family: tahoma; font-size: 12px;" mce_style="font-size: 12px; line-height: 20px; font-family: tahoma; text-align: right; color:#6a6a6a;">หากท่านไม่สามารถอ่านอีเมล์ฉบับนี้ได้ กรุณา <a style=" color:#fd8103; font-family: tahoma; font-size: 12px;" target="_blank" href='.str_replace('CLICKTYPE','edm',$url_click_view).'>คลิกที่นี่</a> </div>
							</td>
						</tr>
						<tr>
