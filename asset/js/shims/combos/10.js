! function(a) {
    ...
    if (!b.defineProperties) {
        ...
        a.extend(b, {
                ...
                prefixed: function(a, c) {
                    var d, e, f = !1;
                    if (c[a] && (f = a), !f)
                        for (a = a.charAt(0).toUpperCase() + a.slice(1), d = 0; d < b.domPrefixes.length; d++)
    ...
    function(a) {
            ...
            e = function() {
                ...
                return function(c) {
                    if (a[c.type] && c.originalEvent && c.originalEvent.touches && c.originalEvent.touches.length)
                        for (var d = 0; d < b.length; d++) c[b[d]] = c.originalEvent.touches[0][b[d]];
                    return c
                }
            }(),
            f = {
                ...
                addRemoveClass: function(a, b) {
                    var c, d = -1 != this.element.prop("className").indexOf(a);
                    ...
                    var b, c, d, f, g = this,
                        ...
                        o = {
                            ...
                            keydown: function(a) {
                                ...
                                var b = !0,
                                    c = a.keyCode;
                                h.readonly || h.disabled || (g.isRtl && (39 == c ? c = 37 : 37 == c && (c = 39)), 39 == c  ? g.doStep(1) : 37 == c  ? g.doStep(-1) : 33 == c ? g.doStep(10, h.animate) : 34 == c ? g.doStep(-10, h.animate) : 36 == c ? g.value(g.options.max, !1, h.animate) : 35 == c ? g.value(g.options.min, !1, h.animate) : b = !1, b && (g.addRemoveClass("ws-active", !0), i.call("input", h.value), a.preventDefault()))
                            }
                        };
        ...
        var g, h = b.formcfg,
            ...
            m = '<select class="dd"><option value=""></option>' + function() {
                for (var a = 1, b = []; 32 > a;) b.push("<option>" + (10 > a ? "0" + a : a) + "</option>"), a++;
                return b.join("")
            }() + "</select>",
            n = function(b) {
                if (!g.patterns[b + "Obj"]) {
            ...
            q = {
                ...
                month: {
                    _create: function(b) {
                        ...
                        if (c.splits.push(b.yearSelect ? a('<select class="yy"></select>')[0] : a('<input type="' + p + '" class="yy" size="4" inputmode="numeric" maxlength="4" />')[0]), b.monthSelect) c.splits.push(a('<select class="mm">' + l(b) + "</select>")[0]);
                        else if (c.splits.push(a('<input type="text" class="mm ws-spin" />')[0]), b.onlyMonthDigits) {
                            a().attr({
                                inputmode: "numeric",
                                size: 2,
                                maxlength: 2
                    ...
                    sort: function(b) {
                        var c, d = a(".ws-input-seperator", b).html(g.dFormat),
        ...
        f.addZero = v, b.loader.addModule("forms-picker", {
            ...
            function() {
                var c = function(a, b) {
                    ...
                    d = {
                        number: function(a, b, c) {
                            ...
                            for (a += "", "-" == a.charAt(0) && (h = !0, a = a.replace("-", "")), d = a.split("."), e = d[0].length, f = e - 1, a = ""; f >= 0;) a = d[0].charAt(f) + a, f > 0 && (e - f) % 3 === 0 && (a = g.numberFormat[","] + a), --f;
                        ...
                        time: function(b, c, d) {
                            ...
                            if (b) {
                                ...
                                if (g.meridian && (e = 1 * b[0], e && e >= 12 ? (b[0] = v(e - 12 + ""), e = 1) : e = 0, "00" === b[0] && (b[0] = "12")), !d) {
                                    for (f = 0; f < b.length; f++) b[f] = v(b[f]);
                                    b[1] || (b[1] = "00")
                                }
                ...
                var j = {
                    _create: function() {
                        ...
                        "color" == this.type && this.inputElements.prop("maxLength", 7), this.addBindings(), a(this.element).data("wsWidget" + e.type, this), e.buttonOnly && this.inputElements.prop({
                            readOnly: !0
                        }), this._init = !0, e.mirrorValidity && (c = this, d = function() {
                            clearTimeout(d._timerDealy), d._timerDealy = setTimeout(d._wsexec, 9)
                        }, d._wsexec = function() {
                            clearTimeout(d._timerDealy), c.mirrorValidity(!0)
                        }, d(), a(this.orig).on("change input", function(a) {
                            "input" == a.type ? d() : d._wsexec()
                        }))
                    },
                ...
                return function(c, d) {
                    ...
                    return a.isFunction(c) ? (d = c, c = !1, this.on("click", k)) : this.on("click", c, k), e ? (j = function() {
                        i = !1
                    }, g = function(b) {
                        var c, e;
                        b = b.originalEvent || {}, a(this).off("touchend touchcancel", g);
            ...
            function() {
                ...
                b.inlinePopover = {
                    ...
                    for (d || (d = ""); 18 > k && (h || i);) k++, h && (g = f.start - k * f.step, h = l(g, "unshift")), i && (g = f.start + k * f.step, i = l(g, "push"));
                    return j
            ...
            function() {
                var c, e, g = b.support.inputtypes,
                    j = {},
                    l = {
                        disabled: 1,
                        required: 1,
                ...
                var p = function() {
                    ...
                    s = function(b) {
                        var c, d, e, f, g, h, i, j = b.orig.style,
                            k = b.element[0].style;
                    ...
                    v = function() {
                        var d, h, l, o, p, q, t, v = a.prop(this, "type");
                        if (j[v] && b.implement(this, "inputwidgets") && (!g[v] || !a(this).hasClass("ws-noreplace"))) {
                            for (l = {}, o = v, t = a(this).is(":focus"), p = a(this).jProp("labels"), h = a.extend(b.getOptions(this, v, [f.widgets, f[v], a(a.prop(this, "form")).data(v)]), {
                                    ...
                                    containerElements: []
                                }), d = 0; d < m.length; d++) h[m[d]] = a.prop(this, m[d]);
                            for (d = 0; d < n.length; d++) o = n[d].replace(/^data\-/, ""), "placeholder" != o && h[o] || (h[o] = a.attr(this, n[d]) || h[o]);
                ...
                f.replaceUI && a.each(a.extend(w, a.isPlainObject(f.replaceUI) ? f.replaceUI : {
                    ...
                    w[c] === !1 || g[c] && !w[c] || p(c, {
                        _create: function(d) {
                            ...
                            var e = d.splitInput ? '<span class="ws-' + c + ' ws-input ws-inputreplace" role="group"></span>' : '<input class="ws-' + c + ' ws-inputreplace" type="text" onkeydown="if(event.keyCode==38||event.keyCode==40||event.keyCode==189) return false;" />',
