! function(a) {
    ...
    navigator.geolocation || (navigator.geolocation = {}), a.extend(navigator.geolocation, function() {
        var f, g = {
            getCurrentPosition: function(d, g, h) {
                var i, j, k, l = 2,
                    m = function() {
                        if (!k)
                            if (f) {
    ...
    b.createElement("summary", function() {
        ...
        if (c && !a.data(this, "detailsElement")) {
            var d, e, f = a.attr(this, "tabIndex") || "0";
            h(this, c), a(this).on({
                ...
                "click.summaryPolyfill": function(b) {
                    var c = g(this);
                    if (c) {
                ...
                "keydown.summaryPolyfill": function(b) {
    ...
    var w, x = {
        onPlayPause: function(a, b, c) {
            var d, e, f = b.paused || b.ended;
            if (null == c) try {
        ...
        onConnectionFailed: function(a, b) {
            g.setError(b._elem, "flash connection error")
        },
        onNotBuffering: function(a, b) {
            u(3, b)
        },
        onDataInitialized: function(a, b) {
            var c, d = b.duration;
        ...
        onBuffering: function(a, b) {
            b.ended && (b.ended = !1), u(1, b), s(b._elem, "waiting")
        },
        onTimeUpdate: function(b, c) {
        ...
        onPlaybackFinished: function(a, b) {
            b.readyState < 4 && u(4, b), b.ended = !0, s(b._elem, "ended")
        },
        onVolumeChange: function(a, b) {
    ...
    var y = function(a) {
            var c, d = a.actionQueue.length,
                e = 0;
            if (d && "third" == a.isActive)
                for (; a.actionQueue.length && d > e;) {
    ...
    var F = function() {
            ...
            return function(c) {
                if (c) {
                    ...
                    var d = b,
                        e = c.networkState;
                    for (u(0, c), clearTimeout(c._durationChangeTimer); --d > -1;) delete c[a[d]];
        ...
        G = function() {
            var e = {},
                ...
                i = function(a, b) {
                    var c, d, e = !1;
                    for (c = 0; 4 > c; c++) d = g(a, h[c]), parseFloat(d, 10) && (e = !0, b[h[c]] = d);
                    return e
                },
                j = function(c) {
                    var d, e, h = c._elem,
    ...
    var N = function(c, d, e, g, i, j) {
            var k, l, m, n, o = "audio/rtmp" == d.type || "video/rtmp" == d.type,
    ...
    g.queueSwfMethod = O, ["audio", "video"].forEach(function(c) {
        ...
        g("seeking"), g("volume", function(a) {
            var c = r(this);
            if (c) a *= 1, isNaN(a) || ((0 > a || a > 1) && b.error("volume greater or less than allowed " + a / 100), O(this, "api_volume", [a], c), c.volume != a && (c.volume = a, s(c._elem, "volumechange")), c = null);
            else if (d.volume.prop._supset) return d.volume.prop._supset.apply(this, arguments)
        }), g("muted", function(a) {
            var b = r(this);
            if (b) a = !!a, O(this, "api_muted", [a], b), b.muted != a && (b.muted = a, s(b._elem, "volumechange")), b = null;
            else if (d.muted.prop._supset) return d.muted.prop._supset.apply(this, arguments)
        }), g("currentTime", function(a) {
            var b = r(this);
            if (b) a *= 1, isNaN(a) || O(this, "api_seek", [a], b);
            else if (d.currentTime.prop._supset) return d.currentTime.prop._supset.apply(this, arguments)
        }), ["play", "pause"].forEach(function(a) {
            e[a] = {
                value: function() {
                    var b = r(this);
                    if (b) b.stopPlayPause && clearTimeout(b.stopPlayPause), O(this, "play" == a ? "api_play" : "api_pause", [], b), b._ppFlag = !0, b.paused != ("play" != a) && (b.paused = "play" != a, s(b._elem, a));
                    else if (d[a].prop._supvalue) return d[a].prop._supvalue.apply(this, arguments)
                }
            }
        ...
        return e || webshim.error("canvas.drawImage feature is needed. In IE8 flashvanvas pro can be used"), CanvasRenderingContext2D.prototype.wsImageComplete = function(a) {
            ...
            if (h[a.nodeName] && (c = b.data(a, "mediaelement")) && "third" == c.isActive && c.api.api_image) {
                ...
                return i[c.currentSrc] || (i[c.currentSrc] = !0, null == l && b.error("video has to be same origin or a crossdomain.xml has to be provided. Video has to be visible for flash API")), k = g.call(arguments, 1), f.canvasSync && c.canvasImg && (k.unshift(c.canvasImg), e.apply(n, k), k = g.call(arguments, 1), m = !0), j = d.createElement("img"), j.onload = function() {
                    if (k.unshift(this), j.onload = null, !(f.canvasSync && (c.canvasImg = j, m && f.noDoubbleDraw)) && (e.apply(n, k), n._wsIsLoading = !1, n._wsLoadingCbs && n._wsLoadingCbs.length))
                        for (; n._wsLoadingCbs.length;) n._wsLoadingCbs.shift().call(n, n)
    ...
    if (P() || b.ready("canvas", P), k && a.cleanData) {
        ...
        a.cleanData = function(a) {
            var b, c, d, e = Q.apply(this, arguments);
            if (a && (c = a.length) && l)
                for (b = 0; c > b; b++)
                    if (T[a[b].nodeName] && "api_destroy" in a[b]) {
                        l--;
                        try {
                            if (a[b].api_destroy(), 4 == a[b].readyState)
                                for (d in a[b]) S[d] || R[d] || "function" != typeof a[b][d] || (a[b][d] = null)
                        } catch (f) {
                            console.log(f)
                        }
                    } return e
    ...
    function e(a, c, e) {
        3 != arguments.length && b.error("wrong arguments.length for VTTCue.constructor"), this.startTime = a, this.endTime = c, this.text = e, this.onenter = null, this.onexit = null, this.pauseOnExit = !1, this.track = null, this.id = null, this.getCueAsHTML = function() {
            ...
            return function() {
                var e, g;
                if (a || (a = d.createDocumentFragment()), b != this.text)
                    for (b = this.text, c = f.parseCueTextToHTML(b), t.innerHTML = c, e = 0, g = t.childNodes.length; g > e; e++) a.appendChild(t.childNodes[e].cloneNode(!0));
    ...
    var f = b.mediaelement,
        ...
        q = function(c, d) {
            ...
            if (c || (c = b.data(this, "mediaelementBase") || b.data(this, "mediaelementBase", {})), d || (c.blockTrackListUpdate = !0, d = a.prop(this, "textTracks"), c.blockTrackListUpdate = !1), clearTimeout(c.updateTrackListTimer), a("track", this).each(function() {
                ...
                }), c.scriptedTextTracks)
                for (e = 0, f = c.scriptedTextTracks.length; f > e; e++) j.push(c.scriptedTextTracks[e]), -1 == d.indexOf(c.scriptedTextTracks[e]) && i.push(c.scriptedTextTracks[e]);
            for (e = 0, f = d.length; f > e; e++) - 1 == j.indexOf(d[e]) && h.push(d[e]);
            if (h.length || i.length) {
                for (d.splice(0), e = 0, f = j.length; f > e; e++) d.push(j[e]);
                for (e = 0, f = h.length; f > e; e++) a([d]).triggerHandler(a.Event({
                    type: "removetrack",
                    track: h[e]
                }));
                for (e = 0, f = i.length; f > e; e++) a([d]).triggerHandler(a.Event({
                    type: "addtrack",
                    track: i[e]
                }));
                (c.scriptedTextTracks || h.length) && a(this).triggerHandler("updatetrackdisplay")
            }
            for (e = 0, f = d.length; f > e; e++) d[e].__wsmode != d[e].mode && (d[e].__wsmode = d[e].mode, g = !0);
        ...
        s = function() {
            ...
            return c.captions = c.subtitles,
                function(d) {
                    var e, f, g = a.prop(d, "default");
    ...
    c.VTTCue = e, c.TextTrackCue = function() {
        ...
        var a = /(<\/?[^>]+>)/gi,
            ...
            d = function(a, b, d, e) {
                var f;
                return c.test(e) ? f = "</" + a + ">" : (d.splice(0, 1), f = "<" + a + " " + b + '="' + d.join(" ").replace(/\"/g, "&#34;") + '">'), f
            },
            e = function(a) {
    ...
    f.loadTextTrack = function(c, d, e, h) {
        var i = "play playing loadedmetadata loadstart",
            ...
            k = function() {
                ...
                if (o && (a(c).off(i, k).off("updatetrackdisplay", k), !e.readyState)) {
                    ...
                    try {
                        j.cues = f.createCueList(), j.activeCues = j.shimActiveCues = j._shimActiveCues = f.createCueList(), w++, l = function() {
                            h = a.ajax({
                                dataType: "text",
                                url: o,
                                success: function(i) {
        ...
        return function(h) {
            ...
            for (i = h.split(/\n/g); !i[0].replace(/\s+/gi, "").length && i.length > 0;) i.shift();
        ...
        return d = d || b.data(c, "mediaelementBase") || b.data(c, "mediaelementBase", {}), d.textTracks || (d.textTracks = [], b.defineProperties(d.textTracks, {
            ...
            for (var b, c = 0; c < d.textTracks.length; c++) b = d.textTracks[c], b.__wsmode != b.mode && (b.__wsmode = b.mode, a([d.textTracks]).triggerHandler("change"))
        })), d.textTracks
