! function(a) {
    "use strict";
    var b = function(a, b) {
            return void 0 === b && (b = 0), Math.round(a * Math.pow(10, b)) / Math.pow(10, b)
        },
        c = function(b, c, d) {
            var e = c;
            c.nodeType && (e = a.data(c, "wsjPicker") || a.data(c, "wsjPicker", {})), b ? a.extend(!0, e, d) : a.extend(e, d)
        },
        d = function(b, c) {
            var d, e, f, g = this,
                h = b.find("img").eq(0),
                ...
                q = new Array,
                r = function(a) {
                    for (var b = 0; b < q.length; b++) q[b].call(g, g, a)
                },
                s = function(c) {
                    var f = b.offset();
                    d = {
                ...
                y = function(a, b) {
                    ...
                    if (!c) switch ((void 0 === a || null == a) && (a = "all"), a.toLowerCase()) {
                        ...
                        case "rangey":
                            return {
                                minY: l, maxY: m, rangeY: n
                            };
                        case "all":
                        default:
                            return {
                                minX: i, maxX: j, rangeX: k, minY: l, maxY: m, rangeY: n
                            }
                    }
                    var d, e, f, g;
                ...
                A = function(b) {
                    if (a.isFunction(b))
                        for (var c; - 1 != (c = a.inArray(b, q));) q.splice(c, 1)
                },
                B = function() {
        ...
        e = function(a, d, e, f) {
            var g = this,
                ...
                r = function(a) {
                    if ("" != a.target.value || a.target == p.get(0) || (null == e || a.target == e.get(0)) && null != e) {
                        if (!u(a)) return a;
                        switch (a.target) {
                            case i.get(0):
                                switch (a.keyCode) {
                    ...
                    if ("" != a.target.value || a.target == p.get(0) || (null == e || a.target == e.get(0)) && null != e) {
                        ...
                        switch (a.target) {
                            ...
                            case o.get(0):
                                ...
                                break;
                            case p.get(0):
                                p.val(p.val().replace(/[^a-fA-F0-9]/g, "").toLowerCase().substring(0, 6)), e && e.val(p.val()), d.val("hex", "" != p.val() ? p.val() : null, a.target);
                                break;
                            case e && e.get(0):
                                e.val(e.val().replace(/[^a-fA-F0-9]/g, "").toLowerCase().substring(0, 6)), p.val(e.val()), d.val("hex", "" != e.val() ? e.val() : null, a.target);
                                break;
                            case q && q.get(0):
                ...
                t = function(a) {
                    if (null != d.val()) switch (a.target) {
                        ...
                        case p.get(0):
                        case e && e.get(0):
                            p.val(d.val("hex")), e && e.val(d.val("hex"));
                            break;
                        case q && q.get(0):
                ...
                w = function(a, c) {
                    var d = a.val("all");
                    c != i.get(0) && i.val(null != d ? d.r : ""), c != j.get(0) && j.val(null != d ? d.g : ""), c != k.get(0) && k.val(null != d ? d.b : ""), l && c != l.get(0) && l.val(null != d ? b(100 * d.a / 255, f) : ""), c != m.get(0) && m.val(null != d ? d.h : ""), c != n.get(0) && n.val(null != d ? d.s : ""), c != o.get(0) && o.val(null != d ? d.v : ""), c != p.get(0) && (e && c != e.get(0) || !e) && p.val(null != d ? d.hex : ""), e && c != e.get(0) && c != p.get(0) && e.val(null != d ? d.hex : ""), q && c != q.get(0) && q.val(null != d ? d.ahex.substring(6) : "")
                },
                x = function() {
                    i.add(j).add(k).add(l).add(m).add(n).add(o).add(p).add(e).add(q).off("keyup", s).off("blur", t), i.add(j).add(k).add(l).add(m).add(n).add(o).off("keydown", r), d.off(w), i = null, j = null, k = null, l = null, m = null, n = null, o = null, p = null, q = null
                };
            c(!0, g, {
                destroy: x
            }), i.add(j).add(k).add(l).add(m).add(n).add(o).add(p).add(e).add(q).on("keyup", s).on("blur", t), i.add(j).add(k).add(l).add(m).add(n).add(o).on("keydown", r), d.bind(w)
        };
    a.wsjPicker = {
        List: [],
        Color: function(b) {
            var d, e, f, g, i, j, k, l = this,
                m = new Array,
                n = function(a) {
                    for (var b = 0; b < m.length; b++) m[b].call(l, l, a)
                },
                o = function(a, b, c) {
                    var m = void 0 !== b;
                    if (!m) {
                        ...
                        switch (a.toLowerCase()) {
                            ...
                            case "all":
                                return {
                                    r: d, g: e, b: f, a: g, h: i, s: j, v: k, hex: o.call(l, "hex"), ahex: o.call(l, "ahex")
                                };
                            default:
                                for (var p = {}, q = 0; q < a.length; q++) switch (a.charAt(q)) {
                                    case "r":
                    ...
                    if (null == c || c != l) {
                        ...
                        switch (a.toLowerCase()) {
                            ...
                            default:
                                ...
                                for (var q = 0; q < a.length; q++) switch (a.charAt(q)) {
                                    case "r":
                                        if (u) continue;
                ...
                q = function(b) {
                    if (a.isFunction(b))
                        for (var c; - 1 != (c = a.inArray(b, m));) m.splice(c, 1)
                },
                r = function() {
                    m = null
                };
        ...
        ColorMethods: {
            ...
            hsvToRgb: function(a) {
                var b = {
                    ...
                    d = a.s,
                    e = a.v;
                if (0 == d) b.r = b.g = b.b = 0 == e ? 0 : 255 * e / 100 | 0;
                else {
    ...
    a.fn.wsjPicker = function(h) {
        ...
        return this.each(function() {
            ...
            var m = null,
                ...
                db = function() {
                    ...
                    if (B = M.find(".Active").eq(0).css({
                        ...
                        for (O = 0; O < hb.quickList.length; O++) {
                            "string" == (typeof hb.quickList[O]).toString().toLowerCase() && (hb.quickList[O] = new f({
                                hex: hb.quickList[O]
                            }));
                ...
                gb = l.localization,
                hb = {
                    active: new f("string" == (typeof l.color.active).toString().toLowerCase() ? {
                    ...
                    current: new f("string" == (typeof l.color.active).toString().toLowerCase() ? {
                        ahex: !l.window.alphaSupport && l.color.active ? l.color.active.substring(0, 6) + "ff" : l.color.active
                    } : {
                        ahex: !l.window.alphaSupport && l.color.active.val("ahex") ? l.color.active.val("ahex").substring(0, 6) + "ff" : l.color.active.val("ahex")
                    }),
    ...
    g.commonColorInit = function(b) {
        ...
        var e, f = {
                ...
                setInputColor: function(b) {
                    var c, d = e.color.active.val(),
                        f = "#" + d.hex;
