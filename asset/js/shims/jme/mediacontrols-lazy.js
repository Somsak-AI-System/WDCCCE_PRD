webshims.register("mediacontrols-lazy", function(a, b, c, d, e) {
    ...
    function i(a) {
        var b, c, d, e;
        if (a.length)
            for (c = a[0].startTime, d = a[a.length - 1].endTime, e = 100 / (d - c), b = 0; b < a.length; b++) a[b].rel = (a[b].endTime - a[b].startTime) * e, b == a.length - 1 ? (a[b].last = !0, a[b].style = "overflow: hidden;") : a[b].style = "float: left; width: " + a[b].rel + "%;", i(a[b].list)
    }
    ...
    function j(a) {
        ...
        var c, d, e, f = [],
            g = null;
        for (d = 0; d < a.cues.length; d++) c = a.cues[d], g && g.startTime > c.startTime || (g && c.startTime >= g.endTime && (g = g.parent), g && c.endTime > g.endTime || (e = {
    ...
    a.fn.wsTouchClick || (a.fn.wsTouchClick = function() {
        ...
        return function(c, e) {
            ...
            return a.isFunction(c) ? (e = c, c = !1, this.on("click", k)) : this.on("click", c, k), d ? (j = function() {
                i = !1
            }, g = function(b) {
                var c, d;
        ...
        "jme-media-overlay": {
            _create: function(b, c, d) {
                ...
                b.wsTouchClick(function() {
                    ...
                    "touchstart touchend mousedown click mouseover": function(a) {
                        var b = 500;
        ...
        "time-slider": {
            ...
            _create: function(b, c, d) {
                var e = this,
                    g = function() {
                        var g, h, i, j, k, m, n = "has-duration",
                            o = c.prop("duration");
                        g = f({
                            get: function() {
                            ...
                            setTimeout(function() {
                                j.removeClass("show-time-select"), b.off(".jmetimeselect"), document.removeEventListener && document.removeEventListener("touchend", m, !0)
                            })
                        }, i = b.rangeUI({
                            min: 0,
                            ...
                            "mouseenter touchstart": function(d) {
                                if (n && "touchstart" != d.type || d.originalEvent && d.originalEvent.touches && 1 == d.originalEvent.touches.length) {
                                    ...
                                    }), document.addEventListener && document.addEventListener("touchend", m, !0), b.off(".jmetimeselect").on("mousemove.jmetimeselect touchmove.jmetimeselect", function(b) {
                                        a.fn.rangeUI.normalizeTouch(b), g(b.pageX)
                                    })
                                }
                            },
                            "mouseleave touchend": m
                        }), c.on({
                            timeupdate: g.get,
                            emptied: function() {
                                h(), i.value(0)
        ...
        chapters: {
            _create: function(c, d, e) {
                var f = this;
                b.ready("track", function() {
                    var g, i, j, k, l, m = function() {
        ...
        mediaconfigmenu: {
            _create: function(b, c, d) {
                var e, f = new a.jme.ButtonMenu(b, '<div class="mediamenu" ><div /></div>'),
                    g = f.menu.find("div"),
                    h = function() {
    ...
    a.jme.defineMethod("activateTrack", function(b, c) {
        ...
        if (c.media) {
            var d, e = c.media.prop("textTracks"),
                f = function() {
                    var a, f = function() {
                        var a, f = g(e);
    ...
    var w = {
        ...
        x = function(b, c) {
            ...
            for (var e, f = [], g = 0, h = c.length; h > g; g++) "ms" == c[g] && g == h - 1 ? e = Math.round(b / w[c[g]] / 10) : (e = parseInt(b / w[c[g]], 10), b %= w[c[g]]), 10 > e && (e = "0" + e), f.push(e);
            return f.join(":")
        };
    a.jme.defineMethod("formatTime", x), a.jme.fullscreen = function() {
            var b, d, e = document.documentElement,
                f = {
            ...
            set: function(b, d) {
                ...
                if (d) {
                    ...
                    if (e.scrollPos = {
                        ...
                        }), "fullwindow" == d) a.jme.fullscreen.requestFullWindow(e.player[0]);
                    else try {
            ...
            _create: function(b, c, d, e) {
                var f, g = a('<div class="buffer-progress-indicator" />').appendTo(b),
                    h = function() {
                ...
                c.on({
                    ...
                    playing: h,
                    "seeked seeking updateprogress": function(a) {
        ...
        function() {
            var b = {
                add: function(b, c, d) {
                    var e, f, g = a.data(b, "jmeuseractivity") || a.data(b, "jmeuseractivity", {
                            idletime: 2500,
                            idle: !0,
                            trigger: {}
                        }),
