...
<head>
  ...
  <link href="<?php echo site_url('assets/bootstrap-multiselect/css/bootstrap-multiselect.min.css'); ?>" rel="stylesheet" type="text/css">
  <script src="<?php echo site_url('assets/bootstrap-multiselect/js/bootstrap-multiselect.min.js'); ?>"></script>
  <script src="<?php echo site_url('assets/script.js?t='.time()); ?>"></script>
