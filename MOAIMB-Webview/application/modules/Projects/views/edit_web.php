                                                            ...
                                                            <?php foreach ($itemList['products'] as $key => $value) { 
                                                                ...
                                                                <tr id="row<?php echo $p_row; ?>" class="row_data">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="hidden" class="base-input base-input-text" id="plan<?php echo $p_row; ?>" name="plan<?php echo $p_row; ?>" value="<?php echo $value['plan'];?>">
                                                                        
                                                                        <input type="hidden" class="base-input base-input-text" id="delivered<?php echo $p_row; ?>" name="delivered<?php echo $p_row; ?>" value="<?php echo $value['delivered'];?>">

                                                                        <input type="hidden" class="base-input base-input-text" id="remain_on_hand<?php echo $p_row; ?>" name="remain_on_hand<?php echo $p_row; ?>" value="<?php echo $value['remain_on_hand'];?>">
    ...
    $(function(){
        ...
        $('#form-projects').submit(async function(e) {
            ...
            await $.post('<?php echo site_url('Projects/checkDup'); ?>', formData, async function(res){
                if(res?.count == '0'){
                    await $.post('<?php echo site_url('Projects/save'); ?>', formData, function(rs){
