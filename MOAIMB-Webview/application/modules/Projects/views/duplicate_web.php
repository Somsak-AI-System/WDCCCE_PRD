    ...
    <div class="row">
                                                            ...
                                                            <?php foreach ($itemList['products'] as $key => $value) { 
                                                                ...
                                                                <tr id="row<?php echo $p_row; ?>" class="row_data">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'productid'.$p_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['productid'] ,'value_name'=>$value['productname'] ,'module_select'=>'Products','modal' => 'productid1','fieldName'=> 'input-productid'.$p_row,'configmodule'=>$configmodule,'count'=>$p_row,'settype'=> 'productinventory'] ); ?>
                                                                        <div class="mb-2">
                                                                    ...
                                                                    <td>
                                                                        <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'dealerid'.$p_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['accountid'] ,'value_name'=>$value['accountname'] ,'module_select'=>'Accounts','modal' => 'dealerid'.$p_row,'fieldName'=> 'input-dealerid'.$p_row,'configmodule'=>$configmodule,'count'=>$p_row,'settype'=> 'productinventory'] ); ?>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" class="base-input" id="estimated<?php echo $p_row; ?>" name="estimated<?php echo $p_row; ?>" value="<?php echo number_format($value['estimated'],0);?>" onkeyup="calcTotal();" onkeypress=" return isNumberPricelist(event);">
                                                                    </td>
                                                    ...
                                                    <?php if(!empty($itemList['architecture'])){?>
                                                        <?php foreach ($itemList['architecture'] as $key => $value) { 
                                                            ...
                                                            <tr id="row_arc<?php echo $arc_row;?>" class="row_data">
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'architecture'.$arc_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['accountid'] ,'value_name'=>$value['accountname'] ,'module_select'=>'Accounts','modal' => 'architecture'.$arc_row,'fieldName'=> 'input-architecture'.$arc_row,'configmodule'=>$configmodule,'count'=>$arc_row,'settype'=> 'architectureinventory'] ); ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'contact_architecture'.$arc_row, 'readonly' => ' 1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['contactid'] ,'value_name'=>$value['contactname'] ,'module_select'=>'Contacts','modal' => 'contact_architecture'.$arc_row,'fieldName'=> 'input-contact_architecture'.$arc_row,'configmodule'=>$configmodule,'count'=>$arc_row,'settype'=> 'architectureinventory'] ); ?>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <?php if(!empty($itemList['owner'])){?>
                                                        <?php foreach ($itemList['owner'] as $key => $value) { 
                                                            ...
                                                            <tr id="row_owner<?php echo $owner_row; ?>" class="row_data">
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'owner'.$owner_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['accountid'] ,'value_name'=>$value['accountname'] ,'module_select'=>'Accounts','modal' => 'owner'.$owner_row,'fieldName'=> 'input-owner'.$owner_row,'configmodule'=>$configmodule,'count'=>$owner_row,'settype'=> 'ownerinventory'] ); ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'contact_owner'.$owner_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['contactid'] ,'value_name'=>$value['contactname'] ,'module_select'=>'Contacts','modal' => 'contact_owner'.$owner_row,'fieldName'=> 'input-contact_owner'.$owner_row,'configmodule'=>$configmodule,'count'=>$owner_row,'settype'=> 'ownerinventory'] ); ?>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <?php if(!empty($itemList['consultant'])){?>
                                                        <?php foreach ($itemList['consultant'] as $key => $value) { 
                                                            ...
                                                            <tr id="row_consul<?php echo $con_row; ?>" class="row_data">
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'consultant'.$con_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['accountid'] ,'value_name'=>$value['accountname'] ,'module_select'=>'Accounts','modal' => 'consultant'.$con_row,'fieldName'=> 'input-consultant'.$con_row,'configmodule'=>$configmodule,'count'=>$con_row,'settype'=> 'consultantinventory'] ); ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'contact_consultant'.$con_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['contactid'] ,'value_name'=>$value['contactname'] ,'module_select'=>'Contacts','modal' => 'contact_consultant'.$con_row,'fieldName'=> 'input-contact_consultant'.$con_row,'configmodule'=>$configmodule,'count'=>$con_row,'settype'=> 'consultantinventory'] ); ?>
                                                                </td>
                                                                <td>
                                                ...
                                                <table id="proTabConstruction" class="table table-striped table-bordered table-sm" cellspacing="0" style="width: 2000px;">
                                                    ...
                                                    <?php if(!empty($itemList['construction'])){?>
                                                        <?php foreach ($itemList['construction'] as $key => $value) { 
                                                            ...
                                                            <tr id="row_const<?php echo $cons_row;?>" class="row_data">
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'construction'.$cons_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['accountid'] ,'value_name'=>$value['accountname'] ,'module_select'=>'Accounts','modal' => 'construction'.$cons_row,'fieldName'=> 'input-construction'.$cons_row,'configmodule'=>$configmodule,'count'=>$cons_row,'settype'=> 'constructioninventory'] ); ?>
                                                                </td>
                                                    ...
                                                    <?php } else{ ?>
                                                        <tr id="row_const1" class="row_data">
                                                            ...
                                                            <td>
                                                                <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'construction1', 'value' => '', 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>'' ,'value_name'=>'' ,'module_select'=>'Accounts','modal' => 'construction1','fieldName'=> 'input-construction1','configmodule'=>$configmodule,'count'=>$cons_row,'settype'=> 'constructioninventory'] ); ?>
                                                            </td>
                                                    ...
                                                    <?php if(!empty($itemList['contractor'])){?>
                                                        <?php foreach ($itemList['contractor'] as $key => $value) { 
                                                            ...
                                                            <tr id="row_contractor<?php echo $cont_row;?>" class="row_data">
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'contractor'.$cont_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['accountid'] ,'value_name'=>$value['accountname'] ,'module_select'=>'Accounts','modal' => 'contractor'.$cont_row,'fieldName'=> 'input-contractor'.$cont_row,'configmodule'=>$configmodule,'count'=>$cont_row,'settype'=> 'contractorinventory'] ); ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'contact_contractor'.$cont_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['contactid'] ,'value_name'=>$value['contactname'] ,'module_select'=>'Contacts','modal' => 'contact_contractor'.$cont_row,'fieldName'=> 'input-contact_contractor'.$cont_row,'configmodule'=>$configmodule,'count'=>$cont_row,'settype'=> 'contractorinventory'] ); ?>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <?php if(!empty($itemList['subcontractor'])){?>
                                                        <?php foreach ($itemList['subcontractor'] as $key => $value) { 
                                                            ...
                                                            <tr id="row_subcontractor<?php echo $subcon_row;?>" class="row_data">
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'subcontractor'.$subcon_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['accountid'] ,'value_name'=>$value['accountname'] ,'module_select'=>'Accounts','modal' => 'subcontractor'.$subcon_row,'fieldName'=> 'input-subcontractor'.$subcon_row,'configmodule'=>$configmodule,'count'=>$subcon_row,'settype'=> 'subcontractorinventory'] ); ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <?php echo inputPopupMulti(['uitype' => '1000', 'fieldClass' => '', 'fieldlabel' => '','columnname' => 'contact_subcontractor'.$subcon_row, 'readonly' => '1', 'rows' => '', 'typeofdata' => 'V~O','value'=>$value['contactid'] ,'value_name'=>$value['contactname'] ,'module_select'=>'Contacts','modal' => 'contact_subcontractor'.$subcon_row,'fieldName'=> 'input-contact_subcontractor'.$subcon_row,'configmodule'=>$configmodule,'count'=>$subcon_row,'settype'=> 'subcontractorinventory'] ); ?>
                                                                </td>
                                                                <td>
        ...
        <nav class="col-3 col-sm-3" id="verticalScrollspy">
            ...
            <li class="nav-item">
                ...
                <button type="submit" class="btn btn-default btn-cancel-form" onclick="history.back()"><i class="ph-bold ph-x-circle" style="font-size: 18px;vertical-align: inherit;"></i>&nbsp;Cancel</button>
            </li>
            <?php if(is_array($blocks)){ foreach($blocks as $index => $block) { ?>
