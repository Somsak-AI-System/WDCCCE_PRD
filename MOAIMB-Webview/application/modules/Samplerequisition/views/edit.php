...
<div class="top-nav">
    <div class="top-nav-content">
        <div class="top-nav-back-icon" onclick="Javascript:window.location.href = '<?php echo site_url('Samplerequisition/edit/back'); ?>';"><i class="ph-caret-left"></i></div>
...
<script>
    ...
    $(function(){
        ...
        $('#form-samplerequisition').submit(function(e) {
            ...
            $('.overlay').show();
            $.post('<?php echo site_url('Samplerequisition/save'); ?>', formData, function(rs){
