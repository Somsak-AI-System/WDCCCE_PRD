...
<div class="top-nav">
    <div class="top-nav-content">
        <!-- <?php
            ...
            echo '</pre>'
            ?> -->
        <?php if ($action == 'viewTempReport') { ?>
            <div class="top-nav-back-icon" onclick="location.href='<?php echo site_url('Quotes/createProduct/' . $crmid . '?userid=' . $userid); ?>'"><i class="ph-caret-left"></i></div>
        <?php } else { ?>
