        ...
        <div class="modal-content modal-custom-content">
            ...
            <div class="modal-body modal-custom-body bg-white">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" style="position:relative" id="list-2" role="tabpanel" aria-labelledby="list-2-tab">
                        <?php $this->load->view('list-sparepart'); ?>
                    </div>
                    <div class="tab-pane fade" id="list-3" role="tabpanel" aria-labelledby="list-3-tab">
                        <?php $this->load->view('list-service'); ?>
                    </div>
                </div>
            </div>
