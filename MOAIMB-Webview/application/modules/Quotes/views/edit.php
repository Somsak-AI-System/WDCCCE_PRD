...
<div class="top-nav">
    <div class="top-nav-content">
        <div class="top-nav-back-icon" onclick="Javascript:window.location.href = '<?php echo site_url('Quotes/edit/back'); ?>';"><i class="ph-caret-left"></i></div>
...
<script>
    ...
    $(function(){
        ...
        $('.input-popup-search-event').keyup(function(i, e){
            ...
            if(len === 0 || len > 2){
                offSet = 0
                getPopupListEvent(moduleSelect, fieldID, $(this).val(), '', '1', relate_field_up, relate_field_down)
            }
        })
        ...
        $('#form-quotes').submit(function(e) {
            ...
            $('.overlay').show();
            $.post('<?php echo site_url('Quotes/save'); ?>', formData, function(rs){
                if(rs.status === 'Success'){
