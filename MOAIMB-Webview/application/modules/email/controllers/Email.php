...
class Email extends MY_Controller
{
    function __construct()
    {
        ...
        $this->service_master_url = 'https://glapcrmuat.ai-crm.com/';
    }
    ...
    private function getReport($crmID, $userID, $module, $submodule)
    {
        ...
        // $url = "http://localhost/MOAISTD/WB_Service_AI/crmreport/send_crmreport";
        $url = $this->service_master_url . "WB_Service_AI/crmreport/send_crmreport";
    ...
    public function send()
    {
        ...
        $params_sendmail = [];
        $params_sendmail['crmid'] = $a_data['crmid'];
        $params_sendmail['userid'] = $a_data['userid'];
        $params_sendmail['emailto'] = $a_data['emailTo'];
        $params_sendmail['emailcc'] = @$a_data['emailCC'];
        $params_sendmail['emailbcc'] = @$a_data['emailBCC'];
        $params_sendmail['filename'] = @$a_data['fielName'];
        $params_sendmail['path'] = @$a_data['path'];
        $params_sendmail['subject'] = @$a_data['emailTitle'];
        $params_sendmail['emailbody'] = $message;

        //echo json_encode($params_sendmail);
        
        $url = $this->service_master_url . "WB_Service_AI/crmreport/sendmail_crmreport";
        
        $fields_string = json_encode($params_sendmail);
        $json_url = $url;
