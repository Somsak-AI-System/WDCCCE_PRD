...
if(!$db_type_status || !$db_server_status)
{
	...
	$error_msg_info = 'This may be due to the following reasons:<br>
			-  specified database user, password, hostname, database type, or port is invalid. <a href="http://www.vtiger.com/products/crm/help/5.1.0/aicrm_CRM_Database_Hostname.pdf" target="_blank">More Information</a><BR>
...
if($patch_version !='')
{
	$log->info($info_style_start . "Ai-CRM Version: " . $aicrm_current_version . " Patch " . $patch_version . $info_style_end);
}
else
{
	$log->info($info_style_start . "Ai-CRM Version: " . $aicrm_current_version . $info_style_end);
}
			...
			<tr>
				...
				<tr>
					...
					<tr>
						...
						<td align="left" nowrap> <font class="dataInput"><?php echo ($db_utf8_support)? "Enabled" : "<strong style='color:#DF0000';>Not Enabled</strong>" ?></font>&nbsp;<a href="http://www.vtiger.com/products/crm/help/5.1.0/aicrm_CRM_Database_UTF8Config.pdf" target="_blank">More Information</a></td>
					</tr>
					</table>
					</td>
					<td align=left class="small" width=50% style="padding-left:10px">
