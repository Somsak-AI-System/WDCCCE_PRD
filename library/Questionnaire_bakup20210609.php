...
class libquestionnaire{
	...
	/*public function save_questionnaire($template=array(),$questionnaireid=NULL,$action=NULL,$questionnaire_answer=array(), $questionnairetemplateid=NULL){*/
	public function save_questionnaire($data=array(),$questionnaireid=NULL,$action=NULL,$questionnaire_answer=array(), $questionnairetemplateid=NULL){
		...
		//echo "<pre>"; print_r($questionnaire_answer); echo "</pre>";
		...
		foreach($data['pages'] as $key => $value) {
			...
			foreach($value['elements'] as $k1 => $v1) {
				...
				//echo $v1['title']; echo "<br>";
				//echo $questionnaire_answer[$v1['name']];
				//echo "<br>";
					...
					if($v1['type'] == 'text'){
						...
						foreach ($questionnaire_answer[$v1['name']] as $K_checkbox => $v1_checkbox) {
							...
							if($v1_checkbox == 'other' && $v1['hasOther'] == 1){
								...
								INNER JOIN aicrm_questionnaire_choice on aicrm_questionnaire_choice.questionnaireid = aicrm_questionnaire.questionnaireid
								INNER JOIN aicrm_questionnaire_choicedetail on aicrm_questionnaire_choicedetail.choiceid = aicrm_questionnaire_choice.choiceid
								WHERE aicrm_questionnaire.questionnaireid = '".$questionnaireid."' and aicrm_questionnaire_choicedetail.choicedetail_name = '".$v1['otherText']."' ";
								$a_choice = $myLibrary_mysqli->select($select_choice);
								...
								INNER JOIN aicrm_questionnaire_choice on aicrm_questionnaire_choice.questionnaireid = aicrm_questionnaire.questionnaireid
								INNER JOIN aicrm_questionnaire_choicedetail on aicrm_questionnaire_choicedetail.choiceid = aicrm_questionnaire_choice.choiceid
								WHERE aicrm_questionnaire.questionnaireid = '".$questionnaireid."' and aicrm_questionnaire_choicedetail.choicedetail_value = '".$v1_checkbox."' ";
								$a_choice = $myLibrary_mysqli->select($select_choice);
						...
						if($questionnaire_answer[$v1['name']] == 'other' && $v1['hasOther'] == 1){
							...
							INNER JOIN aicrm_questionnaire_choice on aicrm_questionnaire_choice.questionnaireid = aicrm_questionnaire.questionnaireid
							INNER JOIN aicrm_questionnaire_choicedetail on aicrm_questionnaire_choicedetail.choiceid = aicrm_questionnaire_choice.choiceid
							WHERE aicrm_questionnaire.questionnaireid = '".$questionnaireid."' and aicrm_questionnaire_choicedetail.choicedetail_value = '".$questionnaire_answer[$v1['name']]."' ";
