    ...
    [6],
    {
        ...
        IKlv: function (e, t, r) {
            ...
            var C = function (e) {
                ...
                G = k.defaultLocale,
                U = D || "";
            (r.p = "".concat(U, "/_next/")), _.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: B || {} });
            var W = (0, x.getURL)();
            (0, b.hasBasePath)(W) && (W = (0, b.delBasePath)(W));
            var J = new P.default(I, U),
                Y = function (e) {
                    var t = l(e, 2),
                        r = t[0],
                        n = t[1];
                        ...
                        i(r, [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    this.scrollToHash(),
                                        z.isSsr &&
                                            (j || (k.nextExport && ((0, w.isDynamicRoute)(z.pathname) || location.search)) || (L && L.__N_SSG && location.search)) &&
                                            z.replace(z.pathname + "?" + String(E.assign(E.urlQueryToSearchParams(z.query), new URLSearchParams(location.search))), W, { _h: 1, shallow: !j });
                                },
                            },
                            {
                            ...
                            function (e) {
                                for (;;)
                                    switch ((e.prev = e.next)) {
                                        ...
                                        case 36:
                                            return (
                                                (t.router = z = (0, A.createRouter)(R, F, W, {
                                                    initialProps: L,
                                                    pageLoader: J,
                                                    App: Q,
                                                    Component: ee,
                                                ...
                                                ae((c = { App: Q, initial: !0, Component: ee, props: L, err: i })),
                                                e.abrupt("return", re)
                                            );
                                        case 44:
            ...
            function ie(e) {
                ...
                return (
                    console.error(r),
                    J.loadPage("/_error").then(function (n) {
                        var a = n.page,
                            o = n.styleSheets,
                            i = de(t),
                            u = { Component: a, AppTree: i, router: z, ctx: { err: r, pathname: R, query: F, asPath: W, AppTree: i } };
                        return Promise.resolve(e.props ? e.props : (0, x.loadGetInitialProps)(t, u)).then(function (t) {
                            return me((0, m.default)({}, e, { err: r, Component: a, styleSheets: o, props: t }));
                        });
                    })
                );
            }
            ...
            function se() {
                if (x.ST) {
                    ...
                    e.length &&
                        ...
                        K && (performance.getEntriesByName("Next.js-render").forEach(K), performance.getEntriesByName("Next.js-route-change-to-render").forEach(K)),
                        le(),
            ...
            function fe(e) {
                ...
                return h.default.createElement(
                    ...
                    h.default.createElement(S.RouterContext.Provider, { value: (0, A.makePublicRouterInstance)(z) }, h.default.createElement(y.HeadManagerContext.Provider, { value: Z }, t))
                );
            }
            var pe,
                de = function (e) {
                    return function (t) {
                        var r = (0, m.default)({}, t, { Component: ee, err: M, router: z });
