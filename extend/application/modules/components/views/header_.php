<script type="text/javascript">
  ...
  window.fbAsyncInit = function() {
    FB.init({
      //appId      : '510853130115673',
      appId      : '130642768879049',
...
function login(response) {
  FB.login(
    ...
    {
      scope:
        "email,pages_show_list,read_page_mailboxes,pages_messaging,pages_read_engagement,pages_manage_metadata",
    },
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item boxagent dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="javascript:void(0)" style="color: #2B2B2B; font-family: PromptMedium;">Report Response History</a>
                    </div>
                </li>
            </ul>

            <!-- Facebook Login -->
            <!-- <div><button onClick="login();">Connect Facebook</button></div> -->
