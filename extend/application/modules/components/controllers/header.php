...
class Header extends MX_Controller
{
  ...
  public function left_bar_omnichannel()
  {
   $a_data = array();  
  $this->load->driver('cache');
  $cache_id = 'ai-' .php_uname('n').'-' . $this->session->userdata('user.username');
  ...
  $a_data['left_menu']= $cache_menu;
    $this->load->view('components/left_bar_omnichannel',$a_data);
  }

  public function right_bar_omnichannel()
  {
   $a_data = array();  
  $this->load->driver('cache');
  $cache_id = 'ai-' .php_uname('n').'-' . $this->session->userdata('user.username');
  ...
  $a_data['right_menu']= $cache_menu;
    $this->load->view('components/right_bar_omnichannel',$a_data);
  }
