...
function Filter_report() {
    ...
    var url = '<?php echo REPORT_VIEWER_URL;?>rpt_project_on_hand_pdf.rptdesign&__showtitle=false'
    +'&s1='+projectorder_no
...
function Export_report_excel() {
    ...
    $.messager.progress();
    Filter_report();
    var url = '<?php echo REPORT_VIEWER_URL;?>rpt_project_on_hand_excel.rptdesign&__showtitle=false'
    +'&s1='+projectorder_no
 +'&s2='+projectorder_name
 +'&s3='+project_type
 +'&s4='+project_size
