...
<script>
    ...
    function Filter1() {
        ...
        $.post('<?php echo site_url('salesvisit/selectdata'); ?>',{id:id}, function (rs) { console.log(rs)
            ...
            var url = '<?php echo REPORT_VIEWER_URL;?>rpt_monthly_report.rptdesign&__showtitle=false&userid=' + userid
                ...
                + '&report_type=' + report_type + '&date_start=' + sendDateStart + '&due_date=' + sendDateStop + '&username=' + username;
    ...
    function Send(send) {
        ...
        $.post('<?php echo site_url('salesvisit/selectdata'); ?>',{id:id}, function (rs) {
