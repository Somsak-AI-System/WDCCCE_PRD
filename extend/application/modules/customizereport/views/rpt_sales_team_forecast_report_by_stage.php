...
function checkvalid() {
    if ($("#date_from").combogrid('getValue') == '') {
...
function Filter_report() {
    ...
    var url = '<?php echo REPORT_VIEWER_URL;?>rpt_sales_team_forecast_report_by_stage.rptdesign&__showtitle=false&date_from=' +
...
function Export_report() {
    ...
    Filter_report();
    var url = '<?php echo REPORT_VIEWER_URL;?>rpt_sales_team_forecast_report_by_stage.rptdesign&__showtitle=false&date_from=' +
    date_from+'&date_to='+date_to+'&__format=pdf';
    // LoadURL(url, "birt-result");
...
function Send_report(send){
    ...
    if (confirmed) {
        ...
        var form_data = {
            date_from : date_from,
            date_to : date_to,
            submodule : 'rpt_sales_team_forecast_report_by_stage',
