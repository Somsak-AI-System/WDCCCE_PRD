                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="row panel-body layout-body" style="height: 120px; padding-top:15px;">
                                ...
                                <div class="col-xs-4">
                                    <input class="easyui-textbox monthly" data-options="required:false" id="monthly"
...
function Filter_report() {
    ...
    date_start +
        ...
        encodeURIComponent(send_to) +'&send_cc=' + encodeURIComponent(send_cc);
...
function Export_report() {
    ...
    date_start +
        '&due_date=' + due_date + '&sale_rap=' +
        encodeURIComponent(sale_rap) +'&sale_rap_name=' + encodeURIComponent(sale_rap_name)+ '&send_to=' +
        encodeURIComponent(send_to) +'&send_cc=' + encodeURIComponent(send_cc)+'&__format=pdf';
    // LoadURL(url, "birt-result");
