    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_name_body_pre != '') { // prepend a string to the name
				...
				$this->file_dst_name_body  = $this->file_name_body_pre;
			...
			//$this->file_dst_name="";
			//$image_manipulation="";
			//echo $this->file_name_body_pre;exit;
			//$this->file_dst_name_body=$this->file_name_body_pre;
			//echo $this->file_name_body_pre;
			//$this->file_dst_name_body="n".str_replace("","",$this->file_name_body_pre);
            if ($image_manipulation) {//echo "555";
                if ($this->image_convert=='') {//echo $this->file_dst_name;exit;
					//echo "=>".$this->file_dst_name."<br>";
					//echo "=>".$this->file_dst_name_body ."||<br>";
                    $this->file_dst_name =$this->file_dst_name_body . (!empty($this->file_dst_name_ext) ? '.' . $this->file_dst_name_ext : '');//echo $this->file_dst_name_body;exit;
